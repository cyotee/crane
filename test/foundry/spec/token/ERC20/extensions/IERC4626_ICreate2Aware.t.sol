...
import {
    IERC4626DFPkg,
    ERC4626DFPkg
} from "../../../../../../contracts/token/ERC20/extensions/ERC4626DFPkg.sol";

contract IERC4626_ICreate2Aware_Test
is
    ...
    TestBase_ICreate2Aware
{
    ...
    override(
        ...
        IERC20PermitDFPkg.ERC20PermitDFPkgArgs memory erc20PermitPkgArgs = IERC20PermitDFPkg.ERC20PermitDFPkgArgs({
