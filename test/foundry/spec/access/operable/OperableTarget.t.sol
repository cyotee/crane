...
import { OperableTargetStub } from "../../../../../contracts/test/stubs/OperableTargetStub.sol";
import { OperableGreeterStub } from "../../../../../contracts/test/stubs/OperableGreeterStub.sol";
import { IOperable } from "../../../../../contracts/interfaces/IOperable.sol";
import { IGreeter } from "../../../../../contracts/test/stubs/greeter/IGreeter.sol";

contract OperableTargetTest is CraneTest {
    ...
    function setUp() public virtual override {
        ...
        declareUsed(address(globalOperator));
        declareUsed(address(functionOperator));
        declareUsed(address(unauthorizedUser));

        operableStub = new OperableTargetStub(owner_);
        greeterStub = new OperableGreeterStub("Hello World", owner_);
        
        declareUsed(address(operableStub));
        declareUsed(address(greeterStub));
    }
    ...
    function test_setMessage_unauthorized_access() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IOperable.NotOperator.selector,
                unauthorizedUser
            )
        );
    ...
    function test_multiple_function_operators() public {
        ...
        declareUsed(address(setMessageOperator));
        declareUsed(address(updateMessageOperator));
