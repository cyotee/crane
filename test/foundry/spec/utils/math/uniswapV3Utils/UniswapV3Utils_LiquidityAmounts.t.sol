...
contract UniswapV3Utils_LiquidityAmounts_Test is TestBase_UniswapV3 {
    ...
    function test_quoteAmountsForLiquidity_tickOverload() public view {
        ...
        (uint256 amount0_tick, uint256 amount1_tick) =
            UniswapV3Utils._quoteAmountsForLiquidity(currentTick, tickLower, tickUpper, liquidity);
    ...
    function test_quoteAmountsForLiquidity_zeroLiquidity() public view {
        ...
        (uint256 amount0, uint256 amount1) =
            UniswapV3Utils._quoteAmountsForLiquidity(sqrtPriceX96, tickLower, tickUpper, 0);
    ...
    function test_quoteLiquidityForAmounts_priceBelowRange() public view {
        int24 tickSpacing = getTickSpacing(FEE_MEDIUM);
        int24 tickLower = nearestUsableTick(6000, tickSpacing);
        int24 tickUpper = nearestUsableTick(12000, tickSpacing);
    ...
    function test_quoteLiquidityForAmounts_priceAboveRange() public view {
        int24 tickSpacing = getTickSpacing(FEE_MEDIUM);
        int24 tickLower = nearestUsableTick(-12000, tickSpacing);
        int24 tickUpper = nearestUsableTick(-6000, tickSpacing);
    ...
    function test_quoteLiquidityForAmounts_tickOverload() public view {
        ...
        uint128 liquidity_tick =
            UniswapV3Utils._quoteLiquidityForAmounts(currentTick, tickLower, tickUpper, amount0, amount1);
    ...
    function test_quoteLiquidityForAmounts_zeroAmounts() public view {
        ...
        uint128 liquidity = UniswapV3Utils._quoteLiquidityForAmounts(sqrtPriceX96, tickLower, tickUpper, 0, 0);
    ...
    function test_roundTrip_amountsToLiquidityToAmounts() public view {
        ...
        uint128 liquidity =
            UniswapV3Utils._quoteLiquidityForAmounts(sqrtPriceX96, tickLower, tickUpper, inputAmount0, inputAmount1);
    ...
    function test_roundTrip_liquidityToAmountsToLiquidity() public view {
        ...
        // Convert to amounts
        (uint256 amount0, uint256 amount1) =
            UniswapV3Utils._quoteAmountsForLiquidity(sqrtPriceX96, tickLower, tickUpper, inputLiquidity);
    ...
    function test_quoteLiquidityForAmounts_matchesActualMint() public {
        ...
        (uint256 usedAmount0, uint256 usedAmount1) =
            mintPosition(pool, address(this), tickLower, tickUpper, quotedLiquidity);
