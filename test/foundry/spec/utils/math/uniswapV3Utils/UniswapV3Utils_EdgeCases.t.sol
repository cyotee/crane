...
contract UniswapV3Utils_EdgeCases_Test is Test {
    ...
    function test_getSqrtPriceFromReserves_revertsOnZeroReserve0() public {
        ...
        (bool success,) = address(this)
            .call(abi.encodeWithSignature("callGetSqrtPriceFromReserves(uint256,uint256)", 0, 1_000_000e18));
    ...
    function test_getAmount0Delta() public {
        ...
        uint256 amount0Down = UniswapV3Utils._getAmount0Delta(sqrtPriceAX96, sqrtPriceBX96, liquidity, false);

        // Test rounding up (paying tokens)
        uint256 amount0Up = UniswapV3Utils._getAmount0Delta(sqrtPriceAX96, sqrtPriceBX96, liquidity, true);
    ...
    function test_getAmount1Delta() public {
        ...
        // Test rounding down
        uint256 amount1Down = UniswapV3Utils._getAmount1Delta(sqrtPriceAX96, sqrtPriceBX96, liquidity, false);

        // Test rounding up
        uint256 amount1Up = UniswapV3Utils._getAmount1Delta(sqrtPriceAX96, sqrtPriceBX96, liquidity, true);
    ...
    function test_quoteExactInput_zeroLiquidity() public {
        ...
        uint256 amountOut = UniswapV3Utils._quoteExactInputSingle(amountIn, sqrtPriceX96, liquidity, 3000, true);
    ...
    function test_quoteExactOutput_higherFeeMeansMoreInput() public {
        ...
        // Quote with low fee
        uint256 inputLowFee = UniswapV3Utils._quoteExactOutputSingle(amountOut, sqrtPriceX96, liquidity, 500, true);

        // Quote with medium fee
        uint256 inputMediumFee = UniswapV3Utils._quoteExactOutputSingle(amountOut, sqrtPriceX96, liquidity, 3000, true);

        // Quote with high fee
        uint256 inputHighFee = UniswapV3Utils._quoteExactOutputSingle(amountOut, sqrtPriceX96, liquidity, 10000, true);
    ...
    function test_quoteExactInput_largerSwapMoreImpact() public {
        ...
        uint256 smallOutput = UniswapV3Utils._quoteExactInputSingle(smallAmount, sqrtPriceX96, liquidity, 3000, true);

        // Large swap (10x)
        uint256 largeAmount = 10_000e18;
        uint256 largeOutput = UniswapV3Utils._quoteExactInputSingle(largeAmount, sqrtPriceX96, liquidity, 3000, true);
