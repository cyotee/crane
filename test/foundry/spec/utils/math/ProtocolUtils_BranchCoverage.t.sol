...
contract UniswapV2UtilsHarness {
    function quoteWithdrawSwapFee(
        ...
        return UniswapV2Utils._quoteWithdrawSwapFee(
            ownedLPAmount, lpTotalSupply, reserveA, reserveB, feePercent, feeDenominator, kLast, feeToOn
        );
    }
}
...
contract AerodromeUtilsHarness {
    function quoteWithdrawSwapWithFee(
        ...
        return AerodromeUtils._quoteWithdrawSwapWithFee(ownedLPAmount, lpTotalSupply, reserveOut, reserveIn, feePercent);
    }
    ...
    function quoteSwapDepositWithFee(
        ...
        return AerodromeUtils._quoteSwapDepositWithFee(amountIn, lpTotalSupply, reserveIn, reserveOut, feePercent);
    }
}
