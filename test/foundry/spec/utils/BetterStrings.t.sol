...
/// forge-lint: disable-next-line(unaliased-plain-import)
import "src/utils/BetterStrings.sol";
...
contract BetterStringsTest is Test {
    ...
    function test__tryParseAddress_invalid() public {
        (bool ok, address a) = BetterStrings._tryParseAddress("notanaddr");
        assertTrue(!ok && a == address(0));
    }

    function test__parseAddress_range() public {
    ...
    function test__tryParseAddress_range_invalid() public {
        (bool ok, address a) = BetterStrings._tryParseAddress("px", 1, 2);
        assertTrue(!ok && a == address(0));
    }

    function test__escapeJSON() public {
