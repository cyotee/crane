...
/**
 * @title AerodromServiceVolatile_Test
 * @notice Tests for the AerodromServiceVolatile library functions
 * @dev Tests volatile pool operations (xy = k curve)
 */
contract AerodromServiceVolatile_Test is TestBase_Aerodrome_Pools {
    ...
    function test_swapDepositVolatile_balancedPool_mintsLP() public {
        ...
        AerodromServiceVolatile.SwapDepositVolatileParams memory params = AerodromServiceVolatile.SwapDepositVolatileParams({
            router: IRouter(address(aerodromeRouter)),
            factory: IPoolFactory(address(aerodromePoolFactory)),
            pool: IPool(address(aeroBalancedPool)),
            token0: token0Ierc20,
        ...
        uint256 lpAmount = AerodromServiceVolatile._swapDepositVolatile(params);
    ...
    function test_withdrawSwapVolatile_fullWithdrawal_returnsTargetToken() public {
        ...
        AerodromServiceVolatile.WithdrawSwapVolatileParams memory params = AerodromServiceVolatile.WithdrawSwapVolatileParams({
        ...
        uint256 amountOut = AerodromServiceVolatile._withdrawSwapVolatile(params);
    ...
    function test_quoteSwapDepositSaleAmtVolatile_returnsPositiveAmount() public {
        ...
        uint256 saleAmt = AerodromServiceVolatile._quoteSwapDepositSaleAmtVolatile(params);
    ...
    function test_integration_swapDepositWithdrawSwap_roundTrip() public {
        ...
        AerodromServiceVolatile.SwapDepositVolatileParams memory depositParams = AerodromServiceVolatile.SwapDepositVolatileParams({
            router: IRouter(address(aerodromeRouter)),
            factory: IPoolFactory(address(aerodromePoolFactory)),
            pool: IPool(address(aeroBalancedPool)),
            token0: token0Ierc20,
        ...
        uint256 lpAmount = AerodromServiceVolatile._swapDepositVolatile(depositParams);
        ...
        AerodromServiceVolatile.WithdrawSwapVolatileParams memory withdrawParams = AerodromServiceVolatile.WithdrawSwapVolatileParams({
            aerodromeRouter: IRouter(address(aerodromeRouter)),
            pool: IPool(address(aeroBalancedPool)),
            factory: IPoolFactory(address(aerodromePoolFactory)),
            tokenOut: IERC20(address(aeroBalancedTokenA)),
        ...
        uint256 amountBack = AerodromServiceVolatile._withdrawSwapVolatile(withdrawParams);
