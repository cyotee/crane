...
/**
 * @title AerodromeServiceStable_Test
 * @notice Tests for the AerodromeServiceStable library functions
...
contract AerodromeServiceStable_Test is TestBase_Aerodrome_Pools {
    ...
    function test_swapStable_normalSwap_returnsExpectedOutput() public {
        ...
        AerodromeServiceStable.SwapStableParams memory params = AerodromeServiceStable.SwapStableParams({
        ...
        uint256 amountOut = AerodromeServiceStable._swapStable(params);
    ...
    function test_swapDepositStable_balancedPool_mintsLP() public {
        ...
        AerodromeServiceStable.SwapDepositStableParams memory params = AerodromeServiceStable.SwapDepositStableParams({
            router: IRouter(address(aerodromeRouter)),
            factory: IPoolFactory(address(aerodromePoolFactory)),
            pool: IPool(address(aeroStablePool)),
            token0: token0Ierc20,
        ...
        uint256 lpAmount = AerodromeServiceStable._swapDepositStable(params);
    ...
    function test_withdrawSwapStable_majorityWithdrawal_returnsTargetToken() public {
        ...
        AerodromeServiceStable.WithdrawSwapStableParams memory params = AerodromeServiceStable.WithdrawSwapStableParams({
        ...
        uint256 amountOut = AerodromeServiceStable._withdrawSwapStable(params);
    ...
    function test_quoteSwapDepositSaleAmtStable_returnsPositiveAmount() public {
        ...
        uint256 saleAmt = AerodromeServiceStable._quoteSwapDepositSaleAmtStable(params);
    ...
    function test_stableVsVolatile_stableHasLowerSlippage() public {
        ...
        aeroStableTokenA.mint(address(this), swapAmount);
        AerodromeServiceStable.SwapStableParams memory stableParams = AerodromeServiceStable.SwapStableParams({
            router: IRouter(address(aerodromeRouter)),
            factory: IPoolFactory(address(aerodromePoolFactory)),
            pool: IPool(address(aeroStablePool)),
            tokenIn: IERC20(address(aeroStableTokenA)),
        ...
        uint256 stableOut = AerodromeServiceStable._swapStable(stableParams);
