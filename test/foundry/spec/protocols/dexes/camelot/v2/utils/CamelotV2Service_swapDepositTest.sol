 ...
 */
contract CamelotV2Service_swapDepositTest is CamelotV2BaseTest {
    ...
    function test_swapDeposit() public {
        ...
        uint256 lpReceived = CamelotV2Service._swapDeposit(
            camV2Router(),
            pool,
            tokenA,
            swapAmount,
        ...
        assertEq(pool.balanceOf(address(this)), beforeLPBalance + lpReceived, "Pool balance should increase by LP tokens received");
    }
    ...
    function test_swapDeposit_compareWithManual() public {
        ...
        uint256 beforeLPBalance = pool.balanceOf(address(this));
        uint256 autoLPReceived = CamelotV2Service._swapDeposit(
            camV2Router(),
            pool,
            tokenA,
            testAmount,
        ...
        assertEq(pool.balanceOf(address(this)), beforeLPBalance + autoLPReceived, "Pool balance should increase by LP tokens received");
