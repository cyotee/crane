 ...
 */
contract CamelotV2Service_swapTest is CamelotV2BaseTest {
    ...
    function test_swap_viaPair() public {
        ...
        // Verify balance increased correctly
        assertEq(tokenB.balanceOf(address(this)), beforeBalanceB + amountOut, "TokenB balance increase should match output");
    }
