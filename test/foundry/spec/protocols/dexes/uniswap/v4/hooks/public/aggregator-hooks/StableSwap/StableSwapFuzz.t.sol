...
contract StableSwapFuzz is Test {
    ...
    string constant FACTORY_BYTECODE_PATH =
        "test/foundry/spec/protocols/dexes/uniswap/v4/hooks/public/aggregator-hooks/StableSwap/precompiled/StableSwapFactory.bin";
    string constant POOL2_BYTECODE_PATH =
        "test/foundry/spec/protocols/dexes/uniswap/v4/hooks/public/aggregator-hooks/StableSwap/precompiled/StableSwapPool2.bin";
    string constant POOL3_BYTECODE_PATH =
        "test/foundry/spec/protocols/dexes/uniswap/v4/hooks/public/aggregator-hooks/StableSwap/precompiled/StableSwapPool3.bin";
    string constant POOL4_BYTECODE_PATH =
        "test/foundry/spec/protocols/dexes/uniswap/v4/hooks/public/aggregator-hooks/StableSwap/precompiled/StableSwapPool4.bin";
