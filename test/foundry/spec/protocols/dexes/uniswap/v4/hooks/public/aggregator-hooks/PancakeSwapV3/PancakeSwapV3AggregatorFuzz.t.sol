...
contract PancakeSwapV3AggregatorFuzz is Test {
    ...
    string constant POOL_DEPLOYER_BYTECODE_PATH =
        "test/foundry/spec/protocols/dexes/uniswap/v4/hooks/public/aggregator-hooks/PancakeSwapV3/precompile/PancakeV3PoolDeployer.bin";
    string constant FACTORY_BYTECODE_PATH =
        "test/foundry/spec/protocols/dexes/uniswap/v4/hooks/public/aggregator-hooks/PancakeSwapV3/precompile/PancakeV3Factory.bin";
