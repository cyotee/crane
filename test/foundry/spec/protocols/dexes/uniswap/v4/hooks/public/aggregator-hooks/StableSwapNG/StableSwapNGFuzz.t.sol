...
} from "@crane/contracts/protocols/dexes/uniswap/v4/hooks/public/aggregator-hooks/implementations/StableSwapNG/interfaces/ICurveStableSwapFactoryNG.sol";
import {
    ICurveStableSwapNG
} from "@crane/contracts/protocols/dexes/uniswap/v4/hooks/public/aggregator-hooks/implementations/StableSwapNG/interfaces/ICurveStableSwapNG.sol";
import {
    StableSwapNGAggregator
} from "@crane/contracts/protocols/dexes/uniswap/v4/hooks/public/aggregator-hooks/implementations/StableSwapNG/StableSwapNGAggregator.sol";
import {
    StableSwapNGAggregatorFactory
} from "@crane/contracts/protocols/dexes/uniswap/v4/hooks/public/aggregator-hooks/implementations/StableSwapNG/StableSwapNGAggregatorFactory.sol";
...
contract StableSwapNGFuzz is Test {
    ...
    string constant FACTORY_BYTECODE_PATH =
        "test/foundry/spec/protocols/dexes/uniswap/v4/hooks/public/aggregator-hooks/StableSwapNG/precompiled/StableSwapNGFactory.bin";
    string constant POOL_BYTECODE_PATH =
        "test/foundry/spec/protocols/dexes/uniswap/v4/hooks/public/aggregator-hooks/StableSwapNG/precompiled/StableSwapNGPool.bin";
    string constant MATH_BYTECODE_PATH =
        "test/foundry/spec/protocols/dexes/uniswap/v4/hooks/public/aggregator-hooks/StableSwapNG/precompiled/StableSwapNGMath.bin";
    string constant VIEWS_BYTECODE_PATH =
        "test/foundry/spec/protocols/dexes/uniswap/v4/hooks/public/aggregator-hooks/StableSwapNG/precompiled/StableSwapNGViews.bin";
