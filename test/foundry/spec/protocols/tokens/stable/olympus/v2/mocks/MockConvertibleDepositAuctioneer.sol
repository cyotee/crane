...
import {Kernel, Policy, Keycode, toKeycode, Permissions} from "@crane/contracts/protocols/tokens/stable/olympus/v2/Kernel.sol";
import {ROLESv1} from "@crane/contracts/protocols/tokens/stable/olympus/v2/modules/ROLES/OlympusRoles.sol";
import {PolicyEnabler} from "@crane/contracts/protocols/tokens/stable/olympus/v2/policies/utils/PolicyEnabler.sol";
import {IConvertibleDepositAuctioneer} from "@crane/contracts/protocols/tokens/stable/olympus/v2/policies/interfaces/deposits/IConvertibleDepositAuctioneer.sol";
import {IDepositManager} from "@crane/contracts/protocols/tokens/stable/olympus/v2/policies/interfaces/deposits/IDepositManager.sol";
import {IERC20} from "@crane/contracts/protocols/tokens/stable/olympus/v2/interfaces/IERC20.sol";
import {ERC721} from "@crane/contracts/external/openzeppelin-contracts-v4/token/ERC721/ERC721.sol";
