...
// Ported from morpho-org/metamorpho-v1.1@bcc003108c0fbb9f715566207c52a1d3f279c5c3 — path: test/helpers/BaseTest.sol
...
import {WAD, MathLib} from "@crane/contracts/external/morpho/blue/libraries/MathLib.sol";
...
import "@crane/contracts/external/morpho/metamorpho-v1.1/interfaces/IMetaMorphoV1_1.sol";

import "@crane/contracts/external/morpho/metamorpho-v1.1/libraries/ConstantsLib.sol";
import {ErrorsLib} from "@crane/contracts/external/morpho/metamorpho-v1.1/libraries/ErrorsLib.sol";
import {EventsLib} from "@crane/contracts/external/morpho/metamorpho-v1.1/libraries/EventsLib.sol";
import {ORACLE_PRICE_SCALE} from "@crane/contracts/external/morpho/blue/libraries/ConstantsLib.sol";

import {IrmMock} from "@crane/contracts/external/morpho/metamorpho-v1.1/mocks/IrmMock.sol";
import {ERC20Mock} from "@crane/contracts/external/morpho/metamorpho-v1.1/mocks/ERC20Mock.sol";
import {OracleMock} from "@crane/contracts/external/morpho/metamorpho-v1.1/mocks/OracleMock.sol";
...
contract BaseTest is Test {
    ...
    function setUp() public virtual {
        // Crane: deploy ported Morpho bytecode via `new` (deployCode artifact lookup is profile-fragile).
