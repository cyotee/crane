...
import {MockERC20} from "@crane/contracts/external/forge-std/mocks/MockERC20.sol";
import {
...
contract CollectorTest is Test {
    ...
    function setUp() public {
        ...
        address PROXY_ADMIN = makeAddr("collector-proxy-admin");
...
contract StreamsTest is CollectorTest {
    ...
    function testCreateStreamWhenNotFundsAdmin() public {
        ...
        collector.createStream(RECIPIENT_STREAM_1, 6 ether, address(tokenA), streamStartTime, streamStopTime);
    }
    ...
    function testCreateStreamWhenRecipientIsCollector() public {
        ...
        vm.prank(FUNDS_ADMIN);
        collector.createStream(address(collector), 6 ether, address(tokenA), streamStartTime, streamStopTime);
    }
    ...
    function testCreateStreamWhenDepositIsZero() public {
        ...
        vm.prank(FUNDS_ADMIN);
        collector.createStream(RECIPIENT_STREAM_1, 0 ether, address(tokenA), streamStartTime, streamStopTime);
    }
    ...
    function testCreateStreamWhenStartTimeInThePast() public {
        ...
        vm.prank(FUNDS_ADMIN);
        collector.createStream(RECIPIENT_STREAM_1, 6 ether, address(tokenA), block.timestamp - 10, streamStopTime);
    }
    ...
    function testCreateStreamWhenStopTimeBeforeStart() public {
        ...
        vm.prank(FUNDS_ADMIN);
        collector.createStream(RECIPIENT_STREAM_1, 6 ether, address(tokenA), block.timestamp + 70, block.timestamp + 10);
    }
    ...
    function createStream() private returns (uint256) {
        return collector.createStream(RECIPIENT_STREAM_1, 6 ether, address(tokenA), streamStartTime, streamStopTime);
    }
}
