...
} from "@crane/contracts/protocols/lending/aave/v3.6/rewards/transfer-strategies/StakedTokenTransferStrategy.sol";
import {StakeMock} from "@crane/contracts/protocols/lending/aave/v3.6/utils/mocks/StakeMock.sol";
import {TestnetProcedures} from "@crane/test/foundry/spec/protocols/lending/aave/3.6/utils/TestnetProcedures.sol";
...
contract StakedTokenTransferStrategyTest is TestnetProcedures {
    ...
    function setUp() public {
        ...
        stakedTokenTransferStrategy =
            new StakedTokenTransferStrategy(report.rewardsControllerProxy, alice, IStakedToken(address(stakeMock)));
    }
    ...
    function test_getters() public view {
        ...
        assertEq(stakedTokenTransferStrategy.getIncentivesController(), address(report.rewardsControllerProxy));
