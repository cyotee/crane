...
import {RewardsController, IRewardsController} from '@crane/contracts/protocols/lending/aave/v3.6/rewards/RewardsController.sol';
import {RewardsDistributor, IRewardsDistributor} from '@crane/contracts/protocols/lending/aave/v3.6/rewards/RewardsDistributor.sol';
...
import {ITransferStrategyBase} from '@crane/contracts/protocols/lending/aave/v3.6/rewards/interfaces/ITransferStrategyBase.sol';
...
import {PullRewardsTransferStrategy} from '@crane/contracts/protocols/lending/aave/v3.6/rewards/transfer-strategies/PullRewardsTransferStrategy.sol';
