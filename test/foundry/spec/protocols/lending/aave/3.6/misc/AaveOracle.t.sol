...
import {MintableERC20} from "@crane/contracts/protocols/lending/aave/v3.6/utils/mocks/tokens/MintableERC20.sol";
import {
    MockAggregator
...
import {PriceOracle} from "@crane/contracts/protocols/lending/aave/v3.6/utils/mocks/oracle/PriceOracle.sol";
...
contract AaveOracleTest is TestnetProcedures {
    ...
    function testUpdateSourceBaseCurrency() public {
        ...
        assertEq(contracts.aaveOracle.getSourceOfAsset(contracts.aaveOracle.BASE_CURRENCY()), sources[0]);
    }
