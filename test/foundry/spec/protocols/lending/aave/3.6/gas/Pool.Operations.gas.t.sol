...
import {
    MockFlashLoanReceiverWithoutMint
} from "@crane/contracts/protocols/lending/aave/v3.6/utils/mocks/flashloan/MockFlashLoanReceiverWithoutMint.sol";
import {
    MockSimpleFlashLoanReceiverWithoutMint
} from "@crane/contracts/protocols/lending/aave/v3.6/utils/mocks/flashloan/MockSimpleFlashLoanReceiverWithoutMint.sol";
...
contract PoolOperations_gas_Tests is Testhelpers {
    ...
    function test_liquidationCall_full() external {
        ...
        contracts.poolProxy.liquidationCall(tokenList.usdx, tokenList.weth, borrower, type(uint256).max, false);
    ...
    function test_liquidationCall_receive_ATokens_partial() external {
        ...
        vm.snapshotGasLastCall("Pool.Operations", "liquidationCall: partial liquidation and receive ATokens");
    }
    ...
    function test_liquidationCall_receive_ATokens_full() external {
        ...
        contracts.poolProxy.liquidationCall(tokenList.usdx, tokenList.weth, borrower, type(uint256).max, true);
        vm.snapshotGasLastCall("Pool.Operations", "liquidationCall: full liquidation and receive ATokens");
    }
    ...
    function test_flashLoan_with_one_asset() external {
        ...
        uint256 flashLoanFee = (flashLoanAmount * contracts.poolProxy.FLASHLOAN_PREMIUM_TOTAL()) / 100_00;

        MockFlashLoanReceiverWithoutMint flashLoanReceiver =
            new MockFlashLoanReceiverWithoutMint(contracts.poolAddressesProvider);
    ...
    function test_flashLoan_with_two_assets() external {
        ...
        uint256 flashLoanFeeWeth = (flashLoanAmountWeth * contracts.poolProxy.FLASHLOAN_PREMIUM_TOTAL()) / 100_00;
        uint256 flashLoanFeeWbtc = (flashLoanAmountWbtc * contracts.poolProxy.FLASHLOAN_PREMIUM_TOTAL()) / 100_00;
    ...
    function test_flashLoan_with_two_assets_with_borrowing() external {
        ...
        _supplyAndEnableAsCollateral(tokenList.weth, flashLoanAmountWeth * 5, address(flashLoanReceiver));
        _supplyAndEnableAsCollateral(tokenList.wbtc, flashLoanAmountWbtc * 5, address(flashLoanReceiver));
    ...
    function test_flashLoanSimple() external {
        ...
        MockSimpleFlashLoanReceiverWithoutMint flashLoanReceiver =
            new MockSimpleFlashLoanReceiverWithoutMint(contracts.poolAddressesProvider);
    ...
    function test_mintToTreasury_one_asset() external {
        ...
        contracts.poolProxy
            .borrow({
                asset: tokenList.weth, amount: borrowAmount, interestRateMode: 2, referralCode: 0, onBehalfOf: borrower
            });
        ...
        IERC20(tokenList.weth).approve(report.poolProxy, type(uint256).max);
        contracts.poolProxy
            .repay({asset: tokenList.weth, amount: borrowAmount, interestRateMode: 2, onBehalfOf: borrower});
    ...
    function test_mintToTreasury_two_assets() external {
        ...
        contracts.poolProxy
            .repay({asset: tokenList.weth, amount: borrowAmountWeth, interestRateMode: 2, onBehalfOf: borrower});
        contracts.poolProxy
            .repay({asset: tokenList.wbtc, amount: borrowAmountWbtc, interestRateMode: 2, onBehalfOf: borrower});
