...
contract PoolGetters_gas_Tests is Testhelpers {
    ...
    function test_getUserAccountData_with_eMode_enabled() external {
        ...
        contracts.poolProxy.getUserAccountData(user);
        vm.snapshotGasLastCall("Pool.Getters", "getUserAccountData: supplies: 0, borrows: 0 with eMode enabled");
    }
    ...
    function test_getUserAccountData_oneSupplies_with_eMode_enabled() external {
        ...
        contracts.poolProxy.getUserAccountData(user);
        vm.snapshotGasLastCall("Pool.Getters", "getUserAccountData: supplies: 1, borrows: 0 with eMode enabled");
    }
    ...
    function test_getUserAccountData_twoSupplies_with_eMode_enabled() external {
        ...
        contracts.poolProxy.getUserAccountData(user);
        vm.snapshotGasLastCall("Pool.Getters", "getUserAccountData: supplies: 2, borrows: 0 with eMode enabled");
    }
    ...
    function test_getUserAccountData_twoSupplies_oneBorrows_with_eMode_enabled() external {
        ...
        contracts.poolProxy.getUserAccountData(user);
        vm.snapshotGasLastCall("Pool.Getters", "getUserAccountData: supplies: 2, borrows: 1 with eMode enabled");
    }
