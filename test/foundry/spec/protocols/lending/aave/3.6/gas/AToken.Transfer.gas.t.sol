...
contract ATokenTransfer_gas_Tests is Testhelpers {
    ...
    function test_transfer_fullAmount() external {
        ...
        vm.snapshotGasLastCall(
            "AToken.transfer", "full amount; sender: ->disableCollateral; receiver: ->enableCollateral"
        );
    }
    ...
    function test_transferFrom_fullAmount() external {
        ...
        vm.snapshotGasLastCall(
            "AToken.transfer", "full amount; sender: ->disableCollateral; receiver: ->enableCollateral; transferFrom"
        );
    }
    ...
    function test_transfer_fullAmount_dirtyReceiver() external {
        ...
        aToken.transfer(receiver, aToken.balanceOf(sender));
        vm.snapshotGasLastCall(
            "AToken.transfer", "full amount; sender: ->disableCollateral; receiver: dirty, ->enableCollateral"
        );
    }
    ...
    function test_transferFrom_fullAmount_senderCollateralDisabled() external {
        ...
        // forge-lint: disable-next-line(erc20-unchecked-transfer)
        aToken.transferFrom(sender, receiver, aToken.balanceOf(sender));
        vm.snapshotGasLastCall("AToken.transfer", "full amount; receiver: ->enableCollateral; transferFrom");
    }
    ...
    function test_transferFrom_fullAmount_senderCollateralDisabled_receiverNonZeroFunds2() external {
        ...
        // forge-lint: disable-next-line(erc20-unchecked-transfer)
        aToken.transferFrom(sender, receiver, aToken.balanceOf(sender));
        vm.snapshotGasLastCall("AToken.transfer", "full amount; sender: ->disableCollateral; transferFrom");
    }
    ...
    function test_transferFrom_fullAmount_senderCollateralDisabled_receiverNonZeroFunds() external {
        ...
        // forge-lint: disable-next-line(erc20-unchecked-transfer)
        aToken.transferFrom(sender, receiver, aToken.balanceOf(sender));
        vm.snapshotGasLastCall("AToken.transfer", "full amount; sender: collateralDisabled; transferFrom");
    }
    ...
    function test_transfer_partialAmount_senderCollateralEnabled() external {
        ...
        vm.snapshotGasLastCall(
            "AToken.transfer", "partial amount; sender: collateralEnabled; receiver: ->enableCollateral"
        );
    }
    ...
    function test_transferFrom_partialAmount_senderCollateralEnabled() external {
        ...
        vm.snapshotGasLastCall(
            "AToken.transfer", "partial amount; sender: collateralEnabled; receiver: ->enableCollateral; transferFrom"
        );
    }
    ...
    function test_transferFrom_partialAmount_senderCollateralEnabled_receiverNonZeroFunds() external {
        ...
        // forge-lint: disable-next-line(erc20-unchecked-transfer)
        aToken.transferFrom(sender, receiver, 0.5 ether);
        vm.snapshotGasLastCall("AToken.transfer", "partial amount; sender: collateralEnabled; transferFrom");
    }
    ...
    function test_transferFrom_partialAmount_receiverNonZeroFunds() external {
        ...
        // forge-lint: disable-next-line(erc20-unchecked-transfer)
        aToken.transferFrom(sender, receiver, 0.5 ether);
        vm.snapshotGasLastCall("AToken.transfer", "partial amount; sender: collateralDisabled; transferFrom");
    }
    ...
    function test_transfer_partialAmount() external {
        ...
        aToken.transfer(receiver, 0.5 ether);
        vm.snapshotGasLastCall(
            "AToken.transfer", "partial amount; sender: collateralDisabled; receiver: ->enableCollateral"
        );
    }
    ...
    function test_transferFrom_partialAmount() external {
        ...
        aToken.transferFrom(sender, receiver, 0.5 ether);
        vm.snapshotGasLastCall(
            "AToken.transfer", "partial amount; sender: collateralDisabled; receiver: ->enableCollateral; transferFrom"
        );
    }
}
