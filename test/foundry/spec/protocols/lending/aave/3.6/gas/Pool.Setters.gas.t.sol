...
contract PoolSetters_gas_Tests is Testhelpers {
    ...
    function test_setUserEModeOnBehalfOf() external {
        ...
        vm.snapshotGasLastCall("Pool.Setters", "setUserEModeOnBehalfOf: enter eMode, 1 borrow, 1 supply");

        _skip(100);

        contracts.poolProxy.setUserEModeOnBehalfOf(0, user);
        vm.snapshotGasLastCall("Pool.Setters", "setUserEModeOnBehalfOf: leave eMode, 1 borrow, 1 supply");
    }
    ...
    function test_setUserUseReserveAsCollateral() external {
        ...
        vm.snapshotGasLastCall("Pool.Setters", "setUserUseReserveAsCollateral: disableCollateral, 1 supply");

        contracts.poolProxy.setUserUseReserveAsCollateral(tokenList.usdx, true);
        vm.snapshotGasLastCall("Pool.Setters", "setUserUseReserveAsCollateral: enableCollateral, 1 supply");
    }
    ...
    function test_setUserUseReserveAsCollateralonBehalfOf() external {
        ...
        vm.snapshotGasLastCall("Pool.Setters", "setUserUseReserveAsCollateralOnBehalfOf: disableCollateral, 1 supply");

        contracts.poolProxy.setUserUseReserveAsCollateralOnBehalfOf(tokenList.usdx, true, user);
        vm.snapshotGasLastCall("Pool.Setters", "setUserUseReserveAsCollateralOnBehalfOf: enableCollateral, 1 supply");
    }
}
