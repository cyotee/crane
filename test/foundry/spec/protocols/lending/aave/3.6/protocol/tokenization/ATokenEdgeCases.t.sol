...
contract ATokenEdgeCasesTests is TestnetProcedures {
    ...
    function test_transferFrom_zeroAddress_origin() public {
        ...
        emit IERC20Events.Transfer(address(0), alice, 0);
    ...
    function test_mintToZeroAddress() public {
        ...
        emit IERC20Events.Transfer(address(0), address(0), mintAmount);
    ...
    function test_burn_zeroAddress() public {
        ...
        emit IERC20Events.Transfer(address(0), address(0), burnAmount);
    ...
    function test_transfer_amount_MAX_UINT_120() public {
        vm.expectRevert(abi.encodeWithSelector(SafeCast.SafeCastOverflowedUintDowncast.selector, 120, UINT256_MAX));
        // forge-lint: disable-next-line(erc20-unchecked-transfer)
