...
} from "@crane/contracts/protocols/lending/aave/v3.6/interfaces/IPoolAddressesProviderRegistry.sol";
...
contract PoolAddressesProviderRegistryTest is TestnetProcedures {
    ...
    function testAddAddressesProvider() public {
        ...
        emit IPoolAddressesProviderRegistry.AddressesProviderRegistered(newAddressesProvider, newAddressesProviderId);
    ...
    function testRemoveAddressesProvider() public {
        ...
        vm.expectEmit(address(contracts.poolAddressesProviderRegistry));
        emit IPoolAddressesProviderRegistry.AddressesProviderUnregistered(newAddressesProvider, newAddressesProviderId);
    ...
    function testRemoveMultipleAddressesProvider() public {
        ...
        emit IPoolAddressesProviderRegistry.AddressesProviderUnregistered(
            newAddressesProvider2, newAddressesProviderId + 1
        );
