...
contract PoolConfiguratorPendingLtvTests is TestnetProcedures {
    ...
    function test_freezeAndSet() public {
        ...
        contracts.poolConfiguratorProxy.configureReserveAsCollateral(tokenList.usdx, originalLTV, lt, lb);
    ...
    function test_setLtv_ltvSetPendingLtvSet(uint256 originalLtv, uint256 ltvToSet) public {
        ...
        contracts.poolConfiguratorProxy
            .configureReserveAsCollateral(tokenList.usdx, originalLtv, liquidationThreshold, liquidationBonus);
        ...
        vm.expectEmit(address(contracts.poolConfiguratorProxy));
        emit IPoolConfigurator.CollateralConfigurationChanged(tokenList.usdx, 0, liquidationThreshold, liquidationBonus);

        // setLtv
        contracts.poolConfiguratorProxy
            .configureReserveAsCollateral(tokenList.usdx, ltvToSet, liquidationThreshold, liquidationBonus);
    ...
    function _getReserveParams() internal view returns (uint256, uint256, uint256, bool) {
        (, uint256 ltv, uint256 liquidationThreshold, uint256 liquidationBonus,,,,,, bool isFrozen) =
