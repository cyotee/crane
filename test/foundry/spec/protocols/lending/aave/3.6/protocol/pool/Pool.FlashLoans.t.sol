...
import {MockFlashLoanReceiver} from '@crane/contracts/protocols/lending/aave/v3.6/utils/mocks/flashloan/MockFlashLoanReceiver.sol';
import {MockFlashLoanSimpleReceiver} from '@crane/contracts/protocols/lending/aave/v3.6/utils/mocks/flashloan/MockSimpleFlashLoanReceiver.sol';
...
import {IReserveInterestRateStrategy} from '@crane/contracts/protocols/lending/aave/v3.6/interfaces/IReserveInterestRateStrategy.sol';
import {DataTypes} from '@crane/contracts/protocols/lending/aave/v3.6/protocol/libraries/types/DataTypes.sol';
import {IERC20} from '@crane/contracts/interfaces/IERC20.sol';
import {MockFlashLoanATokenReceiver} from '@crane/contracts/protocols/lending/aave/v3.6/utils/mocks/MockFlashLoanATokenReceiver.sol';
import {MockFlashLoanBorrowInsideFlashLoan} from '@crane/contracts/protocols/lending/aave/v3.6/utils/mocks/MockFlashLoanBorrowInsideFlashLoan.sol';
import {TestnetProcedures, TestReserveConfig} from '@crane/test/foundry/spec/protocols/lending/aave/3.6/utils/TestnetProcedures.sol';
