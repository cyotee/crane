...
import {
    IRescuableBase
} from "@crane/contracts/protocols/lending/aave/v3.6/dependencies/solidity-utils/contracts/utils/interfaces/IRescuableBase.sol";
...
contract StataTokenV2RescuableTest is BaseTest {
    function test_rescuable_shouldRevertForInvalidCaller() external {
        ...
        IRescuable(address(stataTokenV2)).emergencyTokenTransfer(tokenList.usdx, address(this), 1 ether);
    }
