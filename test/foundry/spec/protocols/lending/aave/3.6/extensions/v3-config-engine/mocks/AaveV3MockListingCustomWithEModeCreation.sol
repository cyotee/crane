...
contract AaveV3MockListingCustomWithEModeCreation is AaveV3Payload {
    ...
    constructor(address assetAddress, address assetFeed, address customEngine, address aTokenImpl, address vTokenImpl)
    ...
    function eModeCategoryCreations() public view override returns (IEngine.EModeCategoryCreation[] memory) {
