...
contract StataTokenV2PermitTest is BaseTest {
    function test_permit() public {
        ...
        bytes32 permitDigest =
            SigUtils.getTypedDataHash(permit, SigUtils.PERMIT_TYPEHASH, stataTokenV2.DOMAIN_SEPARATOR());
    ...
    function test_permit_expired() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(ERC20PermitUpgradeable.ERC2612ExpiredSignature.selector, permit.deadline)
        );
        stataTokenV2.permit(permit.owner, permit.spender, permit.value, permit.deadline, v, r, s);
    }
    ...
    function test_permit_invalidSigner() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(ERC20PermitUpgradeable.ERC2612InvalidSigner.selector, user, permit.owner)
        );
        stataTokenV2.permit(permit.owner, permit.spender, permit.value, permit.deadline, v, r, s);
    }
}
