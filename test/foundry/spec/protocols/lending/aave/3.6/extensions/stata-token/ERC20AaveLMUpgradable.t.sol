...
import {ERC20AaveLMUpgradeable, IERC20AaveLM} from '@crane/contracts/protocols/lending/aave/v3.6/extensions/stata-token/ERC20AaveLMUpgradeable.sol';
import {IRewardsController} from '@crane/contracts/protocols/lending/aave/v3.6/rewards/interfaces/IRewardsController.sol';
import {PullRewardsTransferStrategy, ITransferStrategyBase} from '@crane/contracts/protocols/lending/aave/v3.6/rewards/transfer-strategies/PullRewardsTransferStrategy.sol';
