...
import {
    AaveV3MockCollateralUpdateLtZeroLiqProtocolFeeOnly
} from "./mocks/AaveV3MockCollateralUpdateLtZeroLiqProtocolFeeOnly.sol";
...
contract AaveV3ConfigEngineTest is TestnetProcedures, ProtocolV3TestBase {
    ...
    function testListings() public {
        ...
        ReserveConfig[] memory allConfigsBefore =
            createConfigurationSnapshot("preTestEngineListing", IPool(address(contracts.poolProxy)));

        payload.execute();

        ReserveConfig[] memory allConfigsAfter =
            createConfigurationSnapshot("postTestEngineListing", IPool(address(contracts.poolProxy)));
        ...
        _validateReserveTokensImpls(
            ...
            ReserveTokens({aToken: address(contracts.aToken), variableDebtToken: address(contracts.variableDebtToken)})
        );

        _validateAssetSourceOnOracle(IPoolAddressesProvider(address(contracts.poolAddressesProvider)), asset, feed);
    ...
    function testListingWithEModeCategoryCreation() public {
        ...
        ReserveConfig[] memory allConfigsBefore =
            createConfigurationSnapshot("preTestEngineListingWithEModeCreation", IPool(address(contracts.poolProxy)));

        payload.execute();

        ReserveConfig[] memory allConfigsAfter =
            createConfigurationSnapshot("postTestEngineListingWithEModeCreation", IPool(address(contracts.poolProxy)));
        ...
        _validateEmodeCategory(IPoolAddressesProvider(address(contracts.poolAddressesProvider)), 1, eModeCategoryData);
    }
    ...
    function testListingsCustom() public {
        ...
        address aTokenImpl =
            address(new ATokenInstance(contracts.poolProxy, report.rewardsControllerProxy, report.treasury));
        address vTokenImpl = address(new VariableDebtTokenInstance(contracts.poolProxy, report.rewardsControllerProxy));

        AaveV3MockListingCustom payload = new AaveV3MockListingCustom(asset, feed, configEngine, aTokenImpl, vTokenImpl);

        vm.prank(roleList.marketOwner);
        contracts.aclManager.addPoolAdmin(address(payload));

        ReserveConfig[] memory allConfigsBefore =
            createConfigurationSnapshot("preTestEngineListingCustom", IPool(address(contracts.poolProxy)));

        payload.execute();

        ReserveConfig[] memory allConfigsAfter =
            createConfigurationSnapshot("postTestEngineListingCustom", IPool(address(contracts.poolProxy)));
    ...
    function testListingsCustomWithEModeCategoryCreation() public {
        ...
        AaveV3MockListingCustomWithEModeCreation payload =
            new AaveV3MockListingCustomWithEModeCreation(asset, feed, configEngine, aTokenImpl, vTokenImpl);

        vm.prank(roleList.marketOwner);
        contracts.aclManager.addPoolAdmin(address(payload));

        ReserveConfig[] memory allConfigsBefore = createConfigurationSnapshot(
            "preTestEngineListingCustomWithEModeCreation", IPool(address(contracts.poolProxy))
        );

        payload.execute();

        ReserveConfig[] memory allConfigsAfter = createConfigurationSnapshot(
            "postTestEngineListingCustomWithEModeCreation", IPool(address(contracts.poolProxy))
        );
    ...
    function testCapsUpdate() public {
        ...
        ReserveConfig[] memory allConfigsBefore =
            createConfigurationSnapshot("preTestEngineCaps", IPool(address(contracts.poolProxy)));

        payload.execute();

        ReserveConfig[] memory allConfigsAfter =
            createConfigurationSnapshot("postTestEngineCaps", IPool(address(contracts.poolProxy)));
    ...
    function testCollateralsUpdates() public {
        ...
        ReserveConfig[] memory allConfigsBefore =
            createConfigurationSnapshot("preTestEngineCollateral", IPool(address(contracts.poolProxy)));

        payload.execute();

        ReserveConfig[] memory allConfigsAfter =
            createConfigurationSnapshot("postTestEngineCollateral", IPool(address(contracts.poolProxy)));
    ...
    function testCollateralsUpdatesNoChange() public {
        ...
        ReserveConfig[] memory allConfigsBefore =
            createConfigurationSnapshot("preTestEngineCollateralNoChange", IPool(address(contracts.poolProxy)));

        payload.execute();

        ReserveConfig[] memory allConfigsAfter =
            createConfigurationSnapshot("postTestEngineCollateralNoChange", IPool(address(contracts.poolProxy)));
    ...
    function testCollateralUpdateCorrectBonus() public {
        ...
        ReserveConfig[] memory allConfigsBefore =
            createConfigurationSnapshot("preTestEngineCollateralEdgeBonus", IPool(address(contracts.poolProxy)));

        payload.execute();

        ReserveConfig[] memory allConfigsAfter =
            createConfigurationSnapshot("postTestEngineCollateralEdgeBonus", IPool(address(contracts.poolProxy)));
    ...
    function testCollateralUpdateLtZeroDebtCeilingShouldRevert() public {
        ...
        AaveV3MockCollateralUpdateLtZero payload = new AaveV3MockCollateralUpdateLtZero(asset, configEngine);
    ...
    function testCollateralUpdateLtZeroLiqProtocolFeeOnly() public {
        ...
        AaveV3MockCollateralUpdateLtZeroLiqProtocolFeeOnly payload =
            new AaveV3MockCollateralUpdateLtZeroLiqProtocolFeeOnly(asset, configEngine);

        vm.prank(roleList.marketOwner);
        contracts.aclManager.addPoolAdmin(address(payload));

        ReserveConfig[] memory allConfigsBefore = createConfigurationSnapshot(
            "preTestCollateralLtZeroLiqProtocolFeeOnly", IPool(address(contracts.poolProxy))
        );
        ...
        ReserveConfig[] memory allConfigsAfter = createConfigurationSnapshot(
            "postTestCollateralLtZeroLiqProtocolFeeOnly", IPool(address(contracts.poolProxy))
        );
    ...
    function testBorrowsUpdates() public {
        ...
        ReserveConfig[] memory allConfigsBefore =
            createConfigurationSnapshot("preTestEngineBorrow", IPool(address(contracts.poolProxy)));

        payload.execute();

        ReserveConfig[] memory allConfigsAfter =
            createConfigurationSnapshot("postTestEngineBorrow", IPool(address(contracts.poolProxy)));
    ...
    function testBorrowUpdatesNoChange() public {
        ...
        ReserveConfig[] memory allConfigsBefore =
            createConfigurationSnapshot("preTestEngineBorrowNoChange", IPool(address(contracts.poolProxy)));

        payload.execute();

        ReserveConfig[] memory allConfigsAfter =
            createConfigurationSnapshot("postTestEngineBorrowNoChange", IPool(address(contracts.poolProxy)));
    ...
    function testPriceFeedsUpdates() public {
        ...
        _validateAssetSourceOnOracle(IPoolAddressesProvider(address(contracts.poolAddressesProvider)), asset, newFeed);
    }
    ...
    function testPriceFeedUpdateInvalidDecimalsShouldRevert() public {
        ...
        AaveV3MockPriceFeedUpdateInvalidDecimals payload =
            new AaveV3MockPriceFeedUpdateInvalidDecimals(asset, invalidFeed, configEngine);
    ...
    function testEModeCategoryCreation() public {
        AaveV3MockEModeCategoryCreation payload = new AaveV3MockEModeCategoryCreation(
            tokenList.weth, tokenList.usdx, tokenList.wbtc, tokenList.weth, configEngine
        );
        ...
        _validateEmodeCategory(
            IPoolAddressesProvider(address(contracts.poolAddressesProvider)), 1, prevEmodeCategoryData
        );
        ...
        _validateEmodeCategory(
            IPoolAddressesProvider(address(contracts.poolAddressesProvider)), 2, prevEmodeCategoryData
        );
    }
    ...
    function testEModeCategoryUpdates() public {
        ...
        createConfigurationSnapshot("preTestEngineEModeCategoryUpdate", IPool(address(contracts.poolProxy)));

        payload.execute();

        createConfigurationSnapshot("postTestEngineEModeCategoryUpdate", IPool(address(contracts.poolProxy)));
    ...
    function testEModeCategoryUpdatesNoChange() public {
        ...
        DataTypes.EModeCategoryLegacy memory eModeCategoryDataBefore = contracts.poolProxy.getEModeCategoryData(1);
    ...
    function testAssetEModeUpdates() public {
        ...
        AaveV3MockAssetEModeUpdate payload = new AaveV3MockAssetEModeUpdate(asset, asset2, configEngine);
        ...
        DataTypes.ReserveDataLegacy memory reserveDataAsset2 = contracts.poolProxy.getReserveData(asset2);
        assertEq(EModeConfiguration.isReserveEnabledOnBitmap(collateralBitmap, reserveDataAsset2.id), true);
        assertEq(EModeConfiguration.isReserveEnabledOnBitmap(borrowableBitmap, reserveDataAsset2.id), false);
        assertEq(EModeConfiguration.isReserveEnabledOnBitmap(ltvzeroBitmap, reserveDataAsset2.id), true);
    }
}
