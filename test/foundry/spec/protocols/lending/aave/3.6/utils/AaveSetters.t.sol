...
contract AaveSettersTest is TestnetProcedures {
    ...
    function setUp() external {
        ...
        vm.prank(user);
        contracts.poolProxy
            .borrow({asset: asset, amount: 10 ether, interestRateMode: 2, referralCode: 0, onBehalfOf: user});
    }
    ...
    function test_setLiquidityIndex() external {
        ...
        assertEq(contracts.poolProxy.getReserveData(asset).currentLiquidityRate, oldReserveData.currentLiquidityRate);
    }
