...
import {ReserveConfiguration} from '@crane/contracts/protocols/lending/aave/v3.6/protocol/libraries/configuration/ReserveConfiguration.sol';
import {EModeConfiguration} from '@crane/contracts/protocols/lending/aave/v3.6/protocol/libraries/configuration/EModeConfiguration.sol';
import {UserConfiguration} from '@crane/contracts/protocols/lending/aave/v3.6/protocol/libraries/configuration/UserConfiguration.sol';
...
// Interfaces
import {ILendingHandler} from '@crane/test/foundry/spec/protocols/lending/aave/3.6/invariants/handlers/interfaces/ILendingHandler.sol';
import {IBorrowingHandler} from '@crane/test/foundry/spec/protocols/lending/aave/3.6/invariants/handlers/interfaces/IBorrowingHandler.sol';
import {ILiquidationHandler} from '@crane/test/foundry/spec/protocols/lending/aave/3.6/invariants/handlers/interfaces/ILiquidationHandler.sol';
import {IPoolHandler} from '@crane/test/foundry/spec/protocols/lending/aave/3.6/invariants/handlers/interfaces/IPoolHandler.sol';
...
import {IATokenHandler} from '@crane/test/foundry/spec/protocols/lending/aave/3.6/invariants/handlers/interfaces/IATokenHandler.sol';
