...
contract HubSweepTest is Base {
    ...
    function test_sweep_fuzz(uint256 supplyAmount, uint256 sweepAmount) public {
        ...
        emit Transfer(address(hub1), reinvestmentController, sweepAmount);
    ...
    function test_sweep_revertsWith_InsufficientLiquidity() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(IHub.InsufficientLiquidity.selector, initialLiquidity - swept));
    ...
    function test_sweep_does_not_impact_utilization(uint256 supplyAmount, uint256 drawAmount) public {
        ...
        _drawLiquidityViaTempSpoke({
            hub: hub1, assetId: daiAssetId, amount: drawAmount, withPremium: false, skipTime: false
        });
        ...
        assertEq(
            IBasicInterestRateStrategy(hub1.getAsset(daiAssetId).irStrategy)
