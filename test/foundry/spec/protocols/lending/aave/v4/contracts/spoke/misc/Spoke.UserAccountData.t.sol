...
contract SpokeUserAccountDataTest is Base {
    ...
    function test_userAccountData_scenario1() public {
        ...
        accountDataInfo.collateralDynamicConfigKeys.push(_getLastReserveConfigKey(_usdxReserveId(spoke)));
    ...
    function test_userAccountData_scenario5() public {
        ...
        accountDataInfo.collateralDynamicConfigKeys.push(_getLastReserveConfigKey(_wbtcReserveId(spoke)));
        accountDataInfo.debtReserveIds.push(_wethReserveId(spoke));
        accountDataInfo.drawnDebtAmounts.push(0.025e18);
        accountDataInfo.realizedPremiumAmountsRay.push(0.005e18 * WadRayMath.RAY);
        accountDataInfo.accruedPremiumAmounts.push(0.0075e18);
    ...
    function _checkedUserAccountData(bool refreshConfig, ISpoke.UserAccountData memory expectedUserAccountData)
        internal
    {
        spoke.mockStorage(user, accountDataInfo);

        ISpoke.UserAccountData memory userAccountData = spoke.calculateUserAccountData(user, refreshConfig);
