...
contract SpokeWithdrawHealthFactorTest is Base {
    ...
    function test_withdraw_revertsWith_HealthFactorBelowThreshold_singleBorrow() public {
        ...
        uint256 maxDebtAmount = _calcMaxDebtAmount({
            spoke: spoke1, collReserveId: collReserveId, debtReserveId: debtReserveId, collAmount: collAmount
        });

        // Alice supplies weth as collateral
        SpokeActions.supplyCollateral({
            spoke: spoke1, reserveId: collReserveId, caller: alice, amount: collAmount, onBehalfOf: alice
        });

        // Bob supplies dai
        SpokeActions.supply({
            spoke: spoke1, reserveId: debtReserveId, caller: bob, amount: maxDebtAmount, onBehalfOf: bob
        });

        // Alice borrows dai
        SpokeActions.borrow({
            spoke: spoke1, reserveId: debtReserveId, caller: alice, amount: maxDebtAmount, onBehalfOf: alice
        });
    ...
    function test_withdraw_fuzz_revertsWith_HealthFactorBelowThreshold_singleBorrow(uint256 debtAmount) public {
        ...
        uint256 collAmount = _calcMinimumCollAmount({
            spoke: spoke1, collReserveId: collReserveId, debtReserveId: debtReserveId, debtAmount: debtAmount
        });
        ...
        // Bob supplies dai
        SpokeActions.supply({spoke: spoke1, reserveId: debtReserveId, caller: bob, amount: debtAmount, onBehalfOf: bob});

        // Alice borrows dai
        SpokeActions.borrow({
            spoke: spoke1, reserveId: debtReserveId, caller: alice, amount: debtAmount, onBehalfOf: alice
        });
    ...
    function test_unsetCollateral_fuzz_revertsWith_HealthFactorBelowThreshold(uint256 daiBorrowAmount) public {
        daiBorrowAmount = bound(daiBorrowAmount, 1, MAX_SUPPLY_AMOUNT / 2);
        uint256 wbtcSupplyAmount =
            _calcMinimumCollAmount(spoke1, _wbtcReserveId(spoke1), _daiReserveId(spoke1), daiBorrowAmount);

        _openSupplyPosition(spoke1, _daiReserveId(spoke1), daiBorrowAmount);

        SpokeActions.supplyCollateral({
            spoke: spoke1, reserveId: _wbtcReserveId(spoke1), caller: alice, amount: wbtcSupplyAmount, onBehalfOf: alice
        });
        SpokeActions.borrow({
    ...
    function test_withdraw_revertsWith_HealthFactorBelowThreshold_price_drop() public {
        ...
        _mockReservePriceByPercent({spoke: spoke1, reserveId: collReserveId, percentage: 50_00});
    ...
    /// @dev fuzz - cannot withdraw an amount if resulting withdrawal would result in HF < threshold
    function test_withdraw_fuzz_revertsWith_HealthFactorBelowThreshold_price_drop(uint256 collAmount, uint256 newPrice)
        public
    {
        ...
        _mockReservePrice({spoke: spoke1, reserveId: collReserveId, price: newPrice});
    ...
    function test_withdraw_revertsWith_HealthFactorBelowThreshold_multiple_debts() public {
        ...
        uint256 wethCollAmountDai = _calcMinimumCollAmount({
            spoke: spoke1, collReserveId: wethReserveId, debtReserveId: daiReserveId, debtAmount: daiDebtAmount
        });

        uint256 wethCollAmountUsdx = _calcMinimumCollAmount({
            spoke: spoke1, collReserveId: wethReserveId, debtReserveId: usdxReserveId, debtAmount: usdxDebtAmount
        });
        ...
        // Bob supplies dai
        SpokeActions.supply({
            spoke: spoke1, reserveId: daiReserveId, caller: bob, amount: daiDebtAmount, onBehalfOf: bob
        });
        // Alice borrows dai
        SpokeActions.borrow({
            spoke: spoke1, reserveId: daiReserveId, caller: alice, amount: daiDebtAmount, onBehalfOf: alice
        });

        // Bob supplies usdx
        SpokeActions.supply({
            spoke: spoke1, reserveId: usdxReserveId, caller: bob, amount: usdxDebtAmount, onBehalfOf: bob
        });
        // Alice borrows usdx
        SpokeActions.borrow({
            spoke: spoke1, reserveId: usdxReserveId, caller: alice, amount: usdxDebtAmount, onBehalfOf: alice
        });
    ...
    function test_withdraw_fuzz_revertsWith_HealthFactorBelowThreshold_multiple_debts(
        ...
        vm.assume(
            wethCollAmountDai + wethCollAmountUsdx < MAX_SUPPLY_AMOUNT && wethCollAmountDai + wethCollAmountUsdx > 0
        );
        ...
        vm.expectRevert(ISpoke.HealthFactorBelowThreshold.selector);
        spoke1.withdraw({
            reserveId: wethReserveId, amount: (wethCollAmountDai + wethCollAmountUsdx) / 2, onBehalfOf: alice
    ...
    function test_withdraw_revertsWith_HealthFactorBelowThreshold_multiple_debts_price_drop() public {
        ...
        _mockReservePriceByPercent({spoke: spoke1, reserveId: wethReserveId, percentage: 50_00});
    ...
    function test_withdraw_fuzz_revertsWith_HealthFactorBelowThreshold_multiple_debts_price_drop(
        ...
        // collateral price drop so that alice is undercollateralized
        _mockReservePrice({spoke: spoke1, reserveId: wethReserveId, price: newPrice});
        vm.assume(_getUserHealthFactor(spoke1, alice) < HEALTH_FACTOR_LIQUIDATION_THRESHOLD);
    ...
    function test_withdraw_revertsWith_HealthFactorBelowThreshold_multiple_debts_with_interest() public {
        uint256 daiDebtAmount = 1000e18;
        uint256 usdxDebtAmount = 2000e6;
    ...
    function test_withdraw_revertsWith_HealthFactorBelowThreshold_multiple_colls() public {
        ...
        uint256 wethCollAmount = _calcMinimumCollAmount({
            spoke: spoke1, collReserveId: wethReserveId, debtReserveId: usdxReserveId, debtAmount: usdxDebtAmountWeth
        });
        uint256 daiCollAmount = _calcMinimumCollAmount({
            spoke: spoke1, collReserveId: daiReserveId, debtReserveId: usdxReserveId, debtAmount: usdxDebtAmountDai
        });

        // Bob supply weth collateral
        SpokeActions.supplyCollateral({
            spoke: spoke1, reserveId: wethReserveId, caller: bob, amount: wethCollAmount, onBehalfOf: bob
        });

        // Bob supply dai collateral
        SpokeActions.supplyCollateral({
            spoke: spoke1, reserveId: daiReserveId, caller: bob, amount: daiCollAmount, onBehalfOf: bob
        });
    ...
    function test_withdraw_revertsWith_HealthFactorBelowThreshold_multiple_colls_with_interest() public {
        // weth/dai collateral
        uint256 wethReserveId = _wethReserveId(spoke1);
        uint256 daiReserveId = _daiReserveId(spoke1);
        // usdx debt
    ...
    function test_withdraw_revertsWith_HealthFactorBelowThreshold_multiple_colls_price_drop_weth() public {
        // weth/dai collateral
        uint256 wethReserveId = _wethReserveId(spoke1);
        uint256 daiReserveId = _daiReserveId(spoke1);
        // usdx debt
    ...
    /// @dev cannot withdraw an amount if HF < 1 due to price drop, if multiple colls for same debt
    function test_withdraw_revertsWith_HealthFactorBelowThreshold_multiple_colls_price_drop_dai() public {
        // weth/dai collateral
        uint256 wethReserveId = _wethReserveId(spoke1);
        uint256 daiReserveId = _daiReserveId(spoke1);
        // usdx debt
        ...
        // collateral price drop by half so that bob is undercollateralized
        _mockReservePriceByPercent({spoke: spoke1, reserveId: daiReserveId, percentage: 50_00});
        // invalid HF
        assertLt(_getUserHealthFactor(spoke1, bob), HEALTH_FACTOR_LIQUIDATION_THRESHOLD);
    ...
    function test_withdraw_fuzz_revertsWith_HealthFactorBelowThreshold_multiple_colls_price_drop_dai(
        ...
        // collateral price drop by half so that bob is undercollateralized
        _mockReservePrice({spoke: spoke1, reserveId: daiReserveId, price: newPrice});
        // invalid HF
        vm.assume(_getUserHealthFactor(spoke1, bob) < HEALTH_FACTOR_LIQUIDATION_THRESHOLD);
