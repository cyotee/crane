...
contract TokenizationSpokeEdgeTest is TokenizationSpokeBaseTest {
    ...
    function test_deposit_revertsWith_ERC20InsufficientAllowance_noApproval() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(IERC20Errors.ERC20InsufficientAllowance.selector, address(vault), 0, assets)
        );
        vm.prank(alice);
        vault.deposit(assets, alice);
    }
    ...
    function test_mint_revertsWith_ERC20InsufficientAllowance_noApproval() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(IERC20Errors.ERC20InsufficientAllowance.selector, address(vault), 0, neededAssets)
        );
        vm.prank(alice);
    ...
    function test_withdraw_revertsWith_ERC20InsufficientBalance() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(IERC20Errors.ERC20InsufficientBalance.selector, alice, aliceShares, neededShares)
        );
        vm.prank(alice);
    ...
    function test_redeem_revertsWith_ERC20InsufficientBalance_on_InsufficientShares() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(IERC20Errors.ERC20InsufficientBalance.selector, alice, shares, redeemShares)
        );
        vm.prank(alice);
