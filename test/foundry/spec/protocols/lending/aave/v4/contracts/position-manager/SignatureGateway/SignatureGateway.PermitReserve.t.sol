...
contract SignatureGatewayPermitReserveTest is SignatureGatewayBaseTest {
    ...
    function test_permitReserve_forwards_correct_call() public {
        ...
        vm.prank(vm.randomAddress());
        gateway.permitReserveUnderlying(address(spoke1), reserveId, owner, value, deadline, v, r, s);
    }
    ...
    function test_permitReserve() public {
        ...
        emit Approval(user, address(gateway), params.value);
        vm.prank(vm.randomAddress());
        gateway.permitReserveUnderlying(address(spoke1), reserveId, user, params.value, params.deadline, v, r, s);
