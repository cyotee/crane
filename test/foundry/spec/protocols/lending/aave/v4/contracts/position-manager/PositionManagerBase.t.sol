...
import {
    PositionManagerNoMulticall
} from "@crane/test/foundry/spec/protocols/lending/aave/v4/helpers/mocks/PositionManagerNoMulticall.sol";

contract PositionManagerBaseTest is Base {
    ...
    function test_setSelfAsUserPositionManagerWithSig() public {
        ...
        positionManager.setSelfAsUserPositionManagerWithSig(
            address(spoke1), p.onBehalfOf, p.updates[0].approve, p.nonce, p.deadline, signature
        );
    ...
    function test_permitReserveUnderlying_forwards_correct_call() public {
        ...
        vm.prank(vm.randomAddress());
        positionManager.permitReserveUnderlying(address(spoke1), reserveId, owner, value, deadline, v, r, s);
    }
    ...
    function test_permitReserveUnderlying() public {
        ...
        emit Approval(user, address(positionManager), params.value);
        vm.prank(vm.randomAddress());
        positionManager.permitReserveUnderlying(
            address(spoke1), reserveId, user, params.value, params.deadline, v, r, s
        );
