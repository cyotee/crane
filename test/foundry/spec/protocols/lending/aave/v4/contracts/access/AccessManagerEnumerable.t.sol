...
} from "@crane/contracts/protocols/lending/aave/v4/access/AccessManagerEnumerable.sol";
...
contract AccessManagerEnumerableTest is Test {
    ...
    function test_grantRole() public {
        ...
        address[] memory roleMembers =
            accessManagerEnumerable.getRoleMembers(roleId, 0, accessManagerEnumerable.getRoleMemberCount(roleId));
    ...
    function test_grantRole_fuzz(uint64 roleId, uint256 membersCount) public {
        ...
        vm.assume(roleId != accessManagerEnumerable.PUBLIC_ROLE() && roleId != accessManagerEnumerable.ADMIN_ROLE());
    ...
    function test_setRoleAdmin_trackAdminOfRoles() public {
        ...
        uint64[] memory adminOfRolesList = accessManagerEnumerable.getRolesOfAdminRole(
            NEW_ADMIN_ROLE, 0, accessManagerEnumerable.getRoleOfAdminRoleCount(NEW_ADMIN_ROLE)
        );
        ...
        adminOfRolesList = accessManagerEnumerable.getRolesOfAdminRole(
            ADMIN_ROLE, 0, accessManagerEnumerable.getRoleOfAdminRoleCount(ADMIN_ROLE)
        );
    ...
    function test_setRoleAdmin_fuzz_trackRolesAndTrackAdminRoles_multipleRoles(uint256 rolesCount) public {
        ...
        uint64[] memory roleList = accessManagerEnumerable.getRoles(0, accessManagerEnumerable.getRoleCount());
    ...
    function test_setRoleAdmin_fuzz_trackAdminRoles_multipleRoles_multipleAdmins(uint256 rolesCount) public {
        rolesCount = bound(rolesCount, 1, 15);
        ...
        uint64[] memory adminRoleList =
            accessManagerEnumerable.getAdminRoles(0, accessManagerEnumerable.getAdminRoleCount());
        ...
        for (uint256 i = 0; i < internalAdminRoles.length(); i++) {
            ...
            uint64[] memory adminOfRolesList = accessManagerEnumerable.getRolesOfAdminRole(
                adminRoleId, 0, accessManagerEnumerable.getRoleOfAdminRoleCount(adminRoleId)
            );
            assertEq(
                accessManagerEnumerable.getRoleOfAdminRoleCount(adminRoleId), internalAdminOfRoles[adminRoleId].length()
            );
    ...
    function test_setTargetFunctionRole() public {
        ...
        bytes4[] memory roleSelectors = accessManagerEnumerable.getRoleTargetSelectors(
            roleId, target, 0, accessManagerEnumerable.getRoleTargetSelectorCount(roleId, target)
        );
        ...
        address[] memory roleTargets =
            accessManagerEnumerable.getRoleTargets(roleId, 0, accessManagerEnumerable.getRoleTargetCount(roleId));
    ...
    function test_setTargetFunctionRole_withReplace() public {
        ...
        assertEq(accessManagerEnumerable.getRoleTargetSelector(roleId, target, 1), selector2);
        assertEq(accessManagerEnumerable.getRoleTargetSelector(roleId, target, 2), selector3);
        bytes4[] memory roleSelectors = accessManagerEnumerable.getRoleTargetSelectors(roleId, target, 0, 3);
        assertEq(roleSelectors.length, 3);
        assertEq(roleSelectors[0], selector1);
        assertEq(roleSelectors[1], selector2);
        assertEq(roleSelectors[2], selector3);
        ...
        {
            bytes4[] memory roleSelectors1 = accessManagerEnumerable.getRoleTargetSelectors(roleId, target, 0, 3);
            bytes4[] memory roleSelectors2 = accessManagerEnumerable.getRoleTargetSelectors(roleId2, target, 0, 3);
    ...
    function test_getRoleMembers_fuzz(uint256 startIndex, uint256 endIndex) public {
        ...
        address[] memory roleMembers = accessManagerEnumerable.getRoleMembers(roleId, startIndex, endIndex);
    ...
    function test_getRoleTargetSelectors_fuzz(uint256 startIndex, uint256 endIndex) public {
        ...
        bytes4[] memory roleSelectors =
            accessManagerEnumerable.getRoleTargetSelectors(roleId, target, startIndex, endIndex);
    ...
    function test_labelRole_relabel() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(IAccessManagerEnumerable.AccessManagerUnregisteredLabel.selector, "OLD_LABEL")
        );
    ...
    function test_labelRole_revertsWithAlreadyLabeledRole() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(IAccessManagerEnumerable.AccessManagerRoleAlreadyLabeled.selector, roleId)
        );
        accessManagerEnumerable.labelRole(roleId, "NEW_LABEL");
        vm.stopPrank();
    }
    ...
    function test_labelRole_removeLabelOnUnlabeledRole_revertsWithUnlabeledRole() public {
        ...
        vm.prank(ADMIN);
        vm.expectRevert(abi.encodeWithSelector(IAccessManagerEnumerable.AccessManagerUnlabeledRole.selector, roleId));
        accessManagerEnumerable.labelRole(roleId, "");
    }
    ...
    function test_getLabelRole_revertsWithUnregisteredLabel() public {
        vm.expectRevert(
            abi.encodeWithSelector(IAccessManagerEnumerable.AccessManagerUnregisteredLabel.selector, "NONEXISTENT")
        );
    ...
    function test_labelRole_revertsWithDuplicateLabel() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IAccessManagerEnumerable.AccessManagerLabelAlreadyUsed.selector, "SHARED_LABEL", roleId1
            )
        );
    ...
    function test_labelRole_revertsWithAlreadyLabeledRole_evenIfLabelAlsoUsed() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(IAccessManagerEnumerable.AccessManagerRoleAlreadyLabeled.selector, roleId2)
        );
    ...
    function test_labelRole_removeLabel() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(IAccessManagerEnumerable.AccessManagerUnregisteredLabel.selector, "MY_LABEL")
        );
    ...
    function test_labelRole_onlyAuthorized_revertsWithUnauthorizedAccount() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(IAccessManager.AccessManagerUnauthorizedAccount.selector, address(this), ADMIN_ROLE)
        );
        accessManagerEnumerable.labelRole(roleId, "MY_LABEL");
    }
    ...
    function test_getRoleOfTargetSelector() public {
        ...
        assertEq(accessManagerEnumerable.getRoleOfTargetSelector(target, selector2), roleId2);
        assertEq(accessManagerEnumerable.getRoleOfTargetSelector(target, selectorUnassigned), ADMIN_ROLE);
    }
    ...
    function test_getLabelOfRole_revertsForAdminRole() public {
        vm.expectRevert(
            abi.encodeWithSelector(IAccessManagerEnumerable.AccessManagerUnlabeledRole.selector, ADMIN_ROLE)
        );
    ...
    function test_getLabelOfRole_revertsForPublicRole() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(IAccessManagerEnumerable.AccessManagerUnlabeledRole.selector, publicRole)
        );
    ...
    function test_isRole_excludesAdminAndPublicRole() public {
        ...
        vm.startPrank(ADMIN);
        accessManagerEnumerable.setTargetFunctionRole(target, selectors, accessManagerEnumerable.ADMIN_ROLE());
        assertFalse(accessManagerEnumerable.isRole(accessManagerEnumerable.ADMIN_ROLE()));

        accessManagerEnumerable.setTargetFunctionRole(target, selectors, accessManagerEnumerable.PUBLIC_ROLE());
