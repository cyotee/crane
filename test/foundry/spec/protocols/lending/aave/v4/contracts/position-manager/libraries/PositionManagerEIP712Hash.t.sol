...
contract PositionManagerEIP712HashTest is Test {
    ...
    function test_constants() public pure {
        ...
        assertEq(EIP712Hash.SUPPLY_TYPEHASH, vm.eip712HashType(EIP712Types.TYPE_Supply));
        ...
        assertEq(EIP712Hash.WITHDRAW_TYPEHASH, vm.eip712HashType(EIP712Types.TYPE_Withdraw));
        ...
        assertEq(EIP712Hash.BORROW_TYPEHASH, vm.eip712HashType(EIP712Types.TYPE_Borrow));
        ...
        assertEq(EIP712Hash.REPAY_TYPEHASH, vm.eip712HashType(EIP712Types.TYPE_Repay));
        ...
        assertEq(EIP712Hash.SET_USING_AS_COLLATERAL_TYPEHASH, vm.eip712HashType(EIP712Types.TYPE_SetUsingAsCollateral));
        ...
        assertEq(EIP712Hash.WITHDRAW_PERMIT_TYPEHASH, vm.eip712HashType(EIP712Types.TYPE_WithdrawPermit));
        ...
        assertEq(EIP712Hash.BORROW_PERMIT_TYPEHASH, vm.eip712HashType(EIP712Types.TYPE_BorrowPermit));
    }
    ...
    function test_hash_supply_fuzz(ISignatureGateway.Supply calldata params) public pure {
        ...
        assertEq(params.hash(), vm.eip712HashStruct(EIP712Types.TYPE_Supply, abi.encode(params)));
    }
    ...
    function test_hash_withdraw_fuzz(ISignatureGateway.Withdraw calldata params) public pure {
        ...
        assertEq(params.hash(), expectedHash);
        assertEq(params.hash(), vm.eip712HashStruct(EIP712Types.TYPE_Withdraw, abi.encode(params)));
    }
    ...
    function test_hash_borrow_fuzz(ISignatureGateway.Borrow calldata params) public pure {
        ...
        assertEq(params.hash(), expectedHash);
        assertEq(params.hash(), vm.eip712HashStruct(EIP712Types.TYPE_Borrow, abi.encode(params)));
    }
    ...
    function test_hash_repay_fuzz(ISignatureGateway.Repay calldata params) public pure {
        ...
        assertEq(params.hash(), expectedHash);
        assertEq(params.hash(), vm.eip712HashStruct(EIP712Types.TYPE_Repay, abi.encode(params)));
    }

    function test_hash_setUsingAsCollateral_fuzz(ISignatureGateway.SetUsingAsCollateral calldata params) public pure {
        bytes32 expectedHash = keccak256(abi.encode(EIP712Hash.SET_USING_AS_COLLATERAL_TYPEHASH, params));
        assertEq(params.hash(), expectedHash);
        assertEq(params.hash(), vm.eip712HashStruct(EIP712Types.TYPE_SetUsingAsCollateral, abi.encode(params)));
    }

    function test_hash_updateUserRiskPremium_fuzz(ISignatureGateway.UpdateUserRiskPremium calldata params) public pure {
        bytes32 expectedHash = keccak256(abi.encode(EIP712Hash.UPDATE_USER_RISK_PREMIUM_TYPEHASH, params));
        assertEq(params.hash(), expectedHash);
        assertEq(params.hash(), vm.eip712HashStruct(EIP712Types.TYPE_UpdateUserRiskPremium, abi.encode(params)));
    }

    function test_hash_updateUserDynamicConfig_fuzz(ISignatureGateway.UpdateUserDynamicConfig calldata params)
        public
        pure
    {
        bytes32 expectedHash = keccak256(abi.encode(EIP712Hash.UPDATE_USER_DYNAMIC_CONFIG_TYPEHASH, params));
        assertEq(params.hash(), expectedHash);
        assertEq(params.hash(), vm.eip712HashStruct(EIP712Types.TYPE_UpdateUserDynamicConfig, abi.encode(params)));
    }

    function test_hash_withdrawPermit_fuzz(ITakerPositionManager.WithdrawPermit calldata params) public pure {
        bytes32 expectedHash = keccak256(abi.encode(EIP712Hash.WITHDRAW_PERMIT_TYPEHASH, params));

        assertEq(params.hash(), expectedHash);
    }

    function test_hash_borrowPermit_fuzz(ITakerPositionManager.BorrowPermit calldata params) public pure {
