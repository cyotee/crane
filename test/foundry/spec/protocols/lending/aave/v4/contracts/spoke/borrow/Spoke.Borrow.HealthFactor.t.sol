...
contract SpokeBorrowHealthFactorTest is Base {
    ...
    function test_borrow_revertsWith_HealthFactorBelowThreshold() public {
        ...
        uint256 maxDebtAmount = _calcMaxDebtAmount({
            spoke: spoke1, collReserveId: wethReserveId, debtReserveId: daiReserveId, collAmount: wethSupplyAmount
        });

        // Bob supply weth
        SpokeActions.supplyCollateral({
            spoke: spoke1, reserveId: wethReserveId, caller: bob, amount: wethSupplyAmount, onBehalfOf: bob
        });

        // Alice supply dai
        SpokeActions.supply({
            spoke: spoke1, reserveId: daiReserveId, caller: alice, amount: maxDebtAmount * 2, onBehalfOf: alice
    ...
    function test_borrow_revertsWith_HealthFactorBelowThreshold_multiple_debts() public {
        ...
        // Alice supply dai
        SpokeActions.supply({
            spoke: spoke1, reserveId: daiReserveId, caller: alice, amount: daiDebtAmount * 2, onBehalfOf: alice
        }); // supply enough buffer for multiple borrows
        // Alice supply usdx
        SpokeActions.supply({
            spoke: spoke1, reserveId: usdxReserveId, caller: alice, amount: usdxDebtAmount * 2, onBehalfOf: alice
        }); // supply enough buffer for multiple borrows
    ...
    function test_borrow_fuzz_revertsWith_HealthFactorBelowThreshold_multiple_debts(
        ...
        uint256 daiDebtAmount = _calcMaxDebtAmount({
            spoke: spoke1, collReserveId: wethReserveId, debtReserveId: daiReserveId, collAmount: wethCollAmountDai
        });
        uint256 usdxDebtAmount = _calcMaxDebtAmount({
            spoke: spoke1, collReserveId: wethReserveId, debtReserveId: usdxReserveId, collAmount: wethCollAmountUsdx
        });
    ...
    function test_borrow_revertsWith_HealthFactorBelowThreshold_multiple_debts_with_interest() public {
        // weth collateral
        uint256 wethReserveId = _wethReserveId(spoke1);
        // dai/usdx debt
        uint256 daiReserveId = _daiReserveId(spoke1);
    ...
    function test_borrow_fuzz_revertsWith_HealthFactorBelowThreshold_multiple_debts_with_interest(
        ...
        uint256 daiDebtAmount = _calcMaxDebtAmount({
            spoke: spoke1, collReserveId: wethReserveId, debtReserveId: daiReserveId, collAmount: wethCollForDai
        });
        uint256 usdxDebtAmount = _calcMaxDebtAmount({
            spoke: spoke1, collReserveId: wethReserveId, debtReserveId: usdxReserveId, collAmount: wethCollForUsdx
        });
        ...
        SpokeActions.supplyCollateral({
            ...
            reserveId: wethReserveId,
            caller: bob,
            amount: wethCollForDai + wethCollForUsdx,
            onBehalfOf: bob
        });
    ...
    function test_borrow_revertsWith_HealthFactorBelowThreshold_multiple_colls() public {
        ...
        SpokeActions.supply({
            ...
            caller: alice,
            amount: (usdxDebtAmountWeth + usdxDebtAmountDai) * 2,
            onBehalfOf: alice
        }); // supply enough buffer for multiple borrows
    ...
    function test_borrow_fuzz_revertsWith_HealthFactorBelowThreshold_multiple_colls(
        ...
        SpokeActions.supply({
            ...
            reserveId: usdxReserveId,
            caller: alice,
            amount: (usdxDebtAmountWeth + usdxDebtAmountDai) + 1,
            onBehalfOf: alice
        }); // supply enough buffer for multiple borrows
    ...
    function test_borrow_revertsWith_HealthFactorBelowThreshold_multiple_colls_with_interest() public {
        // weth/dai collateral
        uint256 wethReserveId = _wethReserveId(spoke1);
        uint256 daiReserveId = _daiReserveId(spoke1);
        // usdx debt
    ...
    function test_borrow_fuzz_revertsWith_HealthFactorBelowThreshold_multiple_colls_with_interest(
        ...
        // Alice supply usdx
        SpokeActions.supply({
            spoke: spoke1, reserveId: usdxReserveId, caller: alice, amount: MAX_SUPPLY_AMOUNT, onBehalfOf: alice
        }); // supply enough buffer for multiple borrows
    ...
    function test_borrow_revertsWith_HealthFactorBelowThreshold_multiple_colls_collateral_price_drop_weth() public {
        // weth/dai collateral
        uint256 wethReserveId = _wethReserveId(spoke1);
        uint256 daiReserveId = _daiReserveId(spoke1);
        // usdx debt
    ...
    /// cannot borrow more with multiple colls for same debt, if HF drops below threshold due to price drop
    function test_borrow_revertsWith_HealthFactorBelowThreshold_multiple_colls_collateral_price_drop_dai() public {
        // weth/dai collateral
        uint256 wethReserveId = _wethReserveId(spoke1);
        uint256 daiReserveId = _daiReserveId(spoke1);
        // usdx debt
