...
} from "@crane/test/foundry/spec/protocols/lending/aave/v4/helpers/mocks/ReserveFlagsMapWrapper.sol";
...
contract ReserveFlagsMapTest is Test {
    ...
    function test_create_fuzz(bool paused, bool frozen, bool borrowable, bool receiveSharesEnabled) public view {
    ...
    function _sanitizeFlags(uint8 rawFlags) internal pure returns (ReserveFlags) {
        uint8 sanitizedFlags = rawFlags & (PAUSED_MASK | FROZEN_MASK | BORROWABLE_MASK | RECEIVE_SHARES_ENABLED_MASK);
