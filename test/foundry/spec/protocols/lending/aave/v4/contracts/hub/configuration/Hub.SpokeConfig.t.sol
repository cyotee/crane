...
contract HubSpokeConfigTest is Base {
    ...
    function test_add_active_halted_scenarios() public {
        ...
        HubActions.add({hub: hub1, assetId: usdxAssetId, caller: address(spoke1), amount: 1, user: alice});
    ...
    function test_remove_active_halted_scenarios() public {
        HubActions.add({hub: hub1, assetId: usdxAssetId, caller: address(spoke1), amount: 100, user: alice});
        ...
        HubActions.remove({hub: hub1, assetId: usdxAssetId, caller: address(spoke1), amount: 1, to: alice});
    ...
    function test_draw_active_halted_scenarios() public {
        ...
        HubActions.draw({hub: hub1, assetId: usdxAssetId, caller: address(spoke1), to: alice, amount: 1});
    ...
    function test_restore_active_halted_scenarios() public {
        HubActions.draw({hub: hub1, assetId: usdxAssetId, caller: address(spoke1), to: alice, amount: 100});
        ...
        HubActions.restoreDrawn({
            hub: hub1, assetId: usdxAssetId, caller: address(spoke1), drawnAmount: 1, restorer: alice
        });
    ...
    function test_eliminateDeficit_active_halted_scenarios() public {
        ...
        HubActions.add({hub: hub1, assetId: usdxAssetId, caller: callerSpoke, amount: 1e18, user: alice});
    ...
    function test_payFeeShares_active_halted_scenarios() public {
        address feeReceiver = _getFeeReceiver(hub1, usdxAssetId);
        HubActions.add({hub: hub1, assetId: usdxAssetId, caller: address(spoke1), amount: 1e18, user: alice});
    ...
    function _accrueLiquidityFees(IHub hub, ISpoke spoke, uint256 assetId) internal {
        HubActions.add({hub: hub, assetId: wbtcAssetId, caller: address(spoke), amount: 1e18, user: alice});
