...
contract SpokeRiskPremiumTest is Base {
    ...
    function test_getUserRiskPremium_no_collateral() public view {
        ...
        for (uint256 reserveId = 0; reserveId < spoke1.getReserveCount(); reserveId++) {
            ISpoke.UserPosition memory bobInfo = _getUserInfo(spoke1, bob, reserveId);
    ...
    function test_getUserRiskPremium_single_reserve_collateral() public {
        ...
        SpokeActions.supplyCollateral({
            spoke: spoke1, reserveId: daiReserveId, caller: bob, amount: daiAmount, onBehalfOf: bob
        });
    ...
    function test_getUserRiskPremium_fuzz_single_reserve_collateral_borrowed_amount(uint256 borrowAmount) public {
        ...
        // Bob supply dai into spoke1
        SpokeActions.supplyCollateral({
            spoke: spoke1, reserveId: daiInfo.reserveId, caller: bob, amount: daiInfo.supplyAmount, onBehalfOf: bob
        });
        SpokeActions.borrow({
            spoke: spoke1, reserveId: daiInfo.reserveId, caller: bob, amount: daiInfo.borrowAmount, onBehalfOf: bob
        });
    ...
    function test_getUserRiskPremium_fuzz_supply_does_not_impact(uint256 borrowAmount, uint256 additionalSupplyAmount)
        public
    {
        borrowAmount = bound(borrowAmount, 1, MAX_SUPPLY_AMOUNT_DAI / 2);
        ...
        SpokeActions.supplyCollateral({
            spoke: spoke1, reserveId: usdxInfo.reserveId, caller: bob, amount: additionalSupplyAmount, onBehalfOf: bob
        });
    ...
    function test_riskPremium_collateral_insufficient_to_cover_debt() public {
        ...
        SpokeActions.supplyCollateral({
            spoke: spoke2, reserveId: _wbtcReserveId(spoke2), caller: bob, amount: wbtcSupplyAmount, onBehalfOf: bob
        });
        SpokeActions.supplyCollateral({
            spoke: spoke2, reserveId: _daiReserveId(spoke2), caller: bob, amount: daiSupplyAmount, onBehalfOf: bob
        });
        SpokeActions.supplyCollateral({
            spoke: spoke2, reserveId: _usdxReserveId(spoke2), caller: bob, amount: usdxSupplyAmount, onBehalfOf: bob
        });
        SpokeActions.supplyCollateral({
            spoke: spoke2, reserveId: _wethReserveId(spoke2), caller: bob, amount: wethSupplyAmount, onBehalfOf: bob
        });

        // Bob borrows usdz
        SpokeActions.borrow({
            spoke: spoke2, reserveId: _usdzReserveId(spoke2), caller: bob, amount: borrowAmount, onBehalfOf: bob
        });

        assertEq(_getUserRiskPremium(spoke2, bob), _calculateExpectedUserRP(spoke2, bob), "user risk premium");
        ...
        uint256 collateralValue = _convertAmountToValue(spoke2, _wbtcReserveId(spoke2), wbtcSupplyAmount)
    ...
    function test_riskPremium_postActions() public {
        ...
        SpokeActions.supplyCollateral({
            spoke: spoke1, reserveId: _usdxReserveId(spoke1), caller: bob, amount: 1000e6, onBehalfOf: bob
        });

        SpokeActions.borrow({
            spoke: spoke1, reserveId: _daiReserveId(spoke1), caller: bob, amount: 500e18, onBehalfOf: bob
        });
        _assertUserRpUnchanged(spoke1, bob);
        SpokeActions.borrow({
            spoke: spoke1, reserveId: _usdxReserveId(spoke1), caller: bob, amount: 750e6, onBehalfOf: bob
        });
        _assertUserRpUnchanged(spoke1, bob);
        ...
        SpokeActions.withdraw({
            spoke: spoke1, reserveId: _daiReserveId(spoke1), caller: bob, amount: 0.01e18, onBehalfOf: bob
        });
        _assertUserRpUnchanged(spoke1, bob);

        SpokeActions.withdraw({
            spoke: spoke1, reserveId: _usdxReserveId(spoke1), caller: bob, amount: 0.01e6, onBehalfOf: bob
        });
        _assertUserRpUnchanged(spoke1, bob);
        ...
        SpokeActions.repay({
            spoke: spoke1, reserveId: _daiReserveId(spoke1), caller: bob, amount: 25e18, onBehalfOf: bob
        });
    ...
    function test_getUserRiskPremium_multi_reserve_collateral() public {
        ...
        SpokeActions.supplyCollateral({
            spoke: spoke1, reserveId: usdxInfo.reserveId, caller: bob, amount: usdxInfo.supplyAmount, onBehalfOf: bob
        });

        // Bob supply weth into spoke1
        SpokeActions.supplyCollateral({
            spoke: spoke1, reserveId: wethInfo.reserveId, caller: bob, amount: wethInfo.supplyAmount, onBehalfOf: bob
        });
        ...
        SpokeActions.borrow({
            spoke: spoke1, reserveId: usdxInfo.reserveId, caller: bob, amount: usdxInfo.borrowAmount, onBehalfOf: bob
        });
    ...
    function test_getUserRiskPremium_multi_reserve_collateral_lower_rp_than_highest_cr() public {
        ...
        SpokeActions.supplyCollateral({
            spoke: spoke2, reserveId: daiInfo.reserveId, caller: bob, amount: daiInfo.supplyAmount, onBehalfOf: bob
        });

        // Bob supply usdz into spoke2
        SpokeActions.supplyCollateral({
            spoke: spoke2, reserveId: usdzInfo.reserveId, caller: bob, amount: usdzInfo.supplyAmount, onBehalfOf: bob
        });

        // Bob supply usdx into spoke2
        SpokeActions.supplyCollateral({
            spoke: spoke2, reserveId: usdxInfo.reserveId, caller: bob, amount: usdxInfo.supplyAmount, onBehalfOf: bob
        });

        // Bob supply weth into spoke2
        SpokeActions.supplyCollateral({
            spoke: spoke2, reserveId: wethInfo.reserveId, caller: bob, amount: wethInfo.supplyAmount, onBehalfOf: bob
        });

        // Bob draw dai + usdx
        SpokeActions.borrow({
            spoke: spoke2, reserveId: daiInfo.reserveId, caller: bob, amount: daiInfo.borrowAmount, onBehalfOf: bob
        });
    ...
    function test_getUserRiskPremium_two_reserves_equal_parts() public {
        ...
        SpokeActions.supplyCollateral({
            spoke: spoke1,
            reserveId: wethInfo.reserveId,
            caller: alice,
            amount: wethInfo.supplyAmount,
            onBehalfOf: alice
        });

        // Bob draw weth
        SpokeActions.borrow({
            spoke: spoke1, reserveId: wethInfo.reserveId, caller: bob, amount: wethInfo.borrowAmount, onBehalfOf: bob
        });
        ...
        assertEq(expectedRiskPremium, (daiInfo.collateralRisk + usdxInfo.collateralRisk) / 2, "user risk premium");
    ...
    function test_getUserRiskPremium_fuzz_two_reserves_supply_and_borrow(
        ...
        if (daiInfo.supplyAmount > 0) {
            SpokeActions.supplyCollateral({
                spoke: spoke3, reserveId: daiInfo.reserveId, caller: bob, amount: daiInfo.supplyAmount, onBehalfOf: bob
            });
        }
        ...
        SpokeActions.supplyCollateral({
            spoke: spoke3, reserveId: wethInfo.reserveId, caller: bob, amount: wethInfo.supplyAmount, onBehalfOf: bob
        });
        ...
        assertEq(_getUserRiskPremium(spoke3, bob), _calculateExpectedUserRP(spoke3, bob), "user risk premium");
    }
    ...
    function test_getUserRiskPremium_fuzz_three_reserves_supply_and_borrow(
        ...
        SpokeActions.supplyCollateral({
            spoke: spoke3, reserveId: wbtcInfo.reserveId, caller: bob, amount: wbtcInfo.supplyAmount, onBehalfOf: bob
        });
    ...
    function test_getUserRiskPremium_fuzz_four_reserves_supply_and_borrow(
        ...
        // Bob supply usdz into spoke2
        SpokeActions.supplyCollateral({
            spoke: spoke2, reserveId: usdzInfo.reserveId, caller: bob, amount: MAX_SUPPLY_AMOUNT_USDZ, onBehalfOf: bob
        });
        ...
        if (usdzInfo.borrowAmount > 0) {
            SpokeActions.borrow({
                spoke: spoke2,
                reserveId: usdzInfo.reserveId,
                caller: bob,
                amount: usdzInfo.borrowAmount,
                onBehalfOf: bob
            });
        }
    ...
    function test_getUserRiskPremium_fuzz_four_reserves_prices_supply_debt(
        ...
        vm.assume(
            daiInfo.supplyAmount + wethInfo.supplyAmount + usdxInfo.supplyAmount + wbtcInfo.supplyAmount
                <= MAX_SUPPLY_AMOUNT
        );
        vm.assume(
            daiInfo.borrowAmount + wethInfo.borrowAmount + usdxInfo.borrowAmount + wbtcInfo.borrowAmount
                <= MAX_SUPPLY_AMOUNT / 2
        );
        ...
        daiInfo.collateralRisk = bound(daiInfo.collateralRisk, 0, MAX_ALLOWED_COLLATERAL_RISK).toUint24();
        wethInfo.collateralRisk = bound(wethInfo.collateralRisk, 0, MAX_ALLOWED_COLLATERAL_RISK).toUint24();
        usdxInfo.collateralRisk = bound(usdxInfo.collateralRisk, 0, MAX_ALLOWED_COLLATERAL_RISK).toUint24();
        wbtcInfo.collateralRisk = bound(wbtcInfo.collateralRisk, 0, MAX_ALLOWED_COLLATERAL_RISK).toUint24();
    ...
    function test_getUserRiskPremium_fuzz_applyingInterest(
        ...
        assertEq(
            _getUserRiskPremium(spoke3, bob), _calculateExpectedUserRP(spoke3, bob), "bob risk premium after time skip"
        );
    ...
    function test_getUserRiskPremium_fuzz_applyInterest_two_reserves_borrowed(
        ...
        if (MAX_SUPPLY_AMOUNT_WETH - wethInfo.supplyAmount > 0) {
            _openSupplyPosition(spoke3, wethInfo.reserveId, MAX_SUPPLY_AMOUNT_WETH - wethInfo.supplyAmount);
        }
        ...
        (debtChecks.actualDrawnDebt, debtChecks.actualPremium) = spoke3.getUserDebt(wbtcInfo.reserveId, bob);
        uint40 startTime = vm.getBlockTimestamp().toUint40();
        ...
        (debtChecks.actualDrawnDebt, debtChecks.actualPremium) = spoke3.getUserDebt(wethInfo.reserveId, bob);
        ...
        // See if drawn debt of wbtc changes appropriately
        debtChecks.drawnDebt =
            MathUtils.calculateLinearInterest(baseRateWbtc, startTime).rayMulUp(wbtcInfo.borrowAmount);
        (debtChecks.actualDrawnDebt, debtChecks.actualPremium) = spoke3.getUserDebt(wbtcInfo.reserveId, bob);
        ...
        debtChecks.premiumDebt = (debtChecks.drawnDebt - wbtcInfo.borrowAmount).percentMulUp(expectedUserRiskPremium);
        assertApproxEqAbs(debtChecks.premiumDebt, debtChecks.actualPremium, 1, "user premium debt after accrual");
        ...
        assertApproxEqAbs(debtChecks.reservePremium, debtChecks.premiumDebt, 1, "reserve premium debt after accrual");

        // See if values are reflected on hub side as well
        (debtChecks.spokeOwed, debtChecks.spokePremium) = hub1.getSpokeOwed(wbtcAssetId, address(spoke3));
        assertEq(debtChecks.spokeOwed, debtChecks.drawnDebt, "hub spoke drawn debt after accrual");
        assertApproxEqAbs(debtChecks.spokePremium, debtChecks.premiumDebt, 1, "hub spoke premium debt after accrual");
        ...
        assertApproxEqAbs(debtChecks.assetPremium, debtChecks.premiumDebt, 1, "hub asset premium debt after accrual");

        // See if drawn debt of weth changes appropriately
        debtChecks.drawnDebt =
            MathUtils.calculateLinearInterest(baseRateWeth, startTime).rayMulUp(wethInfo.borrowAmount);
        (debtChecks.actualDrawnDebt, debtChecks.actualPremium) = spoke3.getUserDebt(wethInfo.reserveId, bob);
        assertEq(debtChecks.drawnDebt, debtChecks.actualDrawnDebt, "user drawn debt");

        // See if premium debt changes proportionally to user risk premium
        debtChecks.premiumDebt = (debtChecks.drawnDebt - wethInfo.borrowAmount).percentMulUp(expectedUserRiskPremium);
        assertApproxEqAbs(debtChecks.premiumDebt, debtChecks.actualPremium, 1, "user premium debt after accrual");
        ...
        // See if values are reflected on hub side as well
        (debtChecks.spokeOwed, debtChecks.spokePremium) = hub1.getSpokeOwed(wethAssetId, address(spoke3));
        assertEq(debtChecks.spokeOwed, debtChecks.drawnDebt, "hub spoke drawn debt after accrual");
        assertApproxEqAbs(debtChecks.spokePremium, debtChecks.premiumDebt, 1, "hub spoke premium debt after accrual");
