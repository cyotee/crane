...
contract SpokeMultipleHubBase is Base {
    ...
    ISpoke.DynamicReserveConfig internal dynReserveConfig = ISpoke.DynamicReserveConfig({
        collateralFactor: 80_00, // 80.00%
        maxLiquidationBonus: 100_00, // 100.00%
        liquidationFee: 0 // 0.00%
    });
    IAssetInterestRateStrategy.InterestRateData internal irData = IAssetInterestRateStrategy.InterestRateData({
