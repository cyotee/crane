...
contract AaveOracleTest is Base {
    ...
    function setUp() public override {
        ...
        spoke1 = ISpoke(
            address(AaveV4TestOrchestration.deploySpokeImplementation(address(oracle), MAX_ALLOWED_USER_RESERVES_LIMIT))
        );
    ...
    function test_setSpoke() public {
        ...
        address newSpoke = address(
            AaveV4TestOrchestration.deploySpokeImplementation(address(oracle), MAX_ALLOWED_USER_RESERVES_LIMIT)
        );
    ...
    function test_setReserveSource_revertsWith_OracleMismatch() public {
        ...
        address newSpoke =
            address(AaveV4TestOrchestration.deploySpokeImplementation(mismatchOracle, MAX_ALLOWED_USER_RESERVES_LIMIT));
