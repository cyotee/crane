...
import "@crane/test/foundry/spec/protocols/lending/aave/v4/contracts/position-manager/ConfigPositionManager/ConfigPositionManager.Base.t.sol";
...
contract ConfigPositionManagerPermitTest is ConfigPositionManagerBaseTest {
    function test_eip712Domain() public {
        ConfigPositionManager instance = new ConfigPositionManager{salt: bytes32(vm.randomUint())}(vm.randomAddress());
        (
            bytes1 fields,
            string memory name,
    ...
    function test_setGlobalPermissionWithSig_fuzz(address delegatee, bool permission) public {
        ...
        IConfigPositionManager.SetGlobalPermissionPermit memory p =
            _setGlobalPermissionPermitData(delegatee, alice, permission, _warpBeforeRandomDeadline(MAX_SKIP_TIME));
        ...
        if (permission) {
            ...
            emit IConfigPositionManager.UpdateConfigPermissions(
                address(spoke1), alice, delegatee, emptyPermissions, expectedPermissions
            );
        }
        ...
        IConfigPositionManager.ConfigPermissionValues memory permissions =
            positionManager.getConfigPermissions(address(spoke1), delegatee, alice);
    ...
    function test_setGlobalPermissionWithSig_revertsWith_InvalidSignature_dueTo_ExpiredDeadline() public {
        IConfigPositionManager.SetGlobalPermissionPermit memory p =
            _setGlobalPermissionPermitData(vm.randomAddress(), alice, true, _warpAfterRandomDeadline(MAX_SKIP_TIME));
        bytes memory signature = _sign(alicePk, _getTypedDataHash(positionManager, p));
    ...
    function test_setGlobalPermissionWithSig_revertsWith_InvalidSignature_dueTo_InvalidSigner() public {
        ...
        IConfigPositionManager.SetGlobalPermissionPermit memory p =
            _setGlobalPermissionPermitData(randomUser, delegator, true, _warpBeforeRandomDeadline(MAX_SKIP_TIME));
    ...
    function test_setGlobalPermissionWithSig_revertsWith_InvalidAccountNonce(bytes32) public {
        IConfigPositionManager.SetGlobalPermissionPermit memory p =
            _setGlobalPermissionPermitData(vm.randomAddress(), alice, true, _warpBeforeRandomDeadline(MAX_SKIP_TIME));
        ...
        vm.expectRevert(abi.encodeWithSelector(INoncesKeyed.InvalidAccountNonce.selector, p.delegator, currentNonce));
        vm.prank(vm.randomAddress());
        positionManager.setGlobalPermissionWithSig(p, signature);
    }
    ...
    function test_setGlobalPermissionWithSig_revertsWith_SpokeNotRegistered() public {
        IConfigPositionManager.SetGlobalPermissionPermit memory p =
            _setGlobalPermissionPermitData(bob, alice, true, _warpBeforeRandomDeadline(MAX_SKIP_TIME));
    ...
    function test_setCanSetUsingAsCollateralPermissionPermit_typeHash() public view {
        assertEq(
            ...
            vm.eip712HashType(EIP712Types.TYPE_SetCanSetUsingAsCollateralPermissionPermit)
        );
        assertEq(
            positionManager.SET_CAN_SET_USING_AS_COLLATERAL_PERMISSION_PERMIT_TYPEHASH(),
            keccak256(
    ...
    function test_setCanSetUsingAsCollateralPermissionWithSig_fuzz(address delegatee, bool permission) public {
        vm.assume(delegatee != address(0));

        IConfigPositionManager.SetCanSetUsingAsCollateralPermissionPermit memory p =
            _setCanSetUsingAsCollateralPermissionPermitData(
                delegatee, alice, permission, _warpBeforeRandomDeadline(MAX_SKIP_TIME)
            );
        p.nonce = _burnRandomNoncesAtKey(positionManager, alice);
        bytes memory signature = _sign(alicePk, _getTypedDataHash(positionManager, p));
        ...
        public
    {
        IConfigPositionManager.SetCanSetUsingAsCollateralPermissionPermit memory p =
            _setCanSetUsingAsCollateralPermissionPermitData(
                vm.randomAddress(), alice, true, _warpAfterRandomDeadline(MAX_SKIP_TIME)
            );
        bytes memory signature = _sign(alicePk, _getTypedDataHash(positionManager, p));
        ...
        public
    {
        ...
        IConfigPositionManager.SetCanSetUsingAsCollateralPermissionPermit memory p =
            _setCanSetUsingAsCollateralPermissionPermitData(
                randomUser, delegator, true, _warpBeforeRandomDeadline(MAX_SKIP_TIME)
            );
        bytes memory signature = _sign(randomUserPk, _getTypedDataHash(positionManager, p));
    ...
    function test_setCanSetUsingAsCollateralPermissionWithSig_revertsWith_InvalidAccountNonce(bytes32) public {
        IConfigPositionManager.SetCanSetUsingAsCollateralPermissionPermit memory p =
            _setCanSetUsingAsCollateralPermissionPermitData(
                vm.randomAddress(), alice, true, _warpBeforeRandomDeadline(MAX_SKIP_TIME)
            );
        uint192 nonceKey = _randomNonceKey();
        uint256 currentNonce = _burnRandomNoncesAtKey(positionManager, p.delegator, nonceKey);
        p.nonce = _getRandomInvalidNonceAtKey(positionManager, p.delegator, nonceKey);
    ...
    function test_setCanSetUsingAsCollateralPermissionWithSig_revertsWith_SpokeNotRegistered() public {
        IConfigPositionManager.SetCanSetUsingAsCollateralPermissionPermit memory p =
            _setCanSetUsingAsCollateralPermissionPermitData(bob, alice, true, _warpBeforeRandomDeadline(MAX_SKIP_TIME));
        p.spoke = address(spoke2);
        p.nonce = _burnRandomNoncesAtKey(positionManager, alice);
        bytes memory signature = _sign(alicePk, _getTypedDataHash(positionManager, p));
    ...
    function test_setCanUpdateUserRiskPremiumPermissionPermit_typeHash() public view {
        assertEq(
            ...
            vm.eip712HashType(EIP712Types.TYPE_SetCanUpdateUserRiskPremiumPermissionPermit)
        );
        assertEq(
            positionManager.SET_CAN_UPDATE_USER_RISK_PREMIUM_PERMISSION_PERMIT_TYPEHASH(),
            keccak256(
    ...
    function test_setCanUpdateUserRiskPremiumPermissionWithSig_fuzz(address delegatee, bool permission) public {
        vm.assume(delegatee != address(0));

        IConfigPositionManager.SetCanUpdateUserRiskPremiumPermissionPermit memory p =
    ...
    function test_setCanUpdateUserRiskPremiumPermissionWithSig_revertsWith_InvalidAccountNonce(bytes32) public {
        IConfigPositionManager.SetCanUpdateUserRiskPremiumPermissionPermit memory p =
            _setCanUpdateUserRiskPremiumPermissionPermitData(
                vm.randomAddress(), alice, true, _warpBeforeRandomDeadline(MAX_SKIP_TIME)
            );
    ...
    function test_setCanUpdateUserRiskPremiumPermissionWithSig_revertsWith_SpokeNotRegistered() public {
        IConfigPositionManager.SetCanUpdateUserRiskPremiumPermissionPermit memory p =
            _setCanUpdateUserRiskPremiumPermissionPermitData(bob, alice, true, _warpBeforeRandomDeadline(MAX_SKIP_TIME));
        p.spoke = address(spoke2);
        p.nonce = _burnRandomNoncesAtKey(positionManager, alice);
        bytes memory signature = _sign(alicePk, _getTypedDataHash(positionManager, p));
    ...
    function test_setCanUpdateUserDynamicConfigPermissionPermit_typeHash() public view {
        assertEq(
            ...
            vm.eip712HashType(EIP712Types.TYPE_SetCanUpdateUserDynamicConfigPermissionPermit)
        );
        assertEq(
            positionManager.SET_CAN_UPDATE_USER_DYNAMIC_CONFIG_PERMISSION_PERMIT_TYPEHASH(),
            keccak256(
    ...
    function test_setCanUpdateUserDynamicConfigPermissionWithSig_fuzz(address delegatee, bool permission) public {
        vm.assume(delegatee != address(0));

        IConfigPositionManager.SetCanUpdateUserDynamicConfigPermissionPermit memory p =
    ...
    function test_setCanUpdateUserDynamicConfigPermissionWithSig_revertsWith_InvalidAccountNonce(bytes32) public {
        IConfigPositionManager.SetCanUpdateUserDynamicConfigPermissionPermit memory p =
            _setCanUpdateUserDynamicConfigPermissionPermitData(
                vm.randomAddress(), alice, true, _warpBeforeRandomDeadline(MAX_SKIP_TIME)
            );
    ...
    function test_setCanUpdateUserDynamicConfigPermissionWithSig_revertsWith_SpokeNotRegistered() public {
        IConfigPositionManager.SetCanUpdateUserDynamicConfigPermissionPermit memory p =
            _setCanUpdateUserDynamicConfigPermissionPermitData(
                bob, alice, true, _warpBeforeRandomDeadline(MAX_SKIP_TIME)
            );
        p.spoke = address(spoke2);
        p.nonce = _burnRandomNoncesAtKey(positionManager, alice);
        bytes memory signature = _sign(alicePk, _getTypedDataHash(positionManager, p));
