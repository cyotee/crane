...
contract SpokeMultipleHubSiloedBorrowingTest is SpokeMultipleHubBase {
    ...
    function test_siloed_borrowing() public {
        ...
        SpokeActions.supply({
            spoke: newSpoke, reserveId: siloedVars.reserveAIdNewSpoke, caller: bob, amount: 1e18, onBehalfOf: bob
        });
        ...
        SpokeActions.borrow({
            spoke: newSpoke, reserveId: siloedVars.reserveBId, caller: bob, amount: assetBDrawCapAmount, onBehalfOf: bob
        });
        ...
        vm.expectRevert(abi.encodeWithSelector(IHub.DrawCapExceeded.selector, siloedVars.assetBDrawCap));
        SpokeActions.borrow({
            spoke: newSpoke, reserveId: siloedVars.reserveBId, caller: bob, amount: 1e18, onBehalfOf: bob
        });
    }
}
