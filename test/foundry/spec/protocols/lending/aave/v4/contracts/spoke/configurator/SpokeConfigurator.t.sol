...
contract SpokeConfiguratorTest is Base {
    ...
    function test_updateLiquidationTargetHealthFactor() public {
        ...
        vm.expectCall(spokeAddr, abi.encodeCall(ISpoke.updateLiquidationConfig, (expectedLiquidationConfig)));
        vm.expectEmit(address(spoke));
    ...
    function test_updateLiquidationConfig_revertsWith_AccessManagedUnauthorized() public {
        ...
        spokeConfigurator.updateLiquidationConfig(
            spokeAddr,
            ISpoke.LiquidationConfig({targetHealthFactor: 0, healthFactorForMaxBonus: 0, liquidationBonusFactor: 0})
        );
    }
    ...
    function test_updateLiquidationConfig() public {
        ...
        vm.expectCall(spokeAddr, abi.encodeCall(ISpoke.updateLiquidationConfig, (newLiquidationConfig)));
        vm.expectEmit(address(spoke));
    ...
    function test_addReserve_revertsWith_AccessManagedUnauthorized() public {
        ...
        spokeConfigurator.addReserve({
            ...
            dynamicConfig: ISpoke.DynamicReserveConfig({
                collateralFactor: 80_00, maxLiquidationBonus: 100_00, liquidationFee: 0
            })
        });
    }
    ...
    function test_addReserve() public {
        ...
        vm.expectCall(
            spokeAddr,
            abi.encodeCall(ISpoke.addReserve, (address(hub1), usdzAssetId, newPriceSource, config, dynamicConfig))
        );
        vm.expectEmit(address(spoke));
    ...
    function test_updatePaused() public {
        ...
        for (uint256 i = 0; i < 2; i += 1) {
            ...
            vm.expectCall(spokeAddr, abi.encodeCall(ISpoke.updateReserveConfig, (reserveId, expectedReserveConfig)));
            vm.expectEmit(address(spoke));
    ...
    function test_updateReceiveSharesEnabled() public {
        ...
        for (uint256 i = 0; i < 2; i += 1) {
            ...
            spokeConfigurator.updateReceiveSharesEnabled(
                spokeAddr, reserveId, expectedReserveConfig.receiveSharesEnabled
            );
    ...
    function test_addCollateralFactor() public {
        ...
        ISpoke.DynamicReserveConfig memory expectedDynamicReserveConfig =
            _getLatestDynamicReserveConfig(spoke, reserveId);
        ...
        vm.expectCall(
            spokeAddr, abi.encodeCall(ISpoke.addDynamicReserveConfig, (reserveId, expectedDynamicReserveConfig))
        );
        vm.expectEmit(address(spoke));
        emit ISpoke.AddDynamicReserveConfig(reserveId, expectedConfigKey, expectedDynamicReserveConfig);
        vm.prank(SPOKE_CONFIGURATOR_ADMIN);
        uint32 dynamicConfigKey = spokeConfigurator.addCollateralFactor(spokeAddr, reserveId, newCollateralFactor);
    ...
    function test_updateCollateralFactor() public {
        ...
        vm.expectCall(
            spokeAddr,
            abi.encodeCall(
                ISpoke.updateDynamicReserveConfig, (reserveId, dynamicConfigKey, expectedDynamicReserveConfig)
            )
        );
        vm.expectEmit(address(spoke));
        emit ISpoke.UpdateDynamicReserveConfig(reserveId, dynamicConfigKey, expectedDynamicReserveConfig);
        vm.prank(SPOKE_CONFIGURATOR_ADMIN);
        spokeConfigurator.updateCollateralFactor(spokeAddr, reserveId, dynamicConfigKey, newCollateralFactor);

        assertEq(spoke.getDynamicReserveConfig(reserveId, dynamicConfigKey), expectedDynamicReserveConfig);
    }
    ...
    function test_addMaxLiquidationBonus() public {
        ...
        emit ISpoke.AddDynamicReserveConfig(reserveId, expectedConfigKey, expectedDynamicReserveConfig);
        vm.prank(SPOKE_CONFIGURATOR_ADMIN);
        uint32 dynamicConfigKey = spokeConfigurator.addMaxLiquidationBonus(spokeAddr, reserveId, newLiquidationBonus);
    ...
    function test_updateMaxLiquidationBonus() public {
        ...
        emit ISpoke.UpdateDynamicReserveConfig(reserveId, dynamicConfigKey, expectedDynamicReserveConfig);
        vm.prank(SPOKE_CONFIGURATOR_ADMIN);
        spokeConfigurator.updateMaxLiquidationBonus(spokeAddr, reserveId, dynamicConfigKey, newLiquidationBonus);
    ...
    function test_addLiquidationFee() public {
        ...
        emit ISpoke.AddDynamicReserveConfig(reserveId, expectedConfigKey, expectedDynamicReserveConfig);
        vm.prank(SPOKE_CONFIGURATOR_ADMIN);
        uint32 dynamicConfigKey = spokeConfigurator.addLiquidationFee(spokeAddr, reserveId, newLiquidationFee);
    ...
    function test_updateLiquidationFee() public {
        ...
        emit ISpoke.UpdateDynamicReserveConfig(reserveId, dynamicConfigKey, expectedDynamicReserveConfig);
        vm.prank(SPOKE_CONFIGURATOR_ADMIN);
        spokeConfigurator.updateLiquidationFee(spokeAddr, reserveId, dynamicConfigKey, newLiquidationFee);
    ...
    function test_addDynamicReserveConfig_revertsWith_AccessManagedUnauthorized() public {
        ...
        spokeConfigurator.addDynamicReserveConfig(
            spokeAddr,
            reserveId,
            ISpoke.DynamicReserveConfig({collateralFactor: 20_00, maxLiquidationBonus: 130_00, liquidationFee: 15_00})
        );
    }

    function test_addDynamicReserveConfig() public {
        ISpoke.DynamicReserveConfig memory newDynamicReserveConfig =
            ISpoke.DynamicReserveConfig({collateralFactor: 20_00, maxLiquidationBonus: 130_00, liquidationFee: 15_00});

        uint32 expectedConfigKey = _nextDynamicConfigKey(spoke, reserveId);

        vm.expectCall(spokeAddr, abi.encodeCall(ISpoke.addDynamicReserveConfig, (reserveId, newDynamicReserveConfig)));
        vm.expectEmit(address(spoke));
        emit ISpoke.AddDynamicReserveConfig(reserveId, expectedConfigKey, newDynamicReserveConfig);
        vm.prank(SPOKE_CONFIGURATOR_ADMIN);
        uint32 actualConfigKey =
            spokeConfigurator.addDynamicReserveConfig(spokeAddr, reserveId, newDynamicReserveConfig);
    ...
    function test_updateDynamicReserveConfig_revertsWith_AccessManagedUnauthorized() public {
        ...
        spokeConfigurator.updateDynamicReserveConfig(
            ...
            reserveId,
            0,
            ISpoke.DynamicReserveConfig({collateralFactor: 10_00, maxLiquidationBonus: 150_00, liquidationFee: 12_00})
        );
    }
    ...
    function test_updateDynamicReserveConfig() public {
        ...
        vm.expectCall(
            spokeAddr,
            abi.encodeCall(ISpoke.updateDynamicReserveConfig, (reserveId, configKeyToUpdate, newDynamicReserveConfig))
        );

        vm.expectEmit(address(spoke));
        emit ISpoke.UpdateDynamicReserveConfig(reserveId, configKeyToUpdate, newDynamicReserveConfig);
        vm.prank(SPOKE_CONFIGURATOR_ADMIN);
        spokeConfigurator.updateDynamicReserveConfig(spokeAddr, reserveId, configKeyToUpdate, newDynamicReserveConfig);
    ...
    function test_pauseAllReserves() public {
        for (uint256 reserveIdx = 0; reserveIdx < spoke.getReserveCount(); ++reserveIdx) {
            ...
            vm.expectCall(spokeAddr, abi.encodeCall(ISpoke.updateReserveConfig, (reserveIdx, reserveConfig)));
            vm.expectEmit(address(spoke));
