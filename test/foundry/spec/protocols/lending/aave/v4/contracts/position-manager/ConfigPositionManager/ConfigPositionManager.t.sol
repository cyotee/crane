...
contract ConfigPositionManagerTest is ConfigPositionManagerBaseTest {
    ...
    function test_setGlobalPermission() public {
        IConfigPositionManager.ConfigPermissionValues memory permissions =
            positionManager.getConfigPermissions(address(spoke1), bob, alice);
        ...
        ConfigPermissions newPermissions = emptyPermissions.setCanSetUsingAsCollateral(true)
            .setCanUpdateUserRiskPremium(true).setCanUpdateUserDynamicConfig(true);

        vm.expectEmit(address(positionManager));
        emit IConfigPositionManager.UpdateConfigPermissions(
            address(spoke1), alice, bob, emptyPermissions, newPermissions
        );
        vm.prank(alice);
    ...
    function test_setGlobalPermission_setThenRemove() public {
        ...
        vm.expectEmit(address(positionManager));
        emit IConfigPositionManager.UpdateConfigPermissions(
            address(spoke1), alice, bob, newPermissions, emptyPermissions
        );
        vm.prank(alice);
    ...
    function test_setGlobalPermission_removeAllPermissions() public {
        ...
        vm.expectEmit(address(positionManager));
        emit IConfigPositionManager.UpdateConfigPermissions(
            address(spoke1), alice, bob, globalPermissions, newPermissions
        );
        vm.prank(alice);
        positionManager.setGlobalPermission(address(spoke1), bob, false);
    ...
    function test_setGlobalPermission_removePreviousPermissions() public {
        ...
        ConfigPermissions oldPermissions =
            emptyPermissions.setCanSetUsingAsCollateral(true).setCanUpdateUserDynamicConfig(true);
        ConfigPermissions newPermissions;

        vm.expectEmit(address(positionManager));
        emit IConfigPositionManager.UpdateConfigPermissions(address(spoke1), alice, bob, oldPermissions, newPermissions);
        vm.prank(alice);
        positionManager.setGlobalPermission(address(spoke1), bob, false);
    ...
    function test_renounceCanUpdateUsingAsCollateralPermission_revertsWith_SpokeNotRegistered() public {
        vm.expectRevert(IPositionManagerBase.SpokeNotRegistered.selector);
        vm.prank(bob);
    ...
    function test_renounceCanUpdateUserDynamicConfigPermission_revertsWith_SpokeNotRegistered() public {
        vm.expectRevert(IPositionManagerBase.SpokeNotRegistered.selector);
        vm.prank(bob);
        positionManager.renounceCanUpdateUserDynamicConfigPermission(address(spoke2), alice);
    }

    function test_setUsingAsCollateralOnBehalfOf_fuzz_withPermission(uint256 reserveId, bool useAsCollateral) public {
        ...
        emit IConfigPositionManager.SetUsingAsCollateralOnBehalfOf(
            address(spoke1), bob, alice, reserveId, useAsCollateral
        );
        vm.prank(bob);
        positionManager.setUsingAsCollateralOnBehalfOf(address(spoke1), reserveId, useAsCollateral, alice);

        (isCollateral,) = spoke1.getUserReserveStatus(reserveId, alice);
        assertEq(isCollateral, useAsCollateral);
    }

    function test_setUsingAsCollateralOnBehalfOf_fuzz_withGlobalPermission(uint256 reserveId, bool useAsCollateral)
        public
    {
        reserveId = bound(reserveId, 1, spoke1.getReserveCount() - 1);
    ...
    function test_setUsingAsCollateralOnBehalfOf_noop_whenStatusUnchanged(uint256 reserveId, bool useAsCollateral)
        public
    {
        reserveId = bound(reserveId, 1, spoke1.getReserveCount() - 1);
        ...
        _assertEventsNotEmitted(
            IConfigPositionManager.SetUsingAsCollateralOnBehalfOf.selector, ISpoke.SetUsingAsCollateral.selector
        );
    ...
    function test_setUsingAsCollateralOnBehalfOf_revertsWith_CallerNotAllowed() public {
        ...
        vm.prank(bob);
        positionManager.setUsingAsCollateralOnBehalfOf(address(spoke1), _daiReserveId(spoke1), true, alice);
    }
    ...
    function test_updateUserRiskPremiumOnBehalfOf_withPermission() public {
        ...
        SpokeActions.supplyCollateral({
            spoke: spoke1, reserveId: _daiReserveId(spoke1), caller: alice, amount: 100e18, onBehalfOf: alice
        });
        SpokeActions.borrow({
            spoke: spoke1, reserveId: _daiReserveId(spoke1), caller: alice, amount: 75e18, onBehalfOf: alice
        });
    ...
    function test_multicall() public {
        ...
        calls[0] = abi.encodeWithSignature("setGlobalPermission(address,address,bool)", address(spoke1), bob, true);
        calls[1] = abi.encodeWithSignature("setGlobalPermission(address,address,bool)", address(spoke1), carol, true);
    ...
    function test_setCanSetUsingAsCollateralPermission_revertsWith_InvalidAddress_zeroDelegatee() public {
        vm.expectRevert(IPositionManagerBase.InvalidAddress.selector);
        vm.prank(alice);
        positionManager.setCanSetUsingAsCollateralPermission(address(spoke1), address(0), true);
    }

    function test_setCanUpdateUserRiskPremiumPermission_revertsWith_InvalidAddress_zeroDelegatee() public {
        vm.expectRevert(IPositionManagerBase.InvalidAddress.selector);
        vm.prank(alice);
        positionManager.setCanUpdateUserRiskPremiumPermission(address(spoke1), address(0), true);
    }

    function test_setCanUpdateUserDynamicConfigPermission_revertsWith_InvalidAddress_zeroDelegatee() public {
        vm.expectRevert(IPositionManagerBase.InvalidAddress.selector);
        vm.prank(alice);
