...
contract AaveV4DeployBatchBaseScriptHarness is AaveV4DeployBatchBaseScript {
    ...
    function loadWarningsAndSanitizeInputs(InputUtils.FullDeployInputs memory inputs, address deployer)
        public
...
contract AaveV4DeployBatchBaseScriptTest is Test {
    ...
    function test_loadWarningsAndSanitizeInputs() public {
        ...
        InputUtils.FullDeployInputs memory sanitized = _harness.loadWarningsAndSanitizeInputs(_inputs, _deployer);
        assertEq(sanitized, expected);
    }

    function test_loadWarningsAndSanitizeInputs_withZeroAccessManagerAdmin_fuzz(bool grantRoles) public {
    ...
    function test_loadWarningsAndSanitizeInputs_withZeroHubConfiguratorAdmin_fuzz(bool grantRoles) public {
    ...
    function test_loadWarningsAndSanitizeInputs_withZeroSpokeConfiguratorAdmin_fuzz(bool grantRoles) public {
    ...
    function test_loadWarningsAndSanitizeInputs_withZeroTreasurySpokeOwner_fuzz(bool grantRoles) public {
    ...
    function test_loadWarningsAndSanitizeInputs_withZeroPositionManagerOwner_fuzz(bool grantRoles) public {
    ...
    function test_loadWarningsAndSanitizeInputs_revertsWith_zeroNativeWrapperWhenGatewayEnabled() public {
    ...
    function test_loadWarningsAndSanitizeInputs_withZeroNativeWrapper_gatewayDisabled_fuzz(bool grantRoles) public {
        _inputs.nativeWrapper = address(0);
    ...
    function assertEq(InputUtils.FullDeployInputs memory a, InputUtils.FullDeployInputs memory b) public pure {
    ...
    function _toArray(string memory a, string memory b, string memory c) internal pure returns (string[] memory arr) {
        arr = new string[](3);
        arr[0] = a;
        arr[1] = b;
        arr[2] = c;
