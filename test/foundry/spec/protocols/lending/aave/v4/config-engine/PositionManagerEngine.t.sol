...
contract PositionManagerEngineTest is BaseConfigEngineTest {
    ...
    function test_executePositionManagerSpokeRegistrations() public {
        vm.expectCall(
            address(positionManager), abi.encodeCall(IPositionManagerBase.registerSpoke, (address(spoke1()), true))
        );
        ...
        engine.executePositionManagerSpokeRegistrations(
            _toSpokeRegistrationArray(
                IAaveV4ConfigEngine.SpokeRegistration({
                    positionManager: address(positionManager), spoke: address(spoke1()), registered: true
                })
            )
        );
    ...
    function test_executePositionManagerSpokeRegistrations_deregister() public {
        ...
        engine.executePositionManagerSpokeRegistrations(
            _toSpokeRegistrationArray(
                IAaveV4ConfigEngine.SpokeRegistration({
                    positionManager: address(positionManager), spoke: address(spoke1()), registered: false
                })
            )
        );
    ...
    function test_fuzz_executePositionManagerSpokeRegistrations(bool registered) public {
        engine.executePositionManagerSpokeRegistrations(
            _toSpokeRegistrationArray(
                IAaveV4ConfigEngine.SpokeRegistration({
                    positionManager: address(positionManager), spoke: address(spoke1()), registered: registered
                })
            )
        );
    ...
    function test_executePositionManagerSpokeRegistrations_revert() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(Ownable.OwnableUnauthorizedAccount.selector, address(engine)));
        engine.executePositionManagerSpokeRegistrations(
            _toSpokeRegistrationArray(
                IAaveV4ConfigEngine.SpokeRegistration({
                    positionManager: address(otherPm), spoke: address(spoke1()), registered: true
                })
            )
        );
    }
        ...
        engine.executePositionManagerRoleRenouncements(
            _toPositionManagerRoleRenouncementArray(
                IAaveV4ConfigEngine.PositionManagerRoleRenouncement({
                    positionManager: address(positionManager), spoke: address(spoke1()), user: USER
                })
            )
        );
    ...
    function test_executePositionManagerRoleRenouncements_revert() public {
        ...
        engine.executePositionManagerRoleRenouncements(
            _toPositionManagerRoleRenouncementArray(
                IAaveV4ConfigEngine.PositionManagerRoleRenouncement({
                    positionManager: address(otherPm), spoke: address(spoke1()), user: USER
                })
            )
        );
    }
    ...
    function test_executePositionManagerSpokeRegistrations_batchMultipleSpokes() public {
        IAaveV4ConfigEngine.SpokeRegistration[] memory regs = new IAaveV4ConfigEngine.SpokeRegistration[](3);
        regs[0] = IAaveV4ConfigEngine.SpokeRegistration({
            positionManager: address(positionManager), spoke: address(spoke1()), registered: true
        });
        regs[1] = IAaveV4ConfigEngine.SpokeRegistration({
            positionManager: address(positionManager), spoke: address(spoke2()), registered: true
        });
        regs[2] = IAaveV4ConfigEngine.SpokeRegistration({
            positionManager: address(positionManager), spoke: address(spoke3()), registered: true
        });
    ...
    function test_executePositionManagerSpokeRegistrations_batchMultiplePositionManagers() public {
        ...
        IAaveV4ConfigEngine.SpokeRegistration[] memory regs = new IAaveV4ConfigEngine.SpokeRegistration[](2);
        regs[0] = IAaveV4ConfigEngine.SpokeRegistration({
            positionManager: address(pm1), spoke: address(spoke1()), registered: true
        });
        regs[1] = IAaveV4ConfigEngine.SpokeRegistration({
            positionManager: address(pm2), spoke: address(spoke2()), registered: true
        });
