...
contract HubEngineTest is BaseConfigEngineTest {
    ...
    function test_executeHubAssetConfigUpdates_revertsWith_partialSentinelIrDataOnStrategyChange() public {
        AssetInterestRateStrategy newStrategy = new AssetInterestRateStrategy(address(hub1()));
    ...
    function test_executeHubAssetConfigUpdates_irDataOnly() public {
        ...
        IAssetInterestRateStrategy.InterestRateData memory newIrData = IAssetInterestRateStrategy.InterestRateData({
            optimalUsageRatio: 90_00, baseDrawnRate: 2_00, rateGrowthBeforeOptimal: 5_00, rateGrowthAfterOptimal: 70_00
        });
        ...
        vm.expectCall(
            address(hubConfigurator),
            abi.encodeCall(IHubConfigurator.updateInterestRateData, (address(hub1()), assetId, abi.encode(newIrData)))
        );
        engine.executeHubAssetConfigUpdates(_toAssetConfigUpdateArray(update));
    ...
    function test_executeHubAssetConfigUpdates_irNoOp() public {
        uint256 assetId = _getAssetId(0, 0);
        IAssetInterestRateStrategy.InterestRateData memory irBefore = irStrategy1().getInterestRateData(assetId);
        ...
        IAssetInterestRateStrategy.InterestRateData memory irAfter = irStrategy1().getInterestRateData(assetId);
    ...
    function test_executeHubAssetConfigUpdates_reinvestmentController() public {
        ...
        vm.expectCall(
            address(hubConfigurator),
            abi.encodeCall(
                IHubConfigurator.updateReinvestmentController, (address(hub1()), assetId, REINVESTMENT_CONTROLLER)
            )
        );
        engine.executeHubAssetConfigUpdates(_toAssetConfigUpdateArray(update));
    ...
    function test_executeHubSpokeConfigUpdates_capsBoth() public {
        ...
        vm.expectCall(
            address(hubConfigurator),
            abi.encodeCall(IHubConfigurator.updateSpokeCaps, (address(hub1()), assetId, address(spoke1()), 1000, 500))
        );
    ...
    function test_executeHubSpokeConfigUpdates_addCapOnly() public {
        ...
        vm.expectCall(
            address(hubConfigurator),
            abi.encodeCall(IHubConfigurator.updateSpokeAddCap, (address(hub1()), assetId, address(spoke1()), 2000))
        );
        engine.executeHubSpokeConfigUpdates(_toSpokeConfigUpdateArray(update));
    ...
    function test_executeHubSpokeConfigUpdates_drawCapOnly() public {
        ...
        vm.expectCall(
            address(hubConfigurator),
            abi.encodeCall(IHubConfigurator.updateSpokeDrawCap, (address(hub1()), assetId, address(spoke1()), 300))
        );
        engine.executeHubSpokeConfigUpdates(_toSpokeConfigUpdateArray(update));
    ...
    function test_executeHubSpokeConfigUpdates_haltedOnly() public {
        ...
        vm.expectCall(
            address(hubConfigurator),
            abi.encodeCall(IHubConfigurator.updateSpokeHalted, (address(hub1()), assetId, address(spoke1()), true))
        );
        engine.executeHubSpokeConfigUpdates(_toSpokeConfigUpdateArray(update));
    ...
    function test_executeHubSpokeConfigUpdates_riskPremiumThreshold() public {
        ...
        vm.expectCall(
            address(hubConfigurator),
            abi.encodeCall(
                IHubConfigurator.updateSpokeRiskPremiumThreshold, (address(hub1()), assetId, address(spoke1()), 300)
            )
        );
        engine.executeHubSpokeConfigUpdates(_toSpokeConfigUpdateArray(update));
    ...
    function test_fuzz_executeHubSpokeConfigUpdates_riskPremiumThreshold(uint256 riskPremiumThreshold) public {
    ...
    function test_executeHubSpokeToAssetsAdditions() public {
        ...
        IAaveV4ConfigEngine.SpokeAssetConfig[] memory assets = new IAaveV4ConfigEngine.SpokeAssetConfig[](2);
        ...
        assets[1] = IAaveV4ConfigEngine.SpokeAssetConfig({
            ...
            config: IHub.SpokeConfig({
                addCap: 2000, drawCap: 1000, riskPremiumThreshold: 200, active: true, halted: false
            })
        });

        IAaveV4ConfigEngine.SpokeToAssetsAddition memory addition = IAaveV4ConfigEngine.SpokeToAssetsAddition({
        ...
        IHub.SpokeConfig memory wethConfig = hub1().getSpokeConfig(_getAssetId(0, 0), address(newSpoke));
        assertEq(wethConfig.addCap, 1000);
        assertEq(wethConfig.drawCap, 500);
        assertTrue(wethConfig.active);

        IHub.SpokeConfig memory usdxConfig = hub1().getSpokeConfig(_getAssetId(0, 1), address(newSpoke));
    ...
    function test_executeHubAssetDeactivations() public {
        ...
        IAaveV4ConfigEngine.AssetDeactivation memory deactivation = IAaveV4ConfigEngine.AssetDeactivation({
            hubConfigurator: hubConfigurator, hub: address(hub1()), underlying: address(weth)
        });
    ...
    function test_executeHubAssetCapsResets() public {
        ...
        for (uint256 s; s < NUM_SPOKES; ++s) {
            IHub.SpokeConfig memory spokeConfig = hub1().getSpokeConfig(_getAssetId(0, 0), address(spokes[s]));
    ...
    function test_executeHubSpokeDeactivations() public {
        ...
        IAaveV4ConfigEngine.SpokeDeactivation memory deactivation = IAaveV4ConfigEngine.SpokeDeactivation({
    ...
    function test_executeHubSpokeCapsResets() public {
        ...
        for (uint256 t; t < NUM_TOKENS; ++t) {
            IHub.SpokeConfig memory spokeConfig = hub1().getSpokeConfig(_getAssetId(0, t), address(spoke1()));
            assertEq(spokeConfig.addCap, 0);
            assertEq(spokeConfig.drawCap, 0);
        }
    }
    ...
    function test_executeHubAssetListings_withTokenization() public {
        ...
        listing.tokenization =
            IAaveV4ConfigEngine.TokenizationSpokeConfig({addCap: 1000, name: "Tokenized NEW", symbol: "tNEW"});
        ...
        address predictedProxy = TokenizationSpokeDeployer.computeProxyAddress(
            address(hub1()), address(newToken), "Tokenized NEW", "tNEW", address(this)
        );
    ...
    function test_executeHubAssetListings_tokenization_skipsOnEmptyName() public {
        IAaveV4ConfigEngine.AssetListing memory listing = _defaultAssetListing();
        listing.underlying = address(newToken);
        listing.tokenization = IAaveV4ConfigEngine.TokenizationSpokeConfig({addCap: 1000, name: "", symbol: "tNEW"});
        ...
        address predictedProxy = TokenizationSpokeDeployer.computeProxyAddress(
            address(hub1()), address(newToken), "", "tNEW", address(this)
        );
    ...
    function test_executeHubAssetListings_tokenization_skipsOnEmptySymbol() public {
        ...
        listing.underlying = address(newToken);
        listing.tokenization =
            IAaveV4ConfigEngine.TokenizationSpokeConfig({addCap: 1000, name: "Tokenized NEW", symbol: ""});
        ...
        address predictedProxy = TokenizationSpokeDeployer.computeProxyAddress(
            address(hub1()), address(newToken), "Tokenized NEW", "", address(this)
        );
        assertFalse(hub1().isSpokeListed(expectedAssetId, predictedProxy));
        assertEq(predictedProxy.code.length, 0);
    }
    ...
    function test_computeImplementationAddress() public view {
        address predicted = TokenizationSpokeDeployer.computeImplementationAddress(
            address(hub1()), address(newToken), "Tokenized NEW", "tNEW"
        );
    ...
    function test_executeHubSpokeToAssetsAdditions_revert_spokeAlreadyListed() public {
        ...
        IAaveV4ConfigEngine.SpokeToAssetsAddition memory addition = IAaveV4ConfigEngine.SpokeToAssetsAddition({
            hubConfigurator: hubConfigurator, hub: address(hub1()), spoke: address(spoke1()), assets: assets
        });
    ...
    function test_executeHubAssetHalts_multipleAssets() public {
        ...
        halts[1] = IAaveV4ConfigEngine.AssetHalt({
            hubConfigurator: hubConfigurator, hub: address(hub1()), underlying: address(usdx)
        });
    ...
    function test_executeHubAssetListings_withTokenization_duplicateUnderlying_revertsBeforeCreate2() public {
        IAaveV4ConfigEngine.AssetListing memory listing = _defaultAssetListing();
        listing.underlying = address(newToken);
        listing.tokenization =
            IAaveV4ConfigEngine.TokenizationSpokeConfig({addCap: 1000, name: "Tokenized NEW", symbol: "tNEW"});
