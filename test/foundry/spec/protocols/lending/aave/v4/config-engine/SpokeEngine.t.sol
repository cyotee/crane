...
contract SpokeEngineTest is BaseConfigEngineTest {
    ...
    function _assertReserveConfig(uint256 reserveId, ISpoke.ReserveConfig memory expected) internal view {
    ...
    function _assertDynamicReserveConfig(uint256 reserveId, uint32 key, ISpoke.DynamicReserveConfig memory expected)
        internal
        view
    {
    ...
    function test_executeSpokeReserveConfigUpdates_allKeepCurrent() public {
        ...
        IAaveV4ConfigEngine.ReserveConfigUpdate memory update = IAaveV4ConfigEngine.ReserveConfigUpdate({
    ...
    function test_fuzz_executeSpokeReserveConfigUpdates_onlyCollateralRisk(uint256 collateralRisk) public {
    ...
    function test_executeSpokeReserveConfigUpdates_onlyPriceSource() public {
        ...
        vm.expectCall(
            address(spokeConfigurator),
            abi.encodeCall(ISpokeConfigurator.updateReservePriceSource, (address(spoke1()), reserveId, newPriceFeed))
        );
        engine.executeSpokeReserveConfigUpdates(_toReserveConfigUpdateArray(update));
    ...
    function test_executeSpokeLiquidationConfigUpdates_allSet() public {
        ...
        update.targetHealthFactor = 1.1e18;
        update.healthFactorForMaxBonus = 0.9e18;
        update.liquidationBonusFactor = 90_00;

        ISpoke.LiquidationConfig memory expectedConfig = ISpoke.LiquidationConfig({
            targetHealthFactor: uint128(1.1e18), healthFactorForMaxBonus: uint64(0.9e18), liquidationBonusFactor: 90_00
        });

        vm.expectCall(
            address(spokeConfigurator),
            abi.encodeCall(ISpokeConfigurator.updateLiquidationConfig, (address(spoke1()), expectedConfig))
        );
    ...
    function test_fuzz_executeSpokeLiquidationConfigUpdates_allSet(
        ...
        IAaveV4ConfigEngine.LiquidationConfigUpdate memory update = IAaveV4ConfigEngine.LiquidationConfigUpdate({
            spokeConfigurator: spokeConfigurator,
            spoke: address(spoke1()),
    ...
    function test_executeSpokeLiquidationConfigUpdates_targetOnly() public {
        ...
        vm.expectCall(
            address(spokeConfigurator),
            abi.encodeCall(ISpokeConfigurator.updateLiquidationTargetHealthFactor, (address(spoke1()), 1.15e18))
        );
        engine.executeSpokeLiquidationConfigUpdates(_toLiquidationConfigUpdateArray(update));
    ...
    function test_fuzz_executeSpokeLiquidationConfigUpdates_targetOnly(uint256 targetHealthFactor) public {
        targetHealthFactor = bound(targetHealthFactor, 1e18, type(uint128).max);
        ISpoke.LiquidationConfig memory liqConfigBefore = spoke1().getLiquidationConfig();
    ...
    function test_fuzz_executeSpokeLiquidationConfigUpdates_maxBonusOnly(uint256 healthFactorForMaxBonus) public {
        healthFactorForMaxBonus = bound(healthFactorForMaxBonus, 1, 1e18 - 1);
        ISpoke.LiquidationConfig memory liqConfigBefore = spoke1().getLiquidationConfig();
    ...
    function test_fuzz_executeSpokeLiquidationConfigUpdates_bonusFactorOnly(uint256 liquidationBonusFactor) public {
        liquidationBonusFactor = bound(liquidationBonusFactor, 0, 10_000);
        ISpoke.LiquidationConfig memory liqConfigBefore = spoke1().getLiquidationConfig();
    ...
    function test_executeSpokeDynamicReserveConfigUpdates_allUpdated() public {
        ...
        IAaveV4ConfigEngine.DynamicReserveConfigUpdate memory update = _defaultDynamicReserveConfigUpdate();
        update.collateralFactor = 90_00;
        update.maxLiquidationBonus = 110_00;
        update.liquidationFee = 5_00;

        ISpoke.DynamicReserveConfig memory expectedDynConfig =
            ISpoke.DynamicReserveConfig({collateralFactor: 90_00, maxLiquidationBonus: 110_00, liquidationFee: 5_00});
        ...
        vm.expectEmit(address(spoke1()));
        emit ISpoke.UpdateDynamicReserveConfig(reserveId, uint32(DYNAMIC_CONFIG_KEY), expectedDynConfig);
    ...
    function test_executeSpokeDynamicReserveConfigUpdates_allKeepCurrent() public {
        uint256 reserveId = _getReserveId(0, 0);
        ISpoke.DynamicReserveConfig memory dynConfigBefore =
            spoke1().getDynamicReserveConfig(reserveId, uint32(DYNAMIC_CONFIG_KEY));

        IAaveV4ConfigEngine.DynamicReserveConfigUpdate memory update = IAaveV4ConfigEngine.DynamicReserveConfigUpdate({
            spokeConfigurator: spokeConfigurator,
            spoke: address(spoke1()),
            hub: address(hub1()),
            underlying: address(weth),
    ...
    function test_executeSpokeDynamicReserveConfigUpdates_partialUpdate() public {
        ...
        ISpoke.DynamicReserveConfig memory dynConfigAfter =
            spoke1().getDynamicReserveConfig(reserveId, uint32(DYNAMIC_CONFIG_KEY));
    ...
    function test_fuzz_executeSpokeDynamicReserveConfigUpdates_liquidationFee(uint256 liquidationFee) public {
    ...
    function test_fuzz_executeSpokeDynamicReserveConfigUpdates_collateralFactor(uint256 collateralFactor) public {
        uint256 reserveId = _getReserveId(0, 0);
        ISpoke.DynamicReserveConfig memory dynConfigBefore =
            spoke1().getDynamicReserveConfig(reserveId, uint32(DYNAMIC_CONFIG_KEY));
    ...
    function test_fuzz_executeSpokeDynamicReserveConfigUpdates_maxLiquidationBonus(uint256 mlb) public {
        uint256 reserveId = _getReserveId(0, 0);
        ISpoke.DynamicReserveConfig memory dynConfigBefore =
            spoke1().getDynamicReserveConfig(reserveId, uint32(DYNAMIC_CONFIG_KEY));
    ...
    function test_executeSpokeDynamicReserveConfigAdditions_revert_invalidCollateralFactorAndMaxLiquidationBonus()
        public
    {
        IAaveV4ConfigEngine.DynamicReserveConfigAddition memory addition = _defaultDynamicReserveConfigAddition();
        addition.dynamicConfig =
            ISpoke.DynamicReserveConfig({collateralFactor: 99_00, maxLiquidationBonus: 105_00, liquidationFee: 10_00});

        vm.expectRevert(abi.encodeWithSelector(ISpoke.InvalidCollateralFactorAndMaxLiquidationBonus.selector));
        engine.executeSpokeDynamicReserveConfigAdditions(_toDynamicReserveConfigAdditionArray(addition));
    }
    ...
    function test_executeSpokeReserveListings() public {
        ...
        IAaveV4ConfigEngine.ReserveListing memory listing = IAaveV4ConfigEngine.ReserveListing({
            ...
            dynamicConfig: ISpoke.DynamicReserveConfig({
                collateralFactor: 80_00, maxLiquidationBonus: 105_00, liquidationFee: 2_00
            })
        });
    ...
    function test_executeSpokeDynamicReserveConfigAdditions() public {
        ...
        ISpoke.DynamicReserveConfig memory dynConfig = spoke1()
    ...
    function test_executeSpokePositionManagerUpdates() public {
        ...
        vm.expectCall(
            address(spokeConfigurator),
            abi.encodeCall(
                ISpokeConfigurator.updatePositionManager, (address(spoke1()), address(positionManager), true)
            )
        );
    ...
    function test_executeSpokePositionManagerUpdates_deactivate() public {
        engine.executeSpokePositionManagerUpdates(_toPositionManagerUpdateArray(_defaultPositionManagerUpdate()));
        assertTrue(spoke1().isPositionManagerActive(address(positionManager)));

        IAaveV4ConfigEngine.PositionManagerUpdate memory update = IAaveV4ConfigEngine.PositionManagerUpdate({
            spokeConfigurator: spokeConfigurator,
            spoke: address(spoke1()),
    ...
    function test_executeSpokeReserveConfigUpdates_multipleSpokes() public {
        IAaveV4ConfigEngine.ReserveConfigUpdate[] memory updates = new IAaveV4ConfigEngine.ReserveConfigUpdate[](2);
    ...
    function test_executeSpokeLiquidationConfigUpdates_multipleSpokes() public {
        IAaveV4ConfigEngine.LiquidationConfigUpdate[] memory updates =
            new IAaveV4ConfigEngine.LiquidationConfigUpdate[](2);
        ...
        assertEq(config1.targetHealthFactor, uint128(1.2e18));

        ISpoke.LiquidationConfig memory config2 = spoke2().getLiquidationConfig();
        assertEq(config2.targetHealthFactor, uint128(1.3e18));
    }
    ...
    function test_executeSpokeDynamicReserveConfigUpdates_multipleReserves() public {
        ...
        ISpoke.DynamicReserveConfig memory dynBefore0 =
            spoke1().getDynamicReserveConfig(reserveId0, uint32(DYNAMIC_CONFIG_KEY));
        ISpoke.DynamicReserveConfig memory dynBefore1 =
            spoke1().getDynamicReserveConfig(reserveId1, uint32(DYNAMIC_CONFIG_KEY));

        IAaveV4ConfigEngine.DynamicReserveConfigUpdate[] memory updates =
            new IAaveV4ConfigEngine.DynamicReserveConfigUpdate[](2);
        ...
        ISpoke.DynamicReserveConfig memory dynAfter0 =
            spoke1().getDynamicReserveConfig(reserveId0, uint32(DYNAMIC_CONFIG_KEY));
        ...
        ISpoke.DynamicReserveConfig memory dynAfter1 =
            spoke1().getDynamicReserveConfig(reserveId1, uint32(DYNAMIC_CONFIG_KEY));
    ...
    function test_executeSpokePositionManagerUpdates_multipleUpdates() public {
        ...
        IAaveV4ConfigEngine.PositionManagerUpdate[] memory updates = new IAaveV4ConfigEngine.PositionManagerUpdate[](2);
        ...
        updates[1] = IAaveV4ConfigEngine.PositionManagerUpdate({
            spokeConfigurator: spokeConfigurator, spoke: address(spoke1()), positionManager: address(pm2), active: true
        });
