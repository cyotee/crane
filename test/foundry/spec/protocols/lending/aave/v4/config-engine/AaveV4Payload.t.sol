...
import "@crane/test/foundry/spec/protocols/lending/aave/v4/config-engine/BaseConfigEngine.t.sol";
...
contract AaveV4PayloadTest is BaseConfigEngineTest {
    ...
    function test_execute_hubAction_delegatesCorrectly() public {
        ...
        halts[0] = IAaveV4ConfigEngine.AssetHalt({
            hubConfigurator: hubConfigurator, hub: address(hub1()), underlying: address(weth)
        });
        payload.setHubAssetHalts(halts);

        payload.execute();

        IHub.SpokeConfig memory spokeConfig = hub1().getSpokeConfig(_getAssetId(0, 0), address(spoke1()));
        assertTrue(spokeConfig.halted);
    }

    function test_execute_spokeAction_delegatesCorrectly() public {
        IAaveV4ConfigEngine.PositionManagerUpdate[] memory updates = new IAaveV4ConfigEngine.PositionManagerUpdate[](1);
    ...
    function test_execute_accessManagerAction_delegatesCorrectly() public {
        IAaveV4ConfigEngine.RoleMembership[] memory memberships = new IAaveV4ConfigEngine.RoleMembership[](1);
    ...
    function test_execute_multipleActions_allExecuted() public {
        ...
        IAaveV4ConfigEngine.PositionManagerUpdate[] memory pmUpdates =
            new IAaveV4ConfigEngine.PositionManagerUpdate[](1);
    ...
    function test_execute_hubAssetConfigUpdates_feeOnly() public {
        ...
        IAaveV4ConfigEngine.AssetConfigUpdate[] memory updates = new IAaveV4ConfigEngine.AssetConfigUpdate[](1);
    ...
    function test_execute_hubAssetConfigUpdates_interestRateOnly() public {
        ...
        IAssetInterestRateStrategy.InterestRateData memory newIrData = IAssetInterestRateStrategy.InterestRateData({
            optimalUsageRatio: 95_00, baseDrawnRate: 3_00, rateGrowthBeforeOptimal: 6_00, rateGrowthAfterOptimal: 80_00
        });
        ...
        IAssetInterestRateStrategy.InterestRateData memory storedIrData = irStrategy1().getInterestRateData(assetId);
    ...
    function test_execute_hubAssetConfigUpdates_twoAssets_feeOnly() public {
        ...
        IAaveV4ConfigEngine.AssetConfigUpdate[] memory updates = new IAaveV4ConfigEngine.AssetConfigUpdate[](2);
        updates[0] = IAaveV4ConfigEngine.AssetConfigUpdate({
            hubConfigurator: hubConfigurator,
            hub: address(hub1()),
            underlying: address(weth),
    ...
    function test_execute_hubSpokeToAssetsAdditions() public {
        ...
        IAaveV4ConfigEngine.SpokeToAssetsAddition[] memory additions =
            new IAaveV4ConfigEngine.SpokeToAssetsAddition[](1);
        ...
        additions[0] = IAaveV4ConfigEngine.SpokeToAssetsAddition({
            hubConfigurator: hubConfigurator, hub: address(hub1()), spoke: address(newSpoke), assets: assets
        });
        payload.setHubSpokeToAssetsAdditions(additions);

        payload.execute();

        IHub.SpokeConfig memory spokeConfig = hub1().getSpokeConfig(_getAssetId(0, 0), address(newSpoke));
        assertEq(spokeConfig.addCap, 1000);
        assertTrue(spokeConfig.active);
    }

    function test_execute_hubSpokeConfigUpdates_capsOnly() public {
        IAaveV4ConfigEngine.SpokeConfigUpdate[] memory updates = new IAaveV4ConfigEngine.SpokeConfigUpdate[](1);
        ...
        IHub.SpokeConfig memory spokeConfigBefore = hub1().getSpokeConfig(_getAssetId(0, 0), address(spoke1()));
    ...
    function test_fuzz_execute_hubSpokeConfigUpdates_capsOnly(uint256 addCap, uint256 drawCap) public {
    ...
    function test_execute_hubAssetHalts_multiElement() public {
        ...
        halts[1] = IAaveV4ConfigEngine.AssetHalt({
            hubConfigurator: hubConfigurator, hub: address(hub2()), underlying: address(weth)
        });
        payload.setHubAssetHalts(halts);

        payload.execute();

        IHub.SpokeConfig memory spokeConfig1 = hub1().getSpokeConfig(_getAssetId(0, 0), address(spoke1()));
        assertTrue(spokeConfig1.halted);

        IHub.SpokeConfig memory spokeConfig2 = hub2().getSpokeConfig(_getAssetId(1, 0), address(spoke1()));
    ...
    function test_execute_hubAssetDeactivations() public {
        ...
        IAaveV4ConfigEngine.AssetDeactivation[] memory deactivations = new IAaveV4ConfigEngine.AssetDeactivation[](1);
    ...
    function test_execute_hubAssetCapsResets() public {
        IAaveV4ConfigEngine.AssetCapsReset[] memory resets = new IAaveV4ConfigEngine.AssetCapsReset[](1);
    ...
    function test_execute_spokeReserveListings() public {
        ...
        IAaveV4ConfigEngine.ReserveListing[] memory listings = new IAaveV4ConfigEngine.ReserveListing[](1);
    ...
    function test_execute_spokeReserveConfigUpdates() public {
        IAaveV4ConfigEngine.ReserveConfigUpdate[] memory updates = new IAaveV4ConfigEngine.ReserveConfigUpdate[](1);
    ...
    function test_execute_spokeLiquidationConfigUpdates() public {
        IAaveV4ConfigEngine.LiquidationConfigUpdate[] memory updates =
            new IAaveV4ConfigEngine.LiquidationConfigUpdate[](1);
        updates[0] = _defaultLiquidationConfigUpdate();
        updates[0].targetHealthFactor = 1.2e18;
    ...
    function test_execute_spokeDynamicReserveConfigAdditions() public {
        IAaveV4ConfigEngine.DynamicReserveConfigAddition[] memory additions =
            new IAaveV4ConfigEngine.DynamicReserveConfigAddition[](1);
    ...
    function test_execute_spokeDynamicReserveConfigUpdates() public {
        IAaveV4ConfigEngine.DynamicReserveConfigUpdate[] memory updates =
            new IAaveV4ConfigEngine.DynamicReserveConfigUpdate[](1);
        ...
        ISpoke.DynamicReserveConfig memory dynConfig =
            spoke1().getDynamicReserveConfig(reserveId, uint32(DYNAMIC_CONFIG_KEY));
    ...
    function test_fuzz_execute_spokeDynamicReserveConfigUpdates(
        ...
        maxLiquidationBonus = bound(maxLiquidationBonus, 10_000, (10_000 * 10_000 - 10_000) / collateralFactor);
    ...
    function test_execute_accessManagerRoleMemberships_revoke() public {
        IAaveV4ConfigEngine.RoleMembership[] memory grantMemberships = new IAaveV4ConfigEngine.RoleMembership[](1);
        ...
        IAaveV4ConfigEngine.RoleMembership[] memory revokeMemberships = new IAaveV4ConfigEngine.RoleMembership[](1);
    ...
    function test_execute_accessManagerRoleUpdates() public {
        ...
        assertEq(accessManager.getRoleGuardian(Roles.HUB_CONFIGURATOR_ROLE), Roles.HUB_DEFICIT_ELIMINATOR_ROLE);
    }
    ...
    function test_execute_accessManagerTargetFunctionRoleUpdates() public {
        IAaveV4ConfigEngine.TargetFunctionRoleUpdate[] memory updates =
            new IAaveV4ConfigEngine.TargetFunctionRoleUpdate[](1);
        bytes4[] memory selectors = new bytes4[](1);
        selectors[0] = bytes4(0xdeadbeef);
        updates[0] = IAaveV4ConfigEngine.TargetFunctionRoleUpdate({
            authority: address(accessManager), target: TARGET, selectors: selectors, roleId: Roles.HUB_CONFIGURATOR_ROLE
        });
        payload.setAccessManagerTargetFunctionRoleUpdates(updates);

        payload.execute();

        assertEq(accessManager.getTargetFunctionRole(TARGET, selectors[0]), Roles.HUB_CONFIGURATOR_ROLE);
    }

    function test_execute_accessManagerTargetAdminDelayUpdates() public {
        IAaveV4ConfigEngine.TargetAdminDelayUpdate[] memory updates =
            new IAaveV4ConfigEngine.TargetAdminDelayUpdate[](1);
        updates[0] = IAaveV4ConfigEngine.TargetAdminDelayUpdate({
            authority: address(accessManager), target: TARGET, newDelay: 7200
        });
    ...
    function test_execute_hubSpokeDeactivations() public {
        IAaveV4ConfigEngine.SpokeDeactivation[] memory deactivations = new IAaveV4ConfigEngine.SpokeDeactivation[](1);
        deactivations[0] = IAaveV4ConfigEngine.SpokeDeactivation({
            hubConfigurator: hubConfigurator, hub: address(hub1()), spoke: address(spoke1())
        });
    ...
    function test_execute_hubSpokeCapsResets() public {
        IAaveV4ConfigEngine.SpokeCapsReset[] memory resets = new IAaveV4ConfigEngine.SpokeCapsReset[](1);
    ...
    function test_execute_positionManagerSpokeRegistrations() public {
        IAaveV4ConfigEngine.SpokeRegistration[] memory regs = new IAaveV4ConfigEngine.SpokeRegistration[](1);
        regs[0] = IAaveV4ConfigEngine.SpokeRegistration({
            positionManager: address(payloadPositionManager), spoke: address(spoke1()), registered: true
        });
    ...
    function test_execute_positionManagerRoleRenouncements() public {
        ...
        IAaveV4ConfigEngine.SpokeRegistration[] memory regs = new IAaveV4ConfigEngine.SpokeRegistration[](1);
        regs[0] = IAaveV4ConfigEngine.SpokeRegistration({
            positionManager: address(freshPm), spoke: address(spoke1()), registered: true
        });
        payload.setPositionManagerSpokeRegistrations(regs);
        ...
        IAaveV4ConfigEngine.PositionManagerRoleRenouncement[] memory renouncements =
            new IAaveV4ConfigEngine.PositionManagerRoleRenouncement[](1);
        renouncements[0] = IAaveV4ConfigEngine.PositionManagerRoleRenouncement({
            positionManager: address(freshPm), spoke: address(spoke1()), user: USER
        });
    ...
    function test_execute_reverts_hubAction_withoutHubConfiguratorRole() public {
        AaveV4PayloadWrapper freshPayload = new AaveV4PayloadWrapper(IAaveV4ConfigEngine(address(engine)));
        ...
        vm.expectRevert(
            abi.encodeWithSelector(IAccessManaged.AccessManagedUnauthorized.selector, address(freshPayload))
        );
    ...
    function test_execute_reverts_positionManagerAction_withoutOwnership() public {
        ...
        IAaveV4ConfigEngine.SpokeRegistration[] memory regs = new IAaveV4ConfigEngine.SpokeRegistration[](1);
        regs[0] = IAaveV4ConfigEngine.SpokeRegistration({
            positionManager: address(deadPm), spoke: address(spoke1()), registered: true
        });
        freshPayload.setPositionManagerSpokeRegistrations(regs);

        vm.expectRevert(abi.encodeWithSelector(Ownable.OwnableUnauthorizedAccount.selector, address(freshPayload)));
        freshPayload.execute();
    }
    ...
    function test_execute_crossSpoke_reserveConfigUpdates() public {
        IAaveV4ConfigEngine.ReserveConfigUpdate[] memory updates = new IAaveV4ConfigEngine.ReserveConfigUpdate[](3);
    ...
    function test_execute_crossHubAndSpoke_mixedActions() public {
        ...
        IAaveV4ConfigEngine.AssetConfigUpdate[] memory assetUpdates = new IAaveV4ConfigEngine.AssetConfigUpdate[](1);
        ...
        IAaveV4ConfigEngine.ReserveConfigUpdate[] memory reserveUpdates =
            new IAaveV4ConfigEngine.ReserveConfigUpdate[](2);
        ...
        IHub.SpokeConfig memory spokeConfig = hub1().getSpokeConfig(_getAssetId(0, TOKEN_WETH), address(spoke1()));
        assertTrue(spokeConfig.halted);
    ...
    function test_execute_crossHub_spokeConfigUpdates() public {
        ...
        IHub.SpokeConfig memory sc1 = hub1().getSpokeConfig(_getAssetId(0, TOKEN_WETH), address(spoke1()));
        assertEq(sc1.addCap, 1000);
        assertEq(sc1.drawCap, 500);

        IHub.SpokeConfig memory sc2 = hub2().getSpokeConfig(_getAssetId(1, TOKEN_USDX), address(spoke2()));
