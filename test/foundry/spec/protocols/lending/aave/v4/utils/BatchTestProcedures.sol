...
// orchestration
import {AaveV4DeployOrchestration} from '@crane/contracts/protocols/lending/aave/v4/deployments/orchestration/AaveV4DeployOrchestration.sol';
...
contract BatchTestProcedures is Test, Create2TestHelper, WETHDeployProcedure {
  ...
  function _checkHubDeployment(
    ...
    assertEq(
      ...
      keccak256(vm.getDeployedCode('contracts/protocols/lending/aave/v4/hub/instances/HubInstance.sol:HubInstance')),
