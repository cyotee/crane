...
contract AaveV4AccessManagerRolesProcedureWrapper {
    ...
    function replaceDefaultAdminRole(address accessManager, address adminToAdd, address adminToRemove) external {
        AaveV4AccessManagerRolesProcedure.replaceDefaultAdminRole(accessManager, adminToAdd, adminToRemove);
    }
