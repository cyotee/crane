...
contract PositionStatusMapWrapper {
    ...
    function isolateBorrowingUntil(uint256 word, uint256 reserveCount) external pure returns (uint256) {
    ...
    function isolateCollateralUntil(uint256 word, uint256 reserveCount) external pure returns (uint256) {
