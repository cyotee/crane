...
abstract contract SetupHelpers is SpokeHelpers {
    function _setGlobalPermissionPermitData(
        ...
        return IConfigPositionManager.SetGlobalPermissionPermit({
            spoke: address(spoke),
            delegator: delegator,
            delegatee: delegatee,
            status: status,
    ...
    function _setCanSetUsingAsCollateralPermissionPermitData(
        ...
        return IConfigPositionManager.SetCanSetUsingAsCollateralPermissionPermit({
            spoke: address(spoke),
            delegator: delegator,
            delegatee: delegatee,
            status: status,
    ...
    function _setCanUpdateUserRiskPremiumPermissionPermitData(
        ...
        return IConfigPositionManager.SetCanUpdateUserRiskPremiumPermissionPermit({
            spoke: address(spoke),
            delegator: delegator,
            delegatee: delegatee,
            status: status,
    ...
    function _setCanUpdateUserDynamicConfigPermissionPermitData(
        ...
        return IConfigPositionManager.SetCanUpdateUserDynamicConfigPermissionPermit({
            spoke: address(spoke),
            delegator: delegator,
            delegatee: delegatee,
            status: status,
    ...
    function _canUpdateUsingAsCollateral(
        ...
        IConfigPositionManager.ConfigPermissionValues memory permissions =
            positionManager.getConfigPermissions(spoke, delegator, delegatee);
