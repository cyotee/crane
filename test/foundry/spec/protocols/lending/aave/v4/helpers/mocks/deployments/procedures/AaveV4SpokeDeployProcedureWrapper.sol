...
} from "@crane/contracts/protocols/lending/aave/v4/deployments/procedures/deploy/spoke/AaveV4SpokeDeployProcedure.sol";
...
contract AaveV4SpokeDeployProcedureWrapper is AaveV4SpokeDeployProcedure {
    ...
    function deployUpgradeableSpokeInstance(
        ...
        return _deployUpgradeableSpokeInstance(
            proxyAdminOwner, authority, oracle, spokeBytecode, maxUserReservesLimit, salt
        );
    }
}
