...
contract AaveV4PayloadWrapper is AaveV4Payload {
    ...
    function setHubSpokeToAssetsAdditions(IAaveV4ConfigEngine.SpokeToAssetsAddition[] memory items) external {
    ...
    function setSpokeReserveConfigUpdates(IAaveV4ConfigEngine.ReserveConfigUpdate[] memory items) external {
    ...
    function setSpokeLiquidationConfigUpdates(IAaveV4ConfigEngine.LiquidationConfigUpdate[] memory items) external {
    ...
    function setSpokeDynamicReserveConfigAdditions(IAaveV4ConfigEngine.DynamicReserveConfigAddition[] memory items)
        external
    {
    ...
    function setSpokeDynamicReserveConfigUpdates(IAaveV4ConfigEngine.DynamicReserveConfigUpdate[] memory items)
        external
    {
    ...
    function setSpokePositionManagerUpdates(IAaveV4ConfigEngine.PositionManagerUpdate[] memory items) external {
    ...
    function setPositionManagerSpokeRegistrations(IAaveV4ConfigEngine.SpokeRegistration[] memory items) external {
    ...
    function setPositionManagerRoleRenouncements(IAaveV4ConfigEngine.PositionManagerRoleRenouncement[] memory items)
        external
    {
    ...
    function setAccessManagerRoleMemberships(IAaveV4ConfigEngine.RoleMembership[] memory items) external {
    ...
    function setAccessManagerTargetFunctionRoleUpdates(IAaveV4ConfigEngine.TargetFunctionRoleUpdate[] memory items)
        external
    {
    ...
    function setAccessManagerTargetAdminDelayUpdates(IAaveV4ConfigEngine.TargetAdminDelayUpdate[] memory items)
        external
    {
    ...
    function hubAssetListings() public view override returns (IAaveV4ConfigEngine.AssetListing[] memory) {
        return _hubAssetListings;
    }

    function hubAssetConfigUpdates() public view override returns (IAaveV4ConfigEngine.AssetConfigUpdate[] memory) {
        ...
        returns (IAaveV4ConfigEngine.SpokeToAssetsAddition[] memory)
    {
        ...
        return abi.decode(_hubSpokeToAssetsAdditionsEncoded, (IAaveV4ConfigEngine.SpokeToAssetsAddition[]));
    }

    function hubSpokeConfigUpdates() public view override returns (IAaveV4ConfigEngine.SpokeConfigUpdate[] memory) {
    ...
    function hubAssetDeactivations() public view override returns (IAaveV4ConfigEngine.AssetDeactivation[] memory) {
        return _hubAssetDeactivations;
    }

    function hubAssetCapsResets() public view override returns (IAaveV4ConfigEngine.AssetCapsReset[] memory) {
        return _hubAssetCapsResets;
    }

    function hubSpokeDeactivations() public view override returns (IAaveV4ConfigEngine.SpokeDeactivation[] memory) {
        return _hubSpokeDeactivations;
    }

    function hubSpokeCapsResets() public view override returns (IAaveV4ConfigEngine.SpokeCapsReset[] memory) {
        return _hubSpokeCapsResets;
    }

    function spokeReserveListings() public view override returns (IAaveV4ConfigEngine.ReserveListing[] memory) {
    ...
    function accessManagerRoleMemberships() public view override returns (IAaveV4ConfigEngine.RoleMembership[] memory) {
        return _accessManagerRoleMemberships;
    }

    function accessManagerRoleUpdates() public view override returns (IAaveV4ConfigEngine.RoleUpdate[] memory) {
