...
contract AaveV4HubConfiguratorRolesProcedureWrapper {
    ...
    function setupHubConfiguratorAllRoles(address accessManager, address hubConfigurator) external {
        AaveV4HubConfiguratorRolesProcedure.setupHubConfiguratorAllRoles(accessManager, hubConfigurator);
    }
    ...
    function setupHubConfiguratorRole(
        ...
        AaveV4HubConfiguratorRolesProcedure.setupHubConfiguratorRole(accessManager, hubConfigurator, role, selectors);
    }
