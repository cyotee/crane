...
contract AaveV4HubConfiguratorDeployProcedureTest is ProceduresBase {
    ...
    function test_deployHubConfigurator() public {
        address hubConfigurator = aaveV4HubConfiguratorDeployProcedureWrapper.deployHubConfigurator(owner, salt);
    ...
    function test_deployHubConfigurator_reverts() public {
        ...
        aaveV4HubConfiguratorDeployProcedureWrapper.deployHubConfigurator({authority: address(0), salt: salt});
    }
}
