...
import {AaveV4AccessManagerRolesProcedure} from '@crane/contracts/protocols/lending/aave/v4/deployments/procedures/roles/AaveV4AccessManagerRolesProcedure.sol';
...
library AaveV4TestOrchestration {
  ...
  function deployHubImplementation(bytes32 salt) internal returns (IHubInstance) {
    bytes memory initCode = vm.getCode('contracts/protocols/lending/aave/v4/hub/instances/HubInstance.sol:HubInstance');
