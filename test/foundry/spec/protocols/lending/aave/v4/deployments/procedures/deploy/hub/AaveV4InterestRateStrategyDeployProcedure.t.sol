...
contract AaveV4InterestRateStrategyDeployProcedureTest is ProceduresBase {
    AaveV4InterestRateStrategyDeployProcedureWrapper public aaveV4InterestRateStrategyDeployProcedureWrapper;
    ...
    function test_deployInterestRateStrategy() public {
        address interestRateStrategy =
            aaveV4InterestRateStrategyDeployProcedureWrapper.deployInterestRateStrategy(hub, salt);
    ...
    function test_deployInterestRateStrategy_reverts() public {
        ...
        aaveV4InterestRateStrategyDeployProcedureWrapper.deployInterestRateStrategy({hub: address(0), salt: salt});
    }
}
