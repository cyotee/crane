...
contract AaveV4SpokeDeployProcedureTest is ProceduresBase {
    ...
    function test_deployUpgradeableSpokeInstance() public {
        (address spokeProxy, address spokeImplementation) = aaveV4SpokeDeployProcedureWrapper.deployUpgradeableSpokeInstance(
            owner, accessManager, aaveOracle, spokeBytecode, maxUserReservesLimit, salt
        );
