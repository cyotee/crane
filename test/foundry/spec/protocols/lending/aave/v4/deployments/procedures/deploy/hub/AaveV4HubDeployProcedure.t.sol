...
contract AaveV4HubDeployProcedureTest is ProceduresBase {
    ...
    function test_deployHub() public {
        (address hubProxy, address hubImpl) =
            aaveV4HubDeployProcedureWrapper.deployHub(admin, accessManager, hubBytecode, salt);
    ...
    function test_deployHub_reverts_invalidAuthority() public {
        ...
        aaveV4HubDeployProcedureWrapper.deployHub({
            proxyAdminOwner: admin, authority: address(0), hubBytecode: hubBytecode, salt: salt
        });
    }
    ...
    function test_deployHub_reverts_invalidProxyAdminOwner() public {
        ...
        aaveV4HubDeployProcedureWrapper.deployHub({
            proxyAdminOwner: address(0), authority: accessManager, hubBytecode: hubBytecode, salt: salt
        });
    }
}
