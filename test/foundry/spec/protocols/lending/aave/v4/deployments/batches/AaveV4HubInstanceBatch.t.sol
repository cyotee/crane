...
contract AaveV4HubInstanceBatchTest is BatchBaseTest {
    ...
    function setUp() public override {
        ...
        hubInstanceBatch = new AaveV4HubInstanceBatch({
            proxyAdminOwner_: admin, authority_: accessManager, hubBytecode_: hubBytecode, salt_: salt
        });
    ...
    function test_revert_zeroAuthority() public {
        ...
        new AaveV4HubInstanceBatch({
            proxyAdminOwner_: admin, authority_: address(0), hubBytecode_: hubBytecode, salt_: salt
        });
    }
    ...
    function test_revert_zeroProxyAdminOwner() public {
        ...
        new AaveV4HubInstanceBatch({
            proxyAdminOwner_: address(0), authority_: accessManager, hubBytecode_: hubBytecode, salt_: salt
        });
    }
