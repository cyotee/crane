...
contract AaveV4NativeTokenGatewayDeployProcedureTest is ProceduresBase {
    AaveV4NativeTokenGatewayDeployProcedureWrapper public aaveV4NativeTokenGatewayDeployProcedureWrapper;
    ...
    function test_deployNativeTokenGateway() public {
        address nativeTokenGateway =
            aaveV4NativeTokenGatewayDeployProcedureWrapper.deployNativeTokenGateway(nativeWrapper, owner, salt);
    ...
    function test_deployNativeTokenGateway_reverts() public {
        ...
        aaveV4NativeTokenGatewayDeployProcedureWrapper.deployNativeTokenGateway({
            nativeWrapper: address(0), owner: owner, salt: salt
        });

        vm.expectRevert("invalid owner");
        aaveV4NativeTokenGatewayDeployProcedureWrapper.deployNativeTokenGateway({
            nativeWrapper: nativeWrapper, owner: address(0), salt: salt
        });
    }
}
