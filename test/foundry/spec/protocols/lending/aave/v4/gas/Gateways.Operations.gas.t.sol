...
import "@crane/test/foundry/spec/protocols/lending/aave/v4/helpers/position-manager/signature-gateway/SignatureGatewayHelpers.sol";
...
contract NativeTokenGateway_Gas_Tests is Base {
    ...
    function test_supplyNative() public {
        ...
        SpokeActions.supply({
            spoke: spoke1, reserveId: _wethReserveId(spoke1), caller: bob, amount: amount, onBehalfOf: bob
        });
...
contract SignatureGateway_Gas_Tests is Base, SignatureGatewayHelpers {
    ...
    function test_supplyWithSig() public {
        ...
        SpokeActions.supply({spoke: spoke1, reserveId: p.reserveId, caller: alice, amount: p.amount, onBehalfOf: alice});
    ...
    function test_withdrawWithSig() public {
        ...
        SpokeActions.supply({spoke: spoke1, reserveId: p.reserveId, caller: alice, amount: 200e18, onBehalfOf: alice});
        SpokeActions.withdraw({spoke: spoke1, reserveId: p.reserveId, caller: alice, amount: 100e18, onBehalfOf: alice});
    ...
    function test_borrowWithSig() public {
        ...
        SpokeActions.supplyCollateral({
            spoke: spoke1, reserveId: p.reserveId, caller: alice, amount: p.amount * 4, onBehalfOf: alice
        });
    ...
    function test_repayWithSig() public {
        ...
        SpokeActions.supplyCollateral({
            spoke: spoke1, reserveId: p.reserveId, caller: alice, amount: p.amount * 10, onBehalfOf: alice
        });
        SpokeActions.borrow({
            spoke: spoke1, reserveId: p.reserveId, caller: alice, amount: p.amount * 3, onBehalfOf: alice
        });
        SpokeActions.approve({
            spoke: spoke1, reserveId: p.reserveId, owner: alice, spender: address(gateway), amount: p.amount * 2
        });
        SpokeActions.repay({spoke: spoke1, reserveId: p.reserveId, caller: alice, amount: p.amount, onBehalfOf: alice});
        bytes memory signature = _sign(alicePk, _getTypedDataHash(gateway, p));
    ...
    function test_setUsingAsCollateralWithSig() public {
        ...
        SpokeActions.supply({spoke: spoke1, reserveId: p.reserveId, caller: alice, amount: 1e18, onBehalfOf: alice});
        bytes memory signature = _sign(alicePk, _getTypedDataHash(gateway, p));
