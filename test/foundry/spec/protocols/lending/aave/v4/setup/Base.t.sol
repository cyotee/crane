...
import {ProxyAdmin} from "@crane/contracts/external/openzeppelin-contracts/proxy/transparent/ProxyAdmin.sol";
import {
    ReentrancyGuardTransient
} from "@crane/contracts/external/openzeppelin-contracts/utils/ReentrancyGuardTransient.sol";
import {
    IERC20Metadata
...
import {IERC20Errors} from "@crane/contracts/external/openzeppelin-contracts/token/ERC20/IERC20Errors.sol";
...
import {AccessManager} from "@crane/contracts/external/openzeppelin-contracts/access/manager/AccessManager.sol";
...
import {LibBit} from "@crane/contracts/external/solady/utils/LibBit.sol";

import {Initializable} from "@crane/contracts/external/openzeppelin-upgradeable/proxy/utils/Initializable.sol";
import {OwnableUpgradeable} from "@crane/contracts/external/openzeppelin-upgradeable/access/OwnableUpgradeable.sol";
import {IERC1967} from "@crane/contracts/external/openzeppelin-contracts/interfaces/IERC1967.sol";
...
import {Rescuable, IRescuable} from "@crane/contracts/protocols/lending/aave/v4/utils/Rescuable.sol";
import {NoncesKeyed, INoncesKeyed} from "@crane/contracts/protocols/lending/aave/v4/utils/NoncesKeyed.sol";
import {IntentConsumer, IIntentConsumer} from "@crane/contracts/protocols/lending/aave/v4/utils/IntentConsumer.sol";
import {AccessManagerEnumerable} from "@crane/contracts/protocols/lending/aave/v4/access/AccessManagerEnumerable.sol";

// hub
import {HubConfigurator, IHubConfigurator} from "@crane/contracts/protocols/lending/aave/v4/hub/HubConfigurator.sol";
...
import {TreasurySpoke, ITreasurySpoke} from "@crane/contracts/protocols/lending/aave/v4/spoke/TreasurySpoke.sol";
import {
    TreasurySpokeInstance
} from "@crane/contracts/protocols/lending/aave/v4/spoke/instances/TreasurySpokeInstance.sol";
...
import {
    SpokeConfigurator,
    ISpokeConfigurator
} from "@crane/contracts/protocols/lending/aave/v4/spoke/SpokeConfigurator.sol";
import {SpokeUtils} from "@crane/contracts/protocols/lending/aave/v4/spoke/libraries/SpokeUtils.sol";
import {PositionStatusMap} from "@crane/contracts/protocols/lending/aave/v4/spoke/libraries/PositionStatusMap.sol";
import {
    ReserveFlags,
    ReserveFlagsMap
} from "@crane/contracts/protocols/lending/aave/v4/spoke/libraries/ReserveFlagsMap.sol";
import {LiquidationLogic} from "@crane/contracts/protocols/lending/aave/v4/spoke/libraries/LiquidationLogic.sol";
...
import {
    TokenizationSpoke,
    ITokenizationSpoke
} from "@crane/contracts/protocols/lending/aave/v4/spoke/TokenizationSpoke.sol";
import {
...
} from "@crane/contracts/protocols/lending/aave/v4/position-manager/PositionManagerBase.sol";
import {
    NativeTokenGateway,
    INativeTokenGateway
} from "@crane/contracts/protocols/lending/aave/v4/position-manager/NativeTokenGateway.sol";
import {
    SignatureGateway,
    ISignatureGateway
} from "@crane/contracts/protocols/lending/aave/v4/position-manager/SignatureGateway.sol";
import {
    GiverPositionManager,
    IGiverPositionManager
} from "@crane/contracts/protocols/lending/aave/v4/position-manager/GiverPositionManager.sol";
import {
    TakerPositionManager,
    ITakerPositionManager
} from "@crane/contracts/protocols/lending/aave/v4/position-manager/TakerPositionManager.sol";
import {
    ConfigPositionManager,
    IConfigPositionManager
} from "@crane/contracts/protocols/lending/aave/v4/position-manager/ConfigPositionManager.sol";
import {
    ConfigPermissions,
    ConfigPermissionsMap
} from "@crane/contracts/protocols/lending/aave/v4/position-manager/libraries/ConfigPermissionsMap.sol";

// orchestration
import {ConfigData} from "@crane/test/foundry/spec/protocols/lending/aave/v4/utils/ConfigData.sol";
import {
    OrchestrationReports
} from "@crane/contracts/protocols/lending/aave/v4/deployments/libraries/OrchestrationReports.sol";
import {
...
import {BaseHelpers} from "@crane/test/foundry/spec/protocols/lending/aave/v4/setup/BaseHelpers.sol";
...
import {MockERC20} from "@crane/test/foundry/spec/protocols/lending/aave/v4/helpers/mocks/MockERC20.sol";
...
} from "@crane/test/foundry/spec/protocols/lending/aave/v4/helpers/mocks/PositionStatusMapWrapper.sol";
import {RescuableWrapper} from "@crane/test/foundry/spec/protocols/lending/aave/v4/helpers/mocks/RescuableWrapper.sol";
import {
    PositionManagerBaseWrapper
} from "@crane/test/foundry/spec/protocols/lending/aave/v4/helpers/mocks/PositionManagerBaseWrapper.sol";
import {MockNoncesKeyed} from "@crane/test/foundry/spec/protocols/lending/aave/v4/helpers/mocks/MockNoncesKeyed.sol";
import {MockSpoke} from "@crane/test/foundry/spec/protocols/lending/aave/v4/helpers/mocks/MockSpoke.sol";
import {
    MockERC1271Wallet
} from "@crane/test/foundry/spec/protocols/lending/aave/v4/helpers/mocks/MockERC1271Wallet.sol";
import {MockHubInstance} from "@crane/test/foundry/spec/protocols/lending/aave/v4/helpers/mocks/MockHubInstance.sol";
import {
    MockSpokeInstance
} from "@crane/test/foundry/spec/protocols/lending/aave/v4/helpers/mocks/MockSpokeInstance.sol";
import {
    MockTreasurySpokeInstance
} from "@crane/test/foundry/spec/protocols/lending/aave/v4/helpers/mocks/MockTreasurySpokeInstance.sol";
import {MockSkimSpoke} from "@crane/test/foundry/spec/protocols/lending/aave/v4/helpers/mocks/MockSkimSpoke.sol";
import {
    MockReentrantCaller
} from "@crane/test/foundry/spec/protocols/lending/aave/v4/helpers/mocks/MockReentrantCaller.sol";
import {IHubInstance} from "@crane/contracts/protocols/lending/aave/v4/deployments/utils/interfaces/IHubInstance.sol";
import {
    ISpokeInstance
} from "@crane/contracts/protocols/lending/aave/v4/deployments/utils/interfaces/ISpokeInstance.sol";
import {
    AaveV4TestOrchestrationWrapper
} from "@crane/test/foundry/spec/protocols/lending/aave/v4/helpers/mocks/AaveV4TestOrchestrationWrapper.sol";
import {
    SpokeUtilsWrapper
} from "@crane/test/foundry/spec/protocols/lending/aave/v4/helpers/mocks/SpokeUtilsWrapper.sol";
...
abstract contract Base is BaseHelpers, BatchTestProcedures {
    ...
    function _deployFixtures(uint256 numHubs, uint256 numSpokes)
        internal
        virtual
        returns (TestTypes.TestEnvReport memory report)
    {
    ...
    function _setupFixturesRoles(TestTypes.TestEnvReport memory report) internal virtual {
        ...
        vm.startPrank(ADMIN);
        IAccessManager(report.accessManager).grantRole(Roles.ACCESS_MANAGER_ADMIN_ROLE, address(this), 0);
        vm.stopPrank();
        ...
        AaveV4HubConfiguratorRolesProcedure.grantHubConfiguratorAllRoles(report.accessManager, HUB_CONFIGURATOR_ADMIN);
        ...
        AaveV4SpokeConfiguratorRolesProcedure.grantSpokeConfiguratorAllRoles(
            report.accessManager, SPOKE_CONFIGURATOR_ADMIN
        );

        IAccessManager(report.accessManager).renounceRole(Roles.ACCESS_MANAGER_ADMIN_ROLE, address(this));
    }
    ...
    function _initTokenList() internal {
        ...
        tokenInputs[0] = TestTypes.TestTokenInput({name: "USDX", symbol: "USDX", decimals: _decimals.usdx});
        tokenInputs[1] = TestTypes.TestTokenInput({name: "DAI", symbol: "DAI", decimals: _decimals.dai});
        tokenInputs[2] = TestTypes.TestTokenInput({name: "WBTC", symbol: "WBTC", decimals: _decimals.wbtc});
        tokenInputs[3] = TestTypes.TestTokenInput({name: "USDY", symbol: "USDY", decimals: _decimals.usdy});
        tokenInputs[4] = TestTypes.TestTokenInput({name: "USDZ", symbol: "USDZ", decimals: _decimals.usdz});
    ...
    function _mintAndApproveTokenList() internal {
        address[7] memory users = [alice, bob, carol, derl, LIQUIDATOR, TREASURY_ADMIN, POSITION_MANAGER];
    ...
    function _configureHubsAndSpokes() internal {
        ...
        TestTypes.SpokeReserveId[] memory spokeReserveIds =
            AaveV4TestOrchestration.configureSpokes(liquidationParams, reserveParams);
    ...
    function _getAddSpokeParams() internal view returns (ConfigData.AddSpokeParams[] memory paramsList) {
        ...
        paramsList[0] = ConfigData.AddSpokeParams({
            spoke: address(spoke1), hub: address(hub1), assetId: wethAssetId, config: spokeConfig
        });
        paramsList[1] = ConfigData.AddSpokeParams({
            spoke: address(spoke1), hub: address(hub1), assetId: wbtcAssetId, config: spokeConfig
        });
        paramsList[2] = ConfigData.AddSpokeParams({
            spoke: address(spoke1), hub: address(hub1), assetId: daiAssetId, config: spokeConfig
        });
        paramsList[3] = ConfigData.AddSpokeParams({
            spoke: address(spoke1), hub: address(hub1), assetId: usdxAssetId, config: spokeConfig
        });
        paramsList[4] = ConfigData.AddSpokeParams({
            spoke: address(spoke1), hub: address(hub1), assetId: usdyAssetId, config: spokeConfig
        });

        // spoke2
        paramsList[5] = ConfigData.AddSpokeParams({
            spoke: address(spoke2), hub: address(hub1), assetId: wbtcAssetId, config: spokeConfig
        });
        paramsList[6] = ConfigData.AddSpokeParams({
            spoke: address(spoke2), hub: address(hub1), assetId: wethAssetId, config: spokeConfig
        });
        paramsList[7] = ConfigData.AddSpokeParams({
            spoke: address(spoke2), hub: address(hub1), assetId: daiAssetId, config: spokeConfig
        });
        paramsList[8] = ConfigData.AddSpokeParams({
            spoke: address(spoke2), hub: address(hub1), assetId: usdxAssetId, config: spokeConfig
        });
        paramsList[9] = ConfigData.AddSpokeParams({
            spoke: address(spoke2), hub: address(hub1), assetId: usdyAssetId, config: spokeConfig
        });
        paramsList[10] = ConfigData.AddSpokeParams({
            spoke: address(spoke2), hub: address(hub1), assetId: usdzAssetId, config: spokeConfig
        });

        // spoke3
        paramsList[11] = ConfigData.AddSpokeParams({
            spoke: address(spoke3), hub: address(hub1), assetId: daiAssetId, config: spokeConfig
        });
        paramsList[12] = ConfigData.AddSpokeParams({
            spoke: address(spoke3), hub: address(hub1), assetId: usdxAssetId, config: spokeConfig
        });
        paramsList[13] = ConfigData.AddSpokeParams({
            spoke: address(spoke3), hub: address(hub1), assetId: wethAssetId, config: spokeConfig
        });
        paramsList[14] = ConfigData.AddSpokeParams({
            spoke: address(spoke3), hub: address(hub1), assetId: wbtcAssetId, config: spokeConfig
        });
    ...
    function _getSpokeReserveParams()
        internal
        returns (ConfigData.UpdateLiquidationConfigParams[] memory, ConfigData.AddReserveParams[] memory)
    {
        ConfigData.UpdateLiquidationConfigParams[] memory liquidationParams =
            new ConfigData.UpdateLiquidationConfigParams[](3);
        liquidationParams[0] = ConfigData.UpdateLiquidationConfigParams({
            spoke: address(spoke1),
            config: ISpoke.LiquidationConfig({
                targetHealthFactor: 1.05e18, healthFactorForMaxBonus: 0.7e18, liquidationBonusFactor: 20_00
            })
        });
        liquidationParams[1] = ConfigData.UpdateLiquidationConfigParams({
            spoke: address(spoke2),
            config: ISpoke.LiquidationConfig({
                targetHealthFactor: 1.04e18, healthFactorForMaxBonus: 0.8e18, liquidationBonusFactor: 15_00
            })
        });
        liquidationParams[2] = ConfigData.UpdateLiquidationConfigParams({
            spoke: address(spoke3),
            config: ISpoke.LiquidationConfig({
                targetHealthFactor: 1.03e18, healthFactorForMaxBonus: 0.9e18, liquidationBonusFactor: 10_00
            })
        });
        ...
        reserveParams[0] = ConfigData.AddReserveParams({
            ...
            dynamicConfig: ISpoke.DynamicReserveConfig({
                collateralFactor: 80_00, maxLiquidationBonus: 105_00, liquidationFee: 10_00
            })
        });
        reserveParams[1] = ConfigData.AddReserveParams({
            ...
            config: _getDefaultReserveConfig(15_00),
            dynamicConfig: ISpoke.DynamicReserveConfig({
                collateralFactor: 75_00, maxLiquidationBonus: 103_00, liquidationFee: 15_00
            })
        });
        reserveParams[2] = ConfigData.AddReserveParams({
            ...
            dynamicConfig: ISpoke.DynamicReserveConfig({
                collateralFactor: 78_00, maxLiquidationBonus: 102_00, liquidationFee: 10_00
            })
        });
        reserveParams[3] = ConfigData.AddReserveParams({
            ...
            dynamicConfig: ISpoke.DynamicReserveConfig({
                collateralFactor: 78_00, maxLiquidationBonus: 101_00, liquidationFee: 12_00
            })
        });
        reserveParams[4] = ConfigData.AddReserveParams({
            ...
            config: _getDefaultReserveConfig(50_00),
            dynamicConfig: ISpoke.DynamicReserveConfig({
                collateralFactor: 78_00, maxLiquidationBonus: 101_50, liquidationFee: 15_00
            })
        });
        ...
        reserveParams[6] = ConfigData.AddReserveParams({
            ...
            dynamicConfig: ISpoke.DynamicReserveConfig({
                collateralFactor: 76_00, maxLiquidationBonus: 103_00, liquidationFee: 15_00
            })
        });
        reserveParams[7] = ConfigData.AddReserveParams({
            ...
            config: _getDefaultReserveConfig(20_00),
            dynamicConfig: ISpoke.DynamicReserveConfig({
                collateralFactor: 72_00, maxLiquidationBonus: 102_00, liquidationFee: 10_00
            })
        });
        reserveParams[8] = ConfigData.AddReserveParams({
            ...
            config: _getDefaultReserveConfig(50_00),
            dynamicConfig: ISpoke.DynamicReserveConfig({
                collateralFactor: 72_00, maxLiquidationBonus: 101_00, liquidationFee: 12_00
            })
        });
        reserveParams[9] = ConfigData.AddReserveParams({
            ...
            config: _getDefaultReserveConfig(50_00),
            dynamicConfig: ISpoke.DynamicReserveConfig({
                collateralFactor: 72_00, maxLiquidationBonus: 101_50, liquidationFee: 15_00
            })
        });
        reserveParams[10] = ConfigData.AddReserveParams({
            ...
            dynamicConfig: ISpoke.DynamicReserveConfig({
                collateralFactor: 70_00, maxLiquidationBonus: 106_00, liquidationFee: 10_00
            })
        });
        ...
        reserveParams[11] = ConfigData.AddReserveParams({
            ...
            config: _getDefaultReserveConfig(0),
            dynamicConfig: ISpoke.DynamicReserveConfig({
                collateralFactor: 75_00, maxLiquidationBonus: 104_00, liquidationFee: 11_00
            })
        });
        ...
        reserveParams[13] = ConfigData.AddReserveParams({
            ...
            config: _getDefaultReserveConfig(20_00),
            dynamicConfig: ISpoke.DynamicReserveConfig({
                collateralFactor: 79_00, maxLiquidationBonus: 102_00, liquidationFee: 10_00
            })
        });
        reserveParams[14] = ConfigData.AddReserveParams({
            ...
            config: _getDefaultReserveConfig(50_00),
            dynamicConfig: ISpoke.DynamicReserveConfig({
                collateralFactor: 77_00, maxLiquidationBonus: 101_00, liquidationFee: 12_00
            })
        });
    ...
    function _addHubFixture(string memory label, FixtureAssetList[] memory assetsList)
        internal
        returns (TestTypes.TestHubReport memory report)
    {
        report = AaveV4TestOrchestration.deployTestHub(
            ADMIN, address(accessManager), BytecodeHelper.getHubBytecode(), label, keccak256(abi.encodePacked(label))
        );
        ...
        ConfigData.AddAssetParams[] memory assetParams = new ConfigData.AddAssetParams[](assetsList.length);
    ...
    function _getDefaultReserveConfig(uint24 collateralRisk) internal pure returns (ISpoke.ReserveConfig memory) {
        return ISpoke.ReserveConfig({
            paused: false, frozen: false, borrowable: true, receiveSharesEnabled: true, collateralRisk: collateralRisk
        });
    }
}
