...
contract ReliquaryTest is TestBase_Reliquary {
    ...
    function setUp() public override {
        ...
        polynomialCurve = new PolynomialPlateauCurve(coeffDynamic, 850);

        oath.mint(address(reliquary), 100_000_000 ether);

        testToken = new MockERC20("TestToken", "TST", 6);
    ...
    function testPolynomialCurve() public view {
        console.log(polynomialCurve.getFunction(8500));
    }

    // --- rest of the tests are unchanged; kept as in upstream
