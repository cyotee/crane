...
import {DoubleLinkedList} from "@crane/contracts/protocols/staking/liquity/v2/gov/utils/DoubleLinkedList.sol";
    ...
    function initiative_claimBribes(
        ...
        try initiative.claimBribes(claimData) {
            ...
            if (lqtyAllocated > 0 && !claimedBribe && bribeWasThere) {
                ...
                unableToClaim = true;
                /// @custom:audit Consider adding this as a test once claiming is simplified
            }
        }
    }
}
