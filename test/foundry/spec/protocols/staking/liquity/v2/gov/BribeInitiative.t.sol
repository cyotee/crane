...
contract BribeInitiativeTest is Test, MockStakingV1Deployer {
    ...
    function test_high_deny_last_claim() public {
        /// @custom:audit Overflow due to rounding error in bribes total math vs user math
    ...
    function test_rationalFlow() public {
        ...
        /// @custom:audit Allocate b4 or after bribe should be irrelevant

        /// @custom:audit WTF
        _depositBribe(1e18, 1e18, governance.epoch());
        /// @custom:audit IMO this should also work
