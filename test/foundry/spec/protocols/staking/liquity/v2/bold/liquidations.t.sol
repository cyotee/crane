...
contract LiquidationsTest is DevTestSetup {
    ...
    function testLiquidationOffsetWithSurplus() public {
        ...
        uint256 collSurplusAmount = collAmount * 995 / 1000 - (liquidationAmount + initialValues.AInterest)
            * DECIMAL_PRECISION / price * 105 / 100;
        assertApproxEqAbs(
    ...
    function testLiquidationMix() public {
        ...
        // Portion offset
         vars.collAmount * (vars.liquidationAmount / 2 - 1e18) / (vars.liquidationAmount + vars.AInterest) * 995 / 1000
            ...
            / (vars.liquidationAmount + vars.AInterest) - (vars.liquidationAmount / 2 + 1e18 + vars.AInterest)
