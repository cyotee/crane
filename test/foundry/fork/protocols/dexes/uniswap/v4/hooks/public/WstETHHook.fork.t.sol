...
import {TestRouter} from "@crane/test/foundry/spec/protocols/dexes/uniswap/v4/hooks/public/shared/TestRouter.sol";
...
contract WstETHHookForkTest is Test, Deployers {
    ...
    function setUp() public {
        try vm.envString("INFURA_API_KEY") returns (string memory) {
            ...
            deployCodeTo(
                "contracts/protocols/dexes/uniswap/v4/hooks/public/WstETHRoutingHook.sol:WstETHRoutingHook",
                abi.encode(manager, wstETH),
                address(hookSim)
            );
