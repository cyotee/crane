...
import {IFluidDexLiteAdminModule} from "@crane/test/foundry/spec/protocols/dexes/uniswap/v4/hooks/public/aggregator-hooks/FluidDexLite/interfaces/IFluidDexLiteAdminModule.sol";
import {DexKey, InitializeParams} from "@crane/test/foundry/spec/protocols/dexes/uniswap/v4/hooks/public/aggregator-hooks/FluidDexLite/interfaces/FluidDexLiteStructs.sol";
...
} from "@crane/contracts/protocols/dexes/uniswap/v4/hooks/public/aggregator-hooks/implementations/FluidDexLite/FluidDexLiteAggregatorFactory.sol";
import {
...
contract FluidDexLiteERC20Fuzz is Test {
    ...
    function _initializeFluidPool(PoolSetup memory setup) internal {
        ...
        bytes memory initializeData = abi.encodeWithSelector(IFluidDexLiteAdminModule.initialize.selector, initParams);
