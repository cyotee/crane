...
import "@crane/test/foundry/spec/protocols/staking/liquity/v2/bold/TestContracts/GasGuzzlerOracle.sol";
import "@crane/test/foundry/spec/protocols/staking/liquity/v2/bold/TestContracts/GasGuzzlerToken.sol";
import "@crane/test/foundry/spec/protocols/staking/liquity/v2/bold/TestContracts/RETHTokenMock.sol";
...
contract OraclesMainnet is TestAccounts {
    ...
    function setUp() public {
        try vm.rpcUrl("ethereum_mainnet_alchemy") returns (string memory rpcUrl) {
