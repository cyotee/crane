...
abstract contract GovernanceTest is Test {
    ...
    function test_lqtyToVotes(uint88 _lqtyAmount, uint32 _currentTimestamp, uint256 _offset) public view {
    ...
    function test_unregisterInitiative() public {
        ...
        vm.expectRevert("Governance: cannot-unregister-initiative");
        /// @custom:audit should fail due to not waiting enough time
        governance.unregisterInitiative(baseInitiative3);
    ...
    function test_crit_accounting_mismatch() public {
        ...
        /// @custom:audit TODO Fully digest and explain the bug
    ...
    function test_canAlwaysRemoveAllocation() public {
        ...
        // @custom:audit Warmup is not necessary
        ...
        /// @custom:audit This MUST revert, an initiative should not be re-votable once disabled
    ...
    function test_addRemoveAllocation_accounting() public {
        ...
        /// @custom:audit the next call MUST not revert - this is a critical bug
        governance.resetAllocations(removeInitiatives, true);
    ...
    function test_allocateLQTY_fuzz_deltaLQTYVetos(uint256 _deltaLQTYVetos) public {
        ...
        governance.allocateLQTY(initiativesToReset, initiatives, deltaLQTYVotes, deltaLQTYVetos);
        /// @custom:audit needs overflow tests!!
        vm.stopPrank();
    }
    ...
    function test_claimForInitiative() public {
        ...
        // @custom:audit user can't deallocate because votes already get reset
...
contract MockedGovernanceTest is GovernanceTest, MockStakingV1Deployer {
    function setUp() public override {
        // V2-gov upstream foundry.toml sets `block_timestamp = 2592000`; Crane uses a global
        // foundry.toml without that override, so warp before tests subtract EPOCH_DURATION.
        vm.warp(2592000);
