...
import {veFPISProxy} from "@crane/contracts/protocols/tokens/stable/frax/Curve/veFPISProxy.sol";
import {IveFPIS} from "@crane/contracts/protocols/tokens/stable/frax/Curve/IveFPIS.sol";
...
contract veFPISProxyTest is TestBase_FraxEthereumFork {
    veFPISProxy public proxy;
    ...
    function testTransferFromVeFPISToApp(uint256 amountFPIS) public {
        ...
        emit veFPISProxy.UserSetAppMaxFPISUsage(address(app), amountFPIS);
        vm.prank(ALICE);
        proxy.userSetAppMaxFPISUsage(address(app), amountFPIS);

        vm.expectEmit(true, true, false, true);
        emit veFPISProxy.TransferredFromVeFPISToApp(address(app), ALICE, amountFPIS);
    ...
    function testTransferFromAppToVeFPIS(uint256 amountFPIS) public {
        ...
        vm.expectEmit(true, true, false, true);
        emit veFPISProxy.TransferredFromAppToVeFPIS(address(app), ALICE, amountFPIS);
    ...
    function testAppAdd(uint256 amountFPIS) public {
        ...
        vm.expectEmit(true, true, false, true);
        emit veFPISProxy.AppAdds(address(app), ALICE, amountFPIS, 0);
    ...
    function testUserSurplusAdd(uint256 amountFPIS, uint256 maxUsage) public {
        ...
        vm.expectEmit(true, true, false, true);
        emit veFPISProxy.AppAdds(address(app), ALICE, amountFPIS, amountFPIS - maxUsage);
        app.add(ALICE, amountFPIS);
    ...
    function testAppSlash(uint256 amountFPIS, uint256 amountSlash) public {
        ...
        vm.expectEmit(true, true, false, true);
        emit veFPISProxy.AppSlashes(address(app), ALICE, amountSlash);
    ...
    function testSetUsage(uint256 newPrecision) public {
        ...
        vm.expectEmit(true, false, false, true);
        emit veFPISProxy.SetAppMaxUsagePct(address(app), newPrecision);
        vm.prank(FPIS_COMPTROLLER);
    ...
    function testAddApp(uint256 maxUsagePct) public {
        ...
        vm.expectEmit(true, false, false, true);
        emit veFPISProxy.AddNewApp(address(app), maxUsagePct);
    ...
    function testUserSlashAfterLosingFunds(uint256 amountFPIS) public {
        ...
        vm.expectEmit(true, false, false, true);
        emit veFPISProxy.SetAppAllowUserSlashes(address(app), true);
        vm.prank(FPIS_COMPTROLLER);
        ...
        vm.expectEmit(true, true, false, true);
        emit veFPISProxy.UserSlashes(address(app), ALICE, amountFPIS);
        vm.prank(ALICE);
