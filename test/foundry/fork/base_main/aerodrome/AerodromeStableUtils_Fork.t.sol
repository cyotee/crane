...
import {AerodromServiceStable} from
    "@crane/contracts/protocols/dexes/aerodrome/v1/services/AerodromServiceStable.sol";
...
/// @dev Tests AerodromServiceStable quote calculations against actual swap results
///
/// ## Stable Pool Math
///
...
/// 3. AerodromServiceStable's `_getAmountOutStable()` - our local implementation
///
...
contract AerodromeStableUtils_Fork_Test is TestBase_AerodromeFork {
    ...
    /* -------------------------------------------------------------------------- */
    /*                AerodromServiceStable Parity Tests                          */
    /* -------------------------------------------------------------------------- */

    /// @notice Test AerodromServiceStable._getAmountOutStable matches pool.getAmountOut
    ...
    function test_serviceStable_getAmountOutStable_parity() public {
        ...
        uint256 serviceQuote = AerodromServiceStable._getAmountOutStable(
            amountIn,
            reserveIn,
            reserveOut,
            decimalsIn,
        ...
        console.log("AerodromServiceStable parity test:");
        console.log("  amountIn (USDC):", amountIn);
    ...
    /// @notice Test AerodromServiceStable parity with reverse direction
    function test_serviceStable_getAmountOutStable_parity_reverse() public {
        ...
        console.log("AerodromServiceStable parity test (reverse):");
        console.log("  amountIn (USDbC):", amountIn);
        console.log("  poolQuote:", poolQuote);
        console.log("  serviceQuote:", serviceQuote);
