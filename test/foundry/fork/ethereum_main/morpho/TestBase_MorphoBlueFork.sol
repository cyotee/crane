...
// tag::TestBase_MorphoBlueFork[]
/**
 * @title TestBase_MorphoBlueFork
 * @notice Ethereum mainnet fork base: binds live Morpho Blue + AdaptiveCurveIRM + oracle factory.
 */
abstract contract TestBase_MorphoBlueFork is Test {
    ...
    function setUp() public virtual {
        vm.createSelectFork(vm.rpcUrl("ethereum_mainnet_alchemy"), ETHEREUM_MAIN.DEFAULT_FORK_BLOCK);

        liveMorpho = IMorpho(ETHEREUM_MAIN.MORPHO);
        liveIrm = ETHEREUM_MAIN.MORPHO_ADAPTIVE_CURVE_IRM;
        liveOracleFactory = ETHEREUM_MAIN.MORPHO_CHAINLINK_ORACLE_V2_FACTORY;
