...
import {BaseHooksMock} from "@balancer-labs/v3-vault/contracts/test/BaseHooksMock.sol";
...
import {ERC20MultiTokenMock} from "@balancer-labs/v3-vault/contracts/test/ERC20MultiTokenMock.sol";
import {LinearBasePoolMathMock} from "@balancer-labs/v3-vault/contracts/test/LinearBasePoolMathMock.sol";
...
} from "@balancer-labs/v3-vault/contracts/test/PoolMockFlexibleInvariantRatio.sol";
import {RateProviderMock} from "@balancer-labs/v3-vault/contracts/test/RateProviderMock.sol";
import {RouterCommonMock} from "@balancer-labs/v3-vault/contracts/test/RouterCommonMock.sol";
 ...
 */
contract BetterVaultContractsDeployer is
    CommonBase,
    ScriptBase,
    StdChains,
    StdCheatsSafe,
    ...
    BetterBaseContractsDeployer
{
    ...
    function _computeVaultTestPath(string memory name) private view returns (string memory) {
        return string(abi.encodePacked(artifactsRootDir, "contracts/crane/test/", name, ".sol/", name, ".json"));
    }
}
