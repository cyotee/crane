 ...
 */
contract BalancerV3Authorizer is AccessControl, IAuthorizer {
    constructor(address admin) {
        _grantRole(DEFAULT_ADMIN_ROLE, admin);
    }

    function canPerform(bytes32 actionId, address account, address) public view override returns (bool) {
