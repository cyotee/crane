...
library UInt256 {
     ...
     */
    function toAddress(uint256 value) internal pure returns (address result) {
    ...
    function toHexString(uint256 value, uint256 length) internal pure returns (string memory valueAsString) {
