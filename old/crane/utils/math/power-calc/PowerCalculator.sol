...
import {PowerStorage} from "contracts/crane/utils/math/power-calc/PowerStorage.sol";
 ...
 */
contract PowerCalculator is PowerStorage, IPower {
    ...
    function power(uint256 _baseN, uint256 _baseD, uint32 _expN, uint32 _expD) public view returns (uint256, uint8) {
        ...
        // }
        return _power(_baseN, _baseD, _expN, _expD);
    }
    ...
    function findPositionInMaxExpArray(uint256 _x) public view returns (uint8) {
        ...
        // assert(false);
        // return 0;
        return _findPositionInMaxExpArray(_x);
    }
    ...
    function generalExp(uint256 _x, uint8 _precision) public pure returns (uint256) {
        ...
        return _generalExp(_x, _precision);
    }
