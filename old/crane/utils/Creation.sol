...
library Creation {
    ...
    function _create2WithArgs(bytes memory initCode, bytes32 salt, bytes memory initArgs)
        ...
        returns (address deployment)
    {
        deployment = initCode._create2WithArgs(salt, initArgs);
    }
    ...
    function _create3(bytes memory initCode, bytes32 salt) internal returns (address deployment) {
    ...
    function _create3WithArgs(bytes memory initCode, bytes memory initArgs, bytes32 salt)
        ...
        returns (address deployment)
    {
        return _create3(abi.encodePacked(initCode, initArgs), salt);
    }
