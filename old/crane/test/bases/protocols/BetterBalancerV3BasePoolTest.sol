...
import {BetterBalancerV3BaseTest} from "contracts/crane/test/bases/protocols/BetterBalancerV3BaseTest.sol";
import {TestBase_Permit2} from "contracts/crane/test/bases/protocols/TestBase_Permit2.sol";

abstract contract BetterBalancerV3BasePoolTest is
    CommonBase,
    ScriptBase,
    TestBase,
    StdAssertions,
    ...
    BetterBalancerV3VaultTest
{
    ...
    function setUp()
        public
        virtual
        override(Test_Crane, BetterBalancerV3BaseTest, TestBase_Permit2, BetterBalancerV3VaultTest)
    {
