...
import {IWETHAware} from "contracts/crane/interfaces/IWETHAware.sol";
...
import {TestBase_WETH} from "contracts/crane/test/bases/protocols/TestBase_WETH.sol";
...
abstract contract TestBase_IWETHAware is
    CommonBase,
    ScriptBase,
    TestBase,
    StdAssertions,
    ...
    TestBase_WETH
{
    ...
    function test_IWETHAware() public {
        assertEq(address(wethAwareTestSubject().weth()), address(weth9()));
    }
}
