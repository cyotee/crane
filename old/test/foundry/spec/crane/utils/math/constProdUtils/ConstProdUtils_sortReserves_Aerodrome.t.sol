...
contract ConstProdUtils_sortReserves_Aerodrome is TestBase_ConstProdUtils_Aerodrome {
    ...
    function test_sortReserves_4Param_knownTokenIsToken0() public view {
        address knownToken = address(aeroBalancedTokenA);
        address token0 = address(aeroBalancedTokenA);
    ...
    function test_sortReserves_4Param_knownTokenIsToken1() public view {
        address knownToken = address(aeroBalancedTokenB);
        address token0 = address(aeroBalancedTokenA);
        uint256 reserve0 = 1000e18;
        uint256 reserve1 = 2000e18;
