...
// contract Test_ConstProdUtils_calculateZapOutLP is TestBase_ConstProdUtils {
...
//         uint256 expectedLpNeeded = ConstProdUtils._calculateZapOutLP(
...
//     function test_calculateZapOutLP_edgeCase_smallDesiredOut() public {
//         (uint112 reserveA, uint112 reserveB, , ) = camelotBalancedPair.getReserves();
//         (,,uint32 feeA,) = camelotBalancedPair.getReserves();
//         uint256 feePercent = uint256(feeA);
//         uint256 lpTotalSupply = camelotBalancedPair.totalSupply();
...
//     function test_calculateZapOutLP_edgeCase_largeDesiredOut() public {
//         (uint112 reserveA, uint112 reserveB, , ) = camelotBalancedPair.getReserves();
//         (,,uint32 feeA,) = camelotBalancedPair.getReserves();
//         uint256 feePercent = uint256(feeA);
//         uint256 lpTotalSupply = camelotBalancedPair.totalSupply();
...
//     function test_calculateZapOutLP_edgeCase_differentFees() public {
//         (uint112 reserveA, uint112 reserveB, , ) = camelotBalancedPair.getReserves();
//         (,,uint32 feeA,) = camelotBalancedPair.getReserves();
//         uint256 feePercent = uint256(feeA);
//         uint256 lpTotalSupply = camelotBalancedPair.totalSupply();
...
//     function test_calculateZapOutLP_edgeCase_verySmallReserves() public {
//         (uint112 reserveA, uint112 reserveB, , ) = camelotBalancedPair.getReserves();
//         (,,uint32 feeA,) = camelotBalancedPair.getReserves();
//         uint256 feePercent = uint256(feeA);
//         uint256 lpTotalSupply = camelotBalancedPair.totalSupply();
...
//     function test_calculateZapOutLP_edgeCase_midRangeDesiredOut() public {
//         (uint112 reserveA, uint112 reserveB, , ) = camelotBalancedPair.getReserves();
//         (,,uint32 feeA,) = camelotBalancedPair.getReserves();
//         uint256 feePercent = uint256(feeA);
//         uint256 lpTotalSupply = camelotBalancedPair.totalSupply();
...
//     function test_calculateZapOutLP_edgeCase_maxDesiredOut() public {
//         (uint112 reserveA, uint112 reserveB, ) = uniswapBalancedPair.getReserves();
//         uint256 lpTotalSupply = uniswapBalancedPair.totalSupply();
