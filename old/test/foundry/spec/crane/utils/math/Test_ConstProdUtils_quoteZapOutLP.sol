...
// contract Test_ConstProdUtils_quoteZapOutLP is TestBase_ConstProdUtils {
...
//     function test_quoteZapOutLP_Camelot_balancedPool() public {
...
//         // Calculate expected LP needed
//         uint256 expectedLpNeeded = ConstProdUtils._quoteZapOutLP(
...
//     function test_quoteZapOutLP_Camelot_unbalancedPool() public {
...
//     function test_quoteZapOutLP_Camelot_extremeUnbalancedPool() public {
...
//     function test_quoteZapOutLP_Uniswap_balancedPool() public {
...
//     function test_quoteZapOutLP_Uniswap_unbalancedPool() public {
//         (uint112 reserveA, uint112 reserveB, ) = uniswapBalancedPair.getReserves();
//         uint256 lpTotalSupply = uniswapBalancedPair.totalSupply();
...
//     function test_quoteZapOutLP_Uniswap_extremeUnbalancedPool() public {
//         (uint112 reserveA, uint112 reserveB, ) = uniswapBalancedPair.getReserves();
//         uint256 lpTotalSupply = uniswapBalancedPair.totalSupply();
...
//     function test_quoteZapOutLP_edgeCase_smallDesiredOut() public {
//         (uint112 reserveA, uint112 reserveB, , ) = camelotBalancedPair.getReserves();
//         (,,uint32 feeA,) = camelotBalancedPair.getReserves();
//         uint256 feePercent = uint256(feeA);
//         uint256 lpTotalSupply = camelotBalancedPair.totalSupply();
...
//     function test_quoteZapOutLP_edgeCase_largeDesiredOut() public {
//         (uint112 reserveA, uint112 reserveB, , ) = camelotBalancedPair.getReserves();
//         (,,uint32 feeA,) = camelotBalancedPair.getReserves();
//         uint256 feePercent = uint256(feeA);
//         uint256 lpTotalSupply = camelotBalancedPair.totalSupply();
...
//         uint256 desiredOut = (reserveA * 3) / 4; // 75% of TokenA reserves
...
//     function test_quoteZapOutLP_edgeCase_differentFees() public {
//         (uint112 reserveA, uint112 reserveB, , ) = camelotBalancedPair.getReserves();
//         (,,uint32 feeA,) = camelotBalancedPair.getReserves();
//         uint256 feePercent = uint256(feeA);
//         uint256 lpTotalSupply = camelotBalancedPair.totalSupply();
...
//     function test_quoteZapOutLP_edgeCase_verySmallReserves() public {
//         (uint112 reserveA, uint112 reserveB, , ) = camelotBalancedPair.getReserves();
//         (,,uint32 feeA,) = camelotBalancedPair.getReserves();
//         uint256 feePercent = uint256(feeA);
//         uint256 lpTotalSupply = camelotBalancedPair.totalSupply();
...
//     function test_quoteZapOutLP_edgeCase_midRangeDesiredOut() public {
//         (uint112 reserveA, uint112 reserveB, , ) = camelotBalancedPair.getReserves();
//         (,,uint32 feeA,) = camelotBalancedPair.getReserves();
//         uint256 feePercent = uint256(feeA);
//         uint256 lpTotalSupply = camelotBalancedPair.totalSupply();
...
//         uint256 desiredOut = (reserveA * 2) / 5; // 40% of TokenA reserves
...
//     function test_quoteZapOutLP_edgeCase_maxDesiredOut() public {
//         (uint112 reserveA, uint112 reserveB, ) = uniswapBalancedPair.getReserves();
//         uint256 lpTotalSupply = uniswapBalancedPair.totalSupply();

//         // Set maximum reasonable desired TokenA amount
//         uint256 desiredOut = (reserveA * 9) / 10; // 90% of TokenA reserves
