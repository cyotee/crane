...
contract ERC4626Facet_ICreate2Aware_Test is ScriptBase_Crane_ERC20, TestBase_ICreate2Aware {
    function setUp()
        public
        override(
            // Script_BalancerV3,
    ...
    function create2TestInstance() public override returns (ICreate2Aware) {
        return ICreate2Aware(erc4626Facet());
    }
    ...
    function controlInitCodeHash() public pure override returns (bytes32) {
        return ERC4626_FACET_INITCODE_HASH;
    }

    function controlSalt() public pure override returns (bytes32) {
        return ERC4626_FACET_SALT;
    }
}
