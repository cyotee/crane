...
library BetterStrings {
     ...
     * @dev Wrapper function for the OZ Address.verifyCallResultFromTarget function.
     */
    function _parseUint(string memory input) internal pure returns (uint256) {
     ...
     * @dev Wrapper function for the OZ Address.verifyCallResultFromTarget function.
     */
    function _parseUint(string memory input, uint256 begin, uint256 end) internal pure returns (uint256) {
     ...
     * @dev Wrapper function for the OZ Address.verifyCallResultFromTarget function.
     */
    function _tryParseUint(string memory input) internal pure returns (bool success, uint256 value) {
     ...
     * @dev Wrapper function for the OZ Address.verifyCallResultFromTarget function.
     */
    function _tryParseUint(string memory input, uint256 begin, uint256 end)
        internal
        pure
     ...
     * @dev Wrapper function for the OZ Address.verifyCallResultFromTarget function.
     */
    function _parseInt(string memory input) internal pure returns (int256) {
     ...
     * @dev Wrapper function for the OZ Address.verifyCallResultFromTarget function.
     */
    function _parseInt(string memory input, uint256 begin, uint256 end) internal pure returns (int256) {
     ...
     * @dev Wrapper function for the OZ Address.verifyCallResultFromTarget function.
     */
    function _tryParseInt(string memory input) internal pure returns (bool success, int256 value) {
     ...
     * @dev Wrapper function for the OZ Address.verifyCallResultFromTarget function.
     */
    function _tryParseInt(string memory input, uint256 begin, uint256 end)
        internal
        pure
     ...
     * @dev Wrapper function for the OZ Address.verifyCallResultFromTarget function.
     */
    function _parseHexUint(string memory input) internal pure returns (uint256) {
     ...
     * @dev Wrapper function for the OZ Address.verifyCallResultFromTarget function.
     */
    function _parseHexUint(string memory input, uint256 begin, uint256 end) internal pure returns (uint256) {
     ...
     * @dev Wrapper function for the OZ Address.verifyCallResultFromTarget function.
     */
    function _tryParseHexUint(string memory input) internal pure returns (bool success, uint256 value) {
     ...
     * @dev Wrapper function for the OZ Address.verifyCallResultFromTarget function.
     */
    function _tryParseHexUint(string memory input, uint256 begin, uint256 end)
        internal
        pure
        returns (bool success, uint256 value)
    {
     ...
     * @dev Wrapper function for the OZ Address.verifyCallResultFromTarget function.
     */
    function _parseAddress(string memory input) internal pure returns (address) {
     ...
     * @dev Wrapper function for the OZ Address.verifyCallResultFromTarget function.
     */
    function _parseAddress(string memory input, uint256 begin, uint256 end) internal pure returns (address) {
     ...
     * @dev Wrapper function for the OZ Address.verifyCallResultFromTarget function.
     */
    function _tryParseAddress(string memory input) internal pure returns (bool success, address value) {
     ...
     * @dev Wrapper function for the OZ Address.verifyCallResultFromTarget function.
     */
    function _tryParseAddress(string memory input, uint256 begin, uint256 end)
        internal
        pure
