...
import {UInt256} from "src/utils/UInt256.sol";
...
library BetterAddress {
    ...
    function _toHexString(address addr) internal pure returns (string memory) {
        // TODO Double check this will pefix with 0x. Probably just need to wrap call to BetterStrings.
    ...
    // function _sort(address[] memory array, uint256 unsortedLen) internal pure {
