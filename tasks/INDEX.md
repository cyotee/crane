...
| CRANE-023 | Add ERC-5267 Test Coverage | Pending Merge | CRANE-005 | `test/erc5267-coverage` |
| CRANE-024 | Harden Zap-Out Fee-On Input Validation | In Progress | CRANE-006 | `fix/zapout-fee-validation` |
