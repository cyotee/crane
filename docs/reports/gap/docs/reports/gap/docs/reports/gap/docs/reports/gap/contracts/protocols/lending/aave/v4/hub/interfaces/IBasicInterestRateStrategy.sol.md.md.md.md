# Gap Report for: docs/reports/gap/docs/reports/gap/docs/reports/gap/contracts/protocols/lending/aave/v4/hub/interfaces/IBasicInterestRateStrategy.sol.md.md.md
