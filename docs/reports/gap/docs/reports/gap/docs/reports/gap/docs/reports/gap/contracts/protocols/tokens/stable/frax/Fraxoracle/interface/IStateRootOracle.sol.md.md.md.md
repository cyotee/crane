# Gap Report for: docs/reports/gap/docs/reports/gap/docs/reports/gap/contracts/protocols/tokens/stable/frax/Fraxoracle/interface/IStateRootOracle.sol.md.md.md
