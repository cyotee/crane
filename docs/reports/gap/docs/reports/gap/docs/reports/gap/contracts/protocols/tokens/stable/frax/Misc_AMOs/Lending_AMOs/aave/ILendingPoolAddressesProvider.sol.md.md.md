# Gap Report for: docs/reports/gap/docs/reports/gap/contracts/protocols/tokens/stable/frax/Misc_AMOs/Lending_AMOs/aave/ILendingPoolAddressesProvider.sol.md.md
