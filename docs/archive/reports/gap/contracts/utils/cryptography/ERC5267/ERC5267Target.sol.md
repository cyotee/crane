# Gap Report for: contracts/utils/cryptography/ERC5267/ERC5267Target.sol
...
**Follow-up alignment (post EIP712Repo LR-6 gold edit):** Updated import/usage from removed EIP712Layout to EIP712Repo.Storage to restore build after standardization of struct name to `Storage` (per AGENTS + other gold Repos). This was required to unblock LR-1/LR-7 work on dependents. Source edit + this gap + GAP_REPORT only. Targeted build/inspect to follow. (See main GAP for cross-ref.)
