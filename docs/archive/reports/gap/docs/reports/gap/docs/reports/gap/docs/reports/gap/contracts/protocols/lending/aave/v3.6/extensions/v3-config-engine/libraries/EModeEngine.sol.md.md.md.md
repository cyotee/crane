# Gap Report for: docs/reports/gap/docs/reports/gap/docs/reports/gap/contracts/protocols/lending/aave/v3.6/extensions/v3-config-engine/libraries/EModeEngine.sol.md.md.md
