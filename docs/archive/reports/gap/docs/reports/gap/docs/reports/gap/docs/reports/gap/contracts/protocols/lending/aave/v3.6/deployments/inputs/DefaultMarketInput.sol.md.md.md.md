# Gap Report for: docs/reports/gap/docs/reports/gap/docs/reports/gap/contracts/protocols/lending/aave/v3.6/deployments/inputs/DefaultMarketInput.sol.md.md.md
