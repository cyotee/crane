# Gap Report for: docs/reports/gap/docs/reports/gap/docs/reports/gap/contracts/protocols/lending/aave/v3.6/instances/VariableDebtTokenMainnetInstanceGHO.sol.md.md.md
