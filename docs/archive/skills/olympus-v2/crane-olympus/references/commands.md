...
| Setting | Value / why |
|---------|-------------|
| `src` | `contracts/protocols/tokens/stable/olympus/v2` |
| `test` | `test/foundry/spec/protocols/tokens/stable/olympus/v2` |
...
forge build
forge test
forge test --match-path 'test/foundry/spec/protocols/tokens/stable/olympus/v2/Kernel.t.sol' -vv
