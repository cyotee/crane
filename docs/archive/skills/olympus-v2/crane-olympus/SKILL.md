---
name: crane-olympus
description: This skill should be used when the user asks about "Crane Olympus", "Olympus port", "FOUNDRY_PROFILE=olympus_port", "integrate Olympus Kernel", "Olympus Diamond strategy", "Olympus TestBase", "olympus hermetic tests", building Crane integrations against the Olympus Default Framework port, or writing Foundry tests for Olympus under tokens/stable/olympus/v2.
license: MIT
---
...
| Hermetic tests | `test/foundry/spec/protocols/tokens/stable/olympus/v2/` |
...
import {Kernel, Policy, Permissions, Keycode, toKeycode} from
    "@crane/contracts/protocols/tokens/stable/olympus/v2/Kernel.sol";
import {MINTRv1} from
    "@crane/contracts/protocols/tokens/stable/olympus/v2/modules/MINTR/MINTR.v1.sol";
import {ROLESv1} from
    "@crane/contracts/protocols/tokens/stable/olympus/v2/modules/ROLES/ROLES.v1.sol";
import {RolesConsumer} from
    "@crane/contracts/protocols/tokens/stable/olympus/v2/modules/ROLES/OlympusRoles.sol";
...
| Path match | `… forge test --match-path 'test/foundry/spec/protocols/tokens/stable/olympus/v2/**'` |
...
- Tests: `test/foundry/spec/protocols/tokens/stable/olympus/v2/Kernel.t.sol`, `modules/*.t.sol`
