...
> Docs copy of the repo-root `BANKR_LAUNCH.md` playbook for GitBook navigation. Prefer the root file when editing the canonical runbook in-repo.
...
See also: [Getting Started](../getting-started.md), repo [GOVERNANCE.md](../../GOVERNANCE.md), [README.md](../../README.md), and Bankr docs at https://docs.bankr.bot/.
