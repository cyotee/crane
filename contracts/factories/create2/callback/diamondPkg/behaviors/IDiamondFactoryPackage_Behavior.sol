...
// import "contracts/crane/test/comparators/Comparators.sol";
import {
    FacetsComparator
} from "../../../../../test/comparators/erc2535/FacetsComparator.sol";
...
} from "../../../../../factories/create2/callback/diamondPkg/libs/utils/DiamondFactoryPackageAdaptor.sol";
import {
    IDiamond
} from "../../../../../introspection/erc2535/interfaces/IDiamond.sol";

/**
 * @title IDiamondFactoryPackage_Behavior
 ...
 */
contract IDiamondFactoryPackage_Behavior
is
Behavior,
...
FacetsComparator
{
    ...
    mapping(
        ...
        mapping(address facet => IDiamond.FacetCutAction action)
    ...
    /* ------------------------- Helper Functions --------------------------- */
    function _idfPKG_behaviorName()
    internal pure returns(string memory) {
        return type(IDiamondFactoryPackage_Behavior).name;
    }

    function _idfPKG_errPrefix(
    ...
    function funcSig_IDiamondFactoryPackage_facetInterfaces()
    public pure returns(string memory) {
        return "facetInterfaces()";
    }

    function errSuffix_IDiamondFactoryPackage_facetInterfaces()
    public pure returns(string memory) {
    ...
    function areValid_IDiamondFactoryPackage_facetInterfaces(
        ...
        valid = _compare(
            ...
            actual,
            _idfPKG_errPrefix(
                funcSig_IDiamondFactoryPackage_facetInterfaces(),
                subjectLabel
            ),
    ...
    function areValid_IDiamondFactoryPackage_facetInterfaces(
        ...
        return areValid_IDiamondFactoryPackage_facetInterfaces(
    ...
    function expect_IDiamondFactoryPackage_facetInterfaces(
        ...
        _recExpectedBytes4(
            address(subject),
            IDiamondFactoryPackage.facetInterfaces.selector,
            expectedInterfaces_
        );
     ...
     */
    function hasValid_IDiamondFactoryPackage_facetInterfaces(
        IDiamondFactoryPackage subject
    ...
    function funcSig_IDiamondFactoryPackage_facetCuts()
    public pure returns(string memory) {
        return "facetCuts()";
    }

    function errSuffix_IDiamondFactoryPackage_facetCuts()
    public pure returns(string memory) {
        return "facets";
    }

    function errSuffix_IDiamondFactoryPackage_facets_funcs(
    ...
    function areValid_IDiamondLoupe_facetCuts(
        ...
        if(expected.length != actual.length) {
            _logLengthMismatch(
                ...
                actual.length,
                _idfPKG_errPrefix(
                    funcSig_IDiamondFactoryPackage_facetCuts(),
                    vm.getLabel(address(subject))
                ),
    ...
    function funcSig_IDiamondFactoryPackage_diamondConfig()
    public pure returns(string memory) {
    ...
    function _evalFacetInterfaces(
        ...
        isValid = _compare(
            ...
            actual.interfaces,
            _idfPKG_errPrefix(
                funcSig_IDiamondFactoryPackage_diamondConfig(),
                vm.getLabel(address(subject))
            ),
            errSuffix_IDiamondFactoryPackage_facetInterfaces()
        );
    ...
    function _evalDiamondConfig(
        ...
        console.logBehaviorProcessing(
            ...
            string.concat(
                "expected: ",
                expected.facetCuts.length._toString(),
                ", actual: ",
                actual.facetCuts.length._toString()
            )
        );
        ...
        for(uint256 expectedCursor = 0; expectedCursor < expected.facetCuts.length; expectedCursor++) {
            ...
            if (!actionCheck) {
                console.logBehaviorError(
                    ...
                    string.concat(
                        "Facet: ",
                        vm.getLabel(expected.facetCuts[expectedCursor].facetAddress)
                    )
                );
            }
    ...
    function _diamondConfigErPrefix(
        IDiamondFactoryPackage subject
    ) internal view returns(string memory) {
        return _idfPKG_errPrefix(
            funcSig_IDiamondFactoryPackage_diamondConfig(),
            vm.getLabel(address(subject))
        );
    }
    ...
    function expect_IDiamondFactoryPackage_diamondConfig(
        ...
        _recExpectedBytes4(
            address(subject),
            IDiamondFactoryPackage.diamondConfig.selector,
            expected.interfaces
        );
     ...
     */
    function expected_IDiamondFactoryPackage_diamondConfig(
        IDiamondFactoryPackage subject
    ) public view returns(IDiamondFactoryPackage.DiamondConfig memory expected) {
        ...
        expected.interfaces = _recedExpectedBytes4(
            address(subject),
            IDiamondFactoryPackage.diamondConfig.selector
        )._values();
    }
     ...
     * @return isValid True if the config matches expectations
     */
    function hasValid_IDiamondFactoryPackage_diamondConfig(
        IDiamondFactoryPackage subject
    ) public returns(bool isValid) {
        ...
        isValid = areValid_IDiamondFactoryPackage_diamondConfig(
            subject,
            expected_IDiamondFactoryPackage_diamondConfig(subject),
            subject.diamondConfig()
        );
        
        console.logBehaviorValidation(
            _idfPKG_behaviorName(),
            "hasValid_IDiamondFactoryPackage_diamondConfig",
            "diamond config",
            isValid
        );
    ...
    function funcSig_IDiamondFactoryPackage_calcSalt()
    public pure returns(string memory) {
        return "calcSalt(bytes)";
    }

    function errSuffix_IDiamondFactoryPackage_calcSalt()
    public pure returns(string memory) {
        return "salt";
    }
     ...
     */
    function areValid_IDiamondFactoryPackage_calcSalt(
        string memory subjectLabel,
        bytes32 expected,
        bytes32 actual
        ...
        if(!isValid) {
            console.logBehaviorError(
                ...
                string.concat(
                    _idfPKG_errPrefix(
                        funcSig_IDiamondFactoryPackage_calcSalt(),
                        subjectLabel
                    ),
                    " UNEXPECTED ",
    ...
    function expect_IDiamondFactoryPackage_calcSalt(
        ...
        _expected_salt[address(subject)].push(
            CalcSaltExpect({
        ...
        console.logBehaviorExpectation(
            _idfPKG_behaviorName(),
            "expect_IDiamondFactoryPackage_calcSalt",
            "sender",
            vm.getLabel(expectedSender)
        );
     ...
     */
    function expected_IDiamondFactoryPackage_calcSalt(
        IDiamondFactoryPackage subject
    ) public view returns(CalcSaltExpect[] memory) {
     ...
     */
    function hasValid_IDiamondFactoryPackage_calcSalt(
        IDiamondFactoryPackage subject
    ) public returns(bool isValid) {
        ...
        for(uint256 cursor = 0; cursor < expected.length; cursor++) {
            console.logBehaviorProcessing(
                _idfPKG_behaviorName(),
                "hasValid_IDiamondFactoryPackage_calcSalt",
                "expectation",
                cursor._toString()
            );
            ...
            bool result = areValid_IDiamondFactoryPackage_calcSalt(
                vm.getLabel(address(subject)),
                expected[cursor].salt,
                subject._calcSalt(expected[cursor].args)
            );
    ...
    function funcSig_IDiamondFactoryPackage_processArgs()
    public pure returns(string memory) {
        return "processArgs(bytes)";
    }

    function errSuffix_IDiamondFactoryPackage_processArgs()
    public pure returns(string memory) {
    ...
    function areValid_IDiamondFactoryPackage_processArgs(
        ...
        if(!isValid) {
            console.logBehaviorError(
                ...
                string.concat(
                    _idfPKG_errPrefix(
                        funcSig_IDiamondFactoryPackage_processArgs(),
                        subjectLabel
                    ),
    ...
    function areValid_IDiamondFactoryPackage_processArgs(
        ...
        return areValid_IDiamondFactoryPackage_processArgs(
            vm.getLabel(address(subject)),
            expected,
            actual
        );
    ...
    function expect_IDiamondFactoryPackage_processArgs(
        ...
        _expected_args[address(subject)].push(
            ProcessArgsExpect({
                sender: expectedSender,
                args: expectedArgs,
                result: result
        ...
        console.logBehaviorExpectation(
            _idfPKG_behaviorName(),
            "expect_IDiamondFactoryPackage_processArgs",
            "sender",
            vm.getLabel(expectedSender)
        );
     ...
     */
    function expected_IDiamondFactoryPackage_processArgs(
        IDiamondFactoryPackage subject
    ) public view returns(ProcessArgsExpect[] memory) {
     ...
     */
    function hasValid_IDiamondFactoryPackage_processArgs(
        IDiamondFactoryPackage subject
    ) public returns(bool isValid) {
        ...
        for(uint256 cursor = 0; cursor < expected.length; cursor++) {
            console.logBehaviorProcessing(
                _idfPKG_behaviorName(),
                "hasValid_IDiamondFactoryPackage_processArgs",
                "expectation",
                cursor._toString()
            );
            ...
            bool result = areValid_IDiamondFactoryPackage_processArgs(
                ...
                subject._processArgs(expected[cursor].args)
            );
