...
import {
    ICreate2Aware
} from "../../../../factories/create2/aware/interfaces/ICreate2Aware.sol";

/**
 * @title ICreate2Aware_Behavior
 ...
 */
contract ICreate2Aware_Behavior is Behavior {
    /* ---------------------------- Library Usage --------------------------- */
    ...
    mapping(address subject => mapping(bytes4 selector => ICreate2Aware.CREATE2Metadata expectedMetadata)) private _expectedMetadata;

    /* ------------------------- Helper Functions --------------------------- */
    function _ic2a_behaviorName() 
    internal pure returns(string memory) {
        return type(ICreate2Aware_Behavior).name;
    }

    function _ic2a_errPrefixFunc(
    ...
    function _ic2a_errPrefix(
        string memory testedFuncSig,
        string memory subjectLabel
    ) internal view virtual returns(string memory) {
        return string.concat(
            _ic2a_errPrefixFunc(testedFuncSig),
            subjectLabel
        );
    }
    ...
    function funcSig_ICreate2Aware_ORIGIN()
    public pure returns(string memory) {
        return "ORIGIN()";
    }

    function errSuffix_ICreate2Aware_ORIGIN()
    public pure returns(string memory) {
        return "origin address";
    }

    function isValid_ICreate2Aware_ORIGIN(
        string memory subjectLabel,
        address expected,
        address actual
    ...
    function isValid_ICreate2Aware_ORIGIN(
        ...
        return isValid_ICreate2Aware_ORIGIN(
    ...
    function expect_ICreate2Aware_ORIGIN(
        ICreate2Aware subject,
        address expected
    ) public {
    ...
    function expected_ICreate2Aware_ORIGIN(
        ICreate2Aware subject
    ) public view returns(address) {
        return _expectedOrigins[address(subject)][ICreate2Aware.ORIGIN.selector];
    }

    function hasValid_ICreate2Aware_ORIGIN(
        ICreate2Aware subject
    ) public view returns(bool) {
        console.logBehaviorEntry(_ic2a_behaviorName(), "hasValid_ICreate2Aware_ORIGIN");
        
        bool isValid = isValid_ICreate2Aware_ORIGIN(
            subject,
            expected_ICreate2Aware_ORIGIN(subject),
            subject.ORIGIN()
        );
        
        console.logBehaviorValidation(
            _ic2a_behaviorName(),
            "hasValid_ICreate2Aware_ORIGIN",
            "origin",
            isValid
        );
    ...
    function funcSig_ICreate2Aware_INITCODE_HASH()
    public pure returns(string memory) {
        return "INITCODE_HASH()";
    }

    function errSuffix_ICreate2Aware_INITCODE_HASH()
    public pure returns(string memory) {
        return "initcode hash";
    }

    function isValid_ICreate2Aware_INITCODE_HASH(
        string memory subjectLabel,
        bytes32 expected,
        bytes32 actual
    ) public view returns(bool isValid) {
    ...
    function isValid_ICreate2Aware_INITCODE_HASH(
        ...
        return isValid_ICreate2Aware_INITCODE_HASH(
            vm.getLabel(address(subject)),
            expected,
            actual
        );
    ...
    function expect_ICreate2Aware_INITCODE_HASH(
        ICreate2Aware subject,
        bytes32 expected
    ) public {
        ...
        console.logBehaviorExpectation(
            _ic2a_behaviorName(),
            "expect_ICreate2Aware_INITCODE_HASH",
            "initcode hash",
    ...
    function expected_ICreate2Aware_INITCODE_HASH(
        ICreate2Aware subject
    ) public view returns(bytes32) {
        return _expectedHashes[address(subject)][ICreate2Aware.INITCODE_HASH.selector];
    }

    function hasValid_ICreate2Aware_INITCODE_HASH(
        ICreate2Aware subject
    ) public view returns(bool) {
        ...
        bool isValid = isValid_ICreate2Aware_INITCODE_HASH(
            subject,
            expected_ICreate2Aware_INITCODE_HASH(subject),
            subject.INITCODE_HASH()
        );
        
        console.logBehaviorValidation(
            _ic2a_behaviorName(),
            "hasValid_ICreate2Aware_INITCODE_HASH",
            "initcode hash",
            isValid
        );
    ...
    function funcSig_ICreate2Aware_SALT()
    public pure returns(string memory) {
        return "SALT()";
    }

    function errSuffix_ICreate2Aware_SALT()
    public pure returns(string memory) {
        return "salt value";
    }

    function isValid_ICreate2Aware_SALT(
        string memory subjectLabel,
        bytes32 expected,
        bytes32 actual
    ) public view returns(bool isValid) {
    ...
    function isValid_ICreate2Aware_SALT(
        ...
        return isValid_ICreate2Aware_SALT(
            vm.getLabel(address(subject)),
            expected,
            actual
        );
    ...
    function expect_ICreate2Aware_SALT(
        ICreate2Aware subject,
        bytes32 expected
    ) public {
    ...
    function expected_ICreate2Aware_SALT(
        ICreate2Aware subject
    ) public view returns(bytes32) {
        return _expectedSalts[address(subject)][ICreate2Aware.SALT.selector];
    }

    function hasValid_ICreate2Aware_SALT(
        ICreate2Aware subject
    ) public view returns(bool) {
        return isValid_ICreate2Aware_SALT(
            subject,
            expected_ICreate2Aware_SALT(subject),
            subject.SALT()
        );
    }
    ...
    function funcSig_ICreate2Aware_METADATA()
    public pure returns(string memory) {
        return "METADATA()";
    }

    function errSuffix_ICreate2Aware_METADATA()
    public pure returns(string memory) {
    ...
    function areValid_ICreate2Aware_METADATA(
        ...
        isValid = expected.origin == actual.origin &&
                 expected.initcodeHash == actual.initcodeHash &&
        ...
        if(!isValid) {
            console.log(
                string.concat(
                    _ic2a_errPrefix(
                        funcSig_ICreate2Aware_METADATA(),
                        subjectLabel
                    ),
                    " UNEXPECTED ",
    ...
    function areValid_ICreate2Aware_METADATA(
        ...
        return areValid_ICreate2Aware_METADATA(
            vm.getLabel(address(subject)),
            expected,
            actual
        );
    ...
    function expect_ICreate2Aware_METADATA(
        ICreate2Aware subject,
        ICreate2Aware.CREATE2Metadata memory expected
    ) public {
    ...
    function expected_ICreate2Aware_METADATA(
        ICreate2Aware subject
    ) public view returns(ICreate2Aware.CREATE2Metadata memory) {
        return _expectedMetadata[address(subject)][ICreate2Aware.METADATA.selector];
    }

    function hasValid_ICreate2Aware_METADATA(
        ICreate2Aware subject
    ) public view returns(bool) {
        return areValid_ICreate2Aware_METADATA(
            subject,
            expected_ICreate2Aware_METADATA(subject),
            subject.METADATA()
        );
    }
    ...
    function hasValid_ICreate2Aware(
        ICreate2Aware subject
    ) public view returns(bool) {
        console.logBehaviorEntry(_ic2a_behaviorName(), "hasValid_ICreate2Aware");
        
        bool isValid = hasValid_ICreate2Aware_ORIGIN(subject) &&
                      hasValid_ICreate2Aware_INITCODE_HASH(subject) &&
                      hasValid_ICreate2Aware_SALT(subject) &&
                      hasValid_ICreate2Aware_METADATA(subject);
                      
        console.logBehaviorValidation(
            _ic2a_behaviorName(),
            "hasValid_ICreate2Aware",
            "full interface",
            isValid
        );
