...
contract ERC2612Facet is ERC2612Target, IFacet {
    function facetName() public pure returns (string memory name) {
        return type(ERC2612Facet).name;
    }
        ...
        )
    {
        ...
        funcs[0] = IERC20Permit.permit.selector;
        funcs[1] = IERC20Permit.nonces.selector;
        funcs[2] = IERC20Permit.DOMAIN_SEPARATOR.selector;
    }
