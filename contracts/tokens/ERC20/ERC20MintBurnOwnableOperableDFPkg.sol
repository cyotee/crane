    ...
    IERC20MintBurnOwnableOperableDFPkg
{
    ...
    IFacet immutable ERC20_MINT_BURN_OWNABLE_FACET;
    ...
    constructor(PkgInit memory pkgInit) {
        ...
        MULTI_STEP_OWNABLE_FACET = pkgInit.mutiStepOwnableFacet;
    ...
    function packageName() public pure returns (string memory name_) {
        return type(ERC20MintBurnOwnableOperableDFPkg).name;
    }
    ...
    function facetAddresses() public view returns (address[] memory facetAddresses_) {
        ...
        facetAddresses_[5] = address(OPERABLE_FACET);
    }
        ...
        returns (bytes4[] memory interfaces)
    {
        ...
        interfaces[6] = type(IMultiStepOwnable).interfaceId;
        interfaces[7] = type(IOperable).interfaceId;
    }
