...
import {IEtherFiNode} from "@crane/contracts/external/etherfi/staking/interfaces/IEtherFiNode.sol";
import {IEtherFiNodesManager} from "@crane/contracts/external/etherfi/staking/interfaces/IEtherFiNodesManager.sol";
import {ILiquidityPool} from "@crane/contracts/external/etherfi/core/interfaces/ILiquidityPool.sol";

import {IDelegationManager} from "@crane/contracts/external/etherfi/interfaces/eigenlayer-interfaces/IDelegationManager.sol";
import {IDelegationManagerTypes} from "@crane/contracts/external/etherfi/interfaces/eigenlayer-interfaces/IDelegationManager.sol";
import {IEigenPodManager} from "@crane/contracts/external/etherfi/interfaces/eigenlayer-interfaces/IEigenPodManager.sol";
import {IEigenPod} from "@crane/contracts/external/etherfi/interfaces/eigenlayer-interfaces/IEigenPod.sol";
import {IStrategy} from "@crane/contracts/external/etherfi/interfaces/eigenlayer-interfaces/IStrategy.sol";
import {BeaconChainProofs} from "@crane/contracts/external/eigenlayer/contracts/libraries/BeaconChainProofs.sol";

import {IERC20} from "@crane/contracts/external/openzeppelin-contracts-v4/interfaces/IERC20.sol";
import {LibCall} from "@crane/contracts/external/solady/utils/LibCall.sol";
