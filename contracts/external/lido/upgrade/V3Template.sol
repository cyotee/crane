...
import {IAccessControlEnumerable} from "@crane/contracts/external/openzeppelin-contracts/access/AccessControlEnumerable.sol";
import {UpgradeableBeacon} from "@crane/contracts/external/openzeppelin-contracts-v5/proxy/beacon/UpgradeableBeacon.sol";

import {IBurner as IBurnerWithoutAccessControl} from "@crane/contracts/external/lido/common/interfaces/IBurner.sol";
import {IVersioned} from "@crane/contracts/external/lido/common/interfaces/IVersioned.sol";
import {IOssifiableProxy} from "@crane/contracts/external/lido/common/interfaces/IOssifiableProxy.sol";
import {ILido} from "@crane/contracts/external/lido/common/interfaces/ILido.sol";

import {VaultHub} from "@crane/contracts/external/lido/0.8.25/vaults/VaultHub.sol";
import {VaultFactory} from "@crane/contracts/external/lido/0.8.25/vaults/VaultFactory.sol";
import {OperatorGrid} from "@crane/contracts/external/lido/0.8.25/vaults/OperatorGrid.sol";
import {PausableUntilWithRoles} from "@crane/contracts/external/lido/0.8.25/utils/PausableUntilWithRoles.sol";
