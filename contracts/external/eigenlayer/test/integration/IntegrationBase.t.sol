...
import "@crane/contracts/external/openzeppelin-contracts-v5/token/ERC20/extensions/IERC20Metadata.sol";
import "@crane/contracts/external/openzeppelin-contracts-v5/utils/Strings.sol";
...
abstract contract IntegrationBase is IntegrationDeployer, TypeImporter {
    ...
    function assert_Snap_Unchanged_WithdrawableGwei(User staker, string memory err) internal {
        ...
        assertEq(prevWithdrawableRestakedGwei, curWithdrawableRestakedGwei, err);
    }
