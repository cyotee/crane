...
library Chainlink {
     ...
     */
    function _initialize(Request memory self, bytes32 jobId, address callbackAddr, bytes4 callbackFunc)
        internal
        pure
    ...
    // Frax / Chainlink v0.6 compatibility aliases
