...
contract MockERC20 {
        ...
        virtual
    {
        ...
        // );
        bytes32 permitHash =
            bytes("Permit(address owner,address spender,uint256 value,uint256 nonce,uint256 deadline)")._hash();
        bytes32 argsHash = abi.encode(permitHash, owner, spender, value, nonces[owner]++, deadline)._hash();
        address recoveredAddress =
            ecrecover(abi.encodePacked("\x19\x01", DOMAIN_SEPARATOR(), argsHash)._hash(), v, r, s);
