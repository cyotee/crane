...
const typechain_types_1 = require("@balancer-labs/v3-solidity-utils/typechain-types");
const BatchSwapBase_1 = require("./BatchSwapBase");
describe('PrepaidBatchSwap', function () {
    const baseTest = new BatchSwapBase_1.BatchSwapBaseTest(true);
    baseTest.pathMaxAmountIn = (0, numbers_1.fp)(2);
    before('setup signers', async () => {
        await baseTest.setUpSigners();
    });
    (0, sharedBeforeEach_1.sharedBeforeEach)('setup test', async function () {
    ...
    (0, sharedBeforeEach_1.sharedBeforeEach)('add some dust to the Vault (DDoS check)', async () => {
        ...
        context('pure swaps with no nesting', () => {
            context('should revert if path is incorrect', () => {
                it('should revert if the step.pool is tokenIn', async () => {
                    (0, chai_1.expect)(baseTest.aggregatorRouter.connect(baseTest.sender).swapExactIn([
                        {
                    ...
                    ], constants_1.MAX_UINT256, false, '0x')).to.be.revertedWithCustomError(baseTest.aggregatorRouter, 'OperationNotSupported');
                });
            ...
            context('single path', () => {
                beforeEach(async () => {
                    ...
                    await (await typechain_types_1.ERC20TestToken__factory.connect(baseTest.token0, baseTest.sender).transfer(baseTest.vault, baseTest.totalAmountIn)).wait();
            ...
            context('multi path, MISO', () => {
                beforeEach(async () => {
                    ...
                    await (await typechain_types_1.ERC20TestToken__factory.connect(baseTest.token0, baseTest.sender).transfer(baseTest.vault, baseTest.pathExactAmountIn)).wait();
                    await (await typechain_types_1.ERC20TestToken__factory.connect(baseTest.token1, baseTest.sender).transfer(baseTest.vault, baseTest.pathExactAmountIn)).wait();
                    baseTest.pathsExactIn = [
                        {
                            tokenIn: baseTest.token0,
                            steps: [
            ...
            context('multi path, MIMO', () => {
                beforeEach(async () => {
                    ...
                    await (await typechain_types_1.ERC20TestToken__factory.connect(baseTest.token0, baseTest.sender).transfer(baseTest.vault, baseTest.pathExactAmountIn)).wait();
                    await (await typechain_types_1.ERC20TestToken__factory.connect(await baseTest.poolA.getAddress(), baseTest.sender).transfer(baseTest.vault, baseTest.pathExactAmountIn)).wait();
                    baseTest.pathsExactIn = [
                        {
                            tokenIn: baseTest.token0,
                            steps: [
            ...
            context('unwrap first, SISO', () => {
                beforeEach(async () => {
                    ...
                    await (await typechain_types_1.ERC20TestToken__factory.connect(baseTest.wToken0Address, baseTest.sender).transfer(baseTest.vault, baseTest.totalAmountIn)).wait();
                    baseTest.pathsExactIn = [
                        {
            ...
            context('unwrap first - wrap end, SISO', () => {
                beforeEach(async () => {
                    baseTest.tokensOut = [typechain_types_1.ERC20TestToken__factory.connect(baseTest.wToken2Address, baseTest.sender)];
                    baseTest.totalAmountIn = baseTest.pathExactAmountIn * 2n; // 2 baseTest.pathsExactIn
                    baseTest.totalAmountOut = baseTest.pathMinAmountOut * 2n; // 2 baseTest.pathsExactIn, 1:1 ratio between inputs and outputs
                    baseTest.pathAmountsOut = [baseTest.totalAmountOut / 2n, baseTest.totalAmountOut / 2n]; // 2 baseTest.pathsExactIn, half the output in each
                    ...
                    baseTest.balanceChange = [
                        ...
                        },
                        {
                            account: baseTest.vaultAddress,
                            changes: {
                                [await baseTest.tokens.get(2).symbol()]: ['very-near', -1n * (0, numbers_1.fpDivUp)(BatchSwapBase_1.WRAPPED_TOKEN_AMOUNT, (0, numbers_1.fp)(2))], // Rebalancing
                                [await baseTest.tokensOut[0].symbol()]: ['very-near', (0, numbers_1.fpDivDown)(BatchSwapBase_1.WRAPPED_TOKEN_AMOUNT, (0, numbers_1.fp)(2))], // Rebalancing
                            },
                        },
                        {
                            account: baseTest.wToken2Address,
                            changes: {
                                [await baseTest.tokens.get(2).symbol()]: ['very-near', (0, numbers_1.fpDivUp)(BatchSwapBase_1.WRAPPED_TOKEN_AMOUNT, (0, numbers_1.fp)(2))], // Rebalancing
                            },
                        },
                    ];
                    await (await typechain_types_1.ERC20TestToken__factory.connect(baseTest.wToken0Address, baseTest.sender).transfer(baseTest.vault, baseTest.totalAmountIn)).wait();
                    ...
                    baseTest.balanceChange = [
                        ...
                        },
                        {
                            ...
                            changes: {
                                ...
                                [await baseTest.tokens.get(0).symbol()]: ['very-near', -1n * (0, numbers_1.fpDivUp)(BatchSwapBase_1.WRAPPED_TOKEN_AMOUNT, (0, numbers_1.fp)(2))], // Rebalancing
                                [await baseTest.wToken0.symbol()]: ['very-near', (0, numbers_1.fpDivDown)(BatchSwapBase_1.WRAPPED_TOKEN_AMOUNT, (0, numbers_1.fp)(2))], // Rebalancing
                            },
                        },
                        {
                            account: baseTest.wToken0Address,
                            changes: {
                                [await baseTest.tokens.get(0).symbol()]: ['very-near', (0, numbers_1.fpDivUp)(BatchSwapBase_1.WRAPPED_TOKEN_AMOUNT, (0, numbers_1.fp)(2))], // Rebalancing
                            },
                        },
                    ];
                    await (await typechain_types_1.ERC20TestToken__factory.connect(baseTest.token0, baseTest.sender).transfer(baseTest.vault, baseTest.totalAmountIn)).wait();
    ...
    describe('batch swap given out', () => {
        ...
        context('pure swaps with no nesting', () => {
            it('should revert if the step.pool is tokenIn', async () => {
                (0, chai_1.expect)(baseTest.aggregatorRouter.connect(baseTest.sender).swapExactOut([
                    {
                        tokenIn: baseTest.token0,
                        steps: [{ pool: baseTest.token0, tokenOut: baseTest.token1, isBuffer: false }],
            ...
            context('single path', () => {
                beforeEach(async () => {
                    ...
                    await (await typechain_types_1.ERC20TestToken__factory.connect(baseTest.token0, baseTest.sender).transfer(baseTest.vault, baseTest.pathMaxAmountIn)).wait();
            ...
            context('multi path, SISO', () => {
                beforeEach(async () => {
                    ...
                    await (await typechain_types_1.ERC20TestToken__factory.connect(baseTest.token0, baseTest.sender).transfer(baseTest.vault, maxAmountIn)).wait();
                    baseTest.pathsExactOut = [
                        {
                            tokenIn: baseTest.token0,
                            steps: [
            ...
            context('multi path, MISO', () => {
                beforeEach(async () => {
                    ...
                    await (await typechain_types_1.ERC20TestToken__factory.connect(baseTest.token0, baseTest.sender).transfer(baseTest.vault, baseTest.pathMaxAmountIn)).wait();
                    await (await typechain_types_1.ERC20TestToken__factory.connect(baseTest.token1, baseTest.sender).transfer(baseTest.vault, baseTest.pathMaxAmountIn)).wait();
                    baseTest.pathsExactOut = [
                        {
                            tokenIn: baseTest.token0,
                            steps: [
            ...
            context('multi path, MIMO', () => {
                beforeEach(async () => {
                    ...
                    await (await typechain_types_1.ERC20TestToken__factory.connect(baseTest.token0, baseTest.sender).transfer(baseTest.vault, baseTest.pathMaxAmountIn)).wait();
                    await (await typechain_types_1.ERC20TestToken__factory.connect(await baseTest.poolA.getAddress(), baseTest.sender).transfer(baseTest.vault, baseTest.pathMaxAmountIn)).wait();
                    baseTest.pathsExactOut = [
                        {
                            tokenIn: baseTest.token0,
                            steps: [
            ...
            context('unwrap first, SISO', () => {
                beforeEach(async () => {
                    baseTest.tokensIn = [typechain_types_1.ERC20TestToken__factory.connect(baseTest.wToken0Address, baseTest.sender)];
                    baseTest.tokensOut = [baseTest.tokens.get(2)];
                    const totalAmountToReturn = expectedAmountToReturn * 2n; // 2 baseTest.pathsExactOut, 1:1 ratio between inputs and outputs
                    const maxAmountIn = baseTest.pathMaxAmountIn * 2n;
                    baseTest.totalAmountIn = expectedAmountIn * 2n; // 2 baseTest.pathsExactOut
                        ...
                        },
                        {
                            ...
                            changes: {
                                ...
                                [await baseTest.tokensOut[0].symbol()]: [
                                    'very-near',
                                    (0, numbers_1.fpDivDown)(BatchSwapBase_1.WRAPPED_TOKEN_AMOUNT, (0, numbers_1.fp)(2)) - baseTest.totalAmountOut,
                                ], // Rebalancing
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            changes: {
                                ...
                                [await baseTest.tokensIn[0].symbol()]: [
                                    'very-near',
                                    -1n * (0, numbers_1.fpDivDown)(BatchSwapBase_1.WRAPPED_TOKEN_AMOUNT, (0, numbers_1.fp)(2)) - totalAmountToReturn,
                                ], // Rebalancing
                                [await baseTest.wToken0.symbol()]: ['very-near', (0, numbers_1.fpDivUp)(BatchSwapBase_1.WRAPPED_TOKEN_AMOUNT, (0, numbers_1.fp)(2))], // Rebalancing
                            },
                        },
                        {
                            account: baseTest.wToken0Address,
            ...
            context('multi path, circular inputs/outputs', () => {
                beforeEach(async () => {
                    ...
                    await (await typechain_types_1.ERC20TestToken__factory.connect(baseTest.token0, baseTest.sender).transfer(baseTest.vault, baseTest.pathMaxAmountIn)).wait();
                    await (await typechain_types_1.ERC20TestToken__factory.connect(baseTest.token2, baseTest.sender).transfer(baseTest.vault, baseTest.pathMaxAmountIn)).wait();
                    baseTest.pathsExactOut = [
                        {
                            tokenIn: baseTest.token0,
                            steps: [
