...
contract LBPoolContractsDeployer is BaseContractsDeployer {
    ...
    constructor() {
        ...
        if (vm.exists("artifacts/@crane/contracts/external/balancer/v3/pool-weighted/")) {
            artifactsRootDir = "artifacts/@crane/contracts/external/balancer/v3/pool-weighted/";
        }
    }
