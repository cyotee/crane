...
contract ReadBenchmark {
    ...
    function readFromStateWithoutCallAssembly() external view returns (uint256 dataFeedValue) {
        assembly {
    ...
    function readUsingStaticCallAssemblyWithErrorHandling() external view returns (uint256) {
        uint256 value;
    ...
    function readUsingStaticCallAssemblyWithErrorHandlingWithImmutable() external view returns (uint256) {
        uint256 value;
