...
import {
    MultiFeedAdapterWithoutRoundsTransformingProxy
} from "../price-feeds/without-rounds/MultiFeedAdapterWithoutRoundsTransformingProxy.sol";
...
contract MultiFeedAdapterWithoutRoundsTransformingProxyMock is MultiFeedAdapterWithoutRoundsTransformingProxy {
    ...
    function _transformLastUpdateDetails(uint256 dataTs, uint256 blockTs, uint256 value)
        internal
        view
        virtual
        override
