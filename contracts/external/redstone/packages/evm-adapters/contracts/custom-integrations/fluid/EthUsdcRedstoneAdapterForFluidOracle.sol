...
abstract contract EthUsdcRedstoneAdapterForFluidOracle is IFluidOracle, PriceFeedsAdapterWithoutRounds {
    ...
    bytes32 private constant ETH_USDC_ID = bytes32("ETH/USDC");
