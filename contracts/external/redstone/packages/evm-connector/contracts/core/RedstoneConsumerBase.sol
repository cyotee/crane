    ...
    function _extractDataPackage(
        ...
        // We use scopes to resolve problem with too deep stack
        {
            ...
            uint256 signedMessageCalldataOffset =
                msg.data.length - (calldataNegativeOffset + SIG_BS + signedMessageBytesCount);
        ...
        // Updating helpful arrays
        {
            ...
            for (uint256 dataPointIndex = 0; dataPointIndex < dataPointsCount;) {
                ...
                (dataPointDataFeedId, dataPointValue) =
                    _extractDataPointValueAndDataFeedId(calldataNegativeOffset, eachDataPointValueByteSize);

                for (uint256 dataFeedIdIndex = 0; dataFeedIdIndex < dataFeedIds.length;) {
                    if (dataPointDataFeedId == dataFeedIds[dataFeedIdIndex]) {
                        ...
                        if (
                            ...
                            // Add new value
                            valuesForDataFeeds[dataFeedIdIndex][uniqueSignerCountForDataFeedIds[dataFeedIdIndex]] =
                            dataPointValue;
