...
abstract contract AuthorisedMockSignersBase is RedstoneConstants {
    function getAuthorisedMockSignerIndex(address signerAddress) public view virtual returns (uint8) {
        return getAllMockExceptLastOneAuthorised(signerAddress);
    }

    function getAllMockExceptLastOneAuthorised(address signerAddress) public view virtual returns (uint8) {
