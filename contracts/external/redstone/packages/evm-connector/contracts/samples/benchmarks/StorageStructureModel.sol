...
contract StorageStructureModel is RedstoneConsumerNumericMock {
    ...
    function sendRequestWith3Args(bytes32 arg1, bytes32 arg2, bytes32 arg3) public returns (uint256) {
        counter++;
        requestsWith3Args[counter] = RequestWith3Args(arg1, arg2, arg3, block.number, msg.sender);
        return counter;
    }

    function sendRequestWith5Args(bytes32 arg1, bytes32 arg2, bytes32 arg3, bytes32 arg4, bytes32 arg5)
        public
        returns (uint256)
    {
        counter++;
        requestsWith5Args[counter] = RequestWith5Args(arg1, arg2, arg3, arg4, arg5, block.number, msg.sender);
        return counter;
    }
