...
contract FixedPointMathLibTest is DSTestPlus {
    ...
    function test_RevertWhen_MulWadDownOverflow(uint256 x, uint256 y) public {
        // Ignore cases where x * y does not overflow.
        unchecked {
            if (y == 0 || x == 0 || (x * y) / x == y) return;
        }
    ...
    function test_RevertWhen_MulWadUpOverflow(uint256 x, uint256 y) public {
        // Ignore cases where x * y does not overflow.
        unchecked {
            if (y == 0 || x == 0 || (x * y) / x == y) return;
        }
    ...
    function test_RevertWhen_DivWadDownOverflow(uint256 x, uint256 y) public {
    ...
    function test_RevertWhen_DivWadDownZeroDenominator(uint256 x) public {
        vm.expectRevert();
    ...
    function test_RevertWhen_DivWadUpOverflow(uint256 x, uint256 y) public {
        // Ignore cases where x * WAD does not overflow or y is 0.
        unchecked {
            if (y == 0 || (x * 1e18) / 1e18 == x) return;
        }
    ...
    function test_RevertWhen_DivWadUpZeroDenominator(uint256 x) public {
        vm.expectRevert();
    ...
    function test_RevertWhen_MulDivDownOverflow(uint256 x, uint256 y, uint256 denominator) public {
    ...
    function test_RevertWhen_MulDivDownZeroDenominator(uint256 x, uint256 y) public {
        vm.expectRevert();
    ...
    function test_RevertWhen_MulDivUpOverflow(uint256 x, uint256 y, uint256 denominator) public {
        // Ignore cases where x * y does not overflow or denominator is 0.
        unchecked {
            if (denominator == 0 || x == 0 || (x * y) / x == y) return;
        }
    ...
    function test_RevertWhen_MulDivUpZeroDenominator(uint256 x, uint256 y) public {
        vm.expectRevert();
