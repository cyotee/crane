...
contract ERC1155Test is DSTestPlus, ERC1155TokenReceiver {
    ...
    function test_RevertMintToNonERC155Recipient() public {
        address to = address(new NonERC1155Recipient());
        vm.expectRevert();
        token.mint(to, 1337, 1, "");
    }

    function test_RevertMintToRevertingERC155Recipient() public {
        address to = address(new RevertingERC1155Recipient());
        vm.expectRevert();
        token.mint(to, 1337, 1, "");
    }

    function test_RevertMintToWrongReturnDataERC155Recipient() public {
    ...
    function test_RevertSafeTransferFromInsufficientBalance() public {
        address from = address(0xABCD);
    ...
    function test_RevertSafeTransferFromSelfInsufficientBalance() public {
        token.mint(address(this), 1337, 70, "");
        vm.expectRevert();
        token.safeTransferFrom(address(this), address(0xBEEF), 1337, 100, "");
    }

    function test_RevertSafeTransferFromToZero() public {
        token.mint(address(this), 1337, 100, "");
        vm.expectRevert();
        token.safeTransferFrom(address(this), address(0), 1337, 70, "");
    }

    function test_RevertSafeTransferFromToNonERC155Recipient() public {
        token.mint(address(this), 1337, 100, "");
        address to = address(new NonERC1155Recipient());
        vm.expectRevert();
    ...
    function test_RevertSafeTransferFromToRevertingERC1155Recipient() public {
        token.mint(address(this), 1337, 100, "");
        address to = address(new RevertingERC1155Recipient());
        vm.expectRevert();
        token.safeTransferFrom(address(this), to, 1337, 70, "");
    ...
    function test_RevertSafeTransferFromToWrongReturnDataERC1155Recipient() public {
        token.mint(address(this), 1337, 100, "");
        address to = address(new WrongReturnDataERC1155Recipient());
        vm.expectRevert();
        token.safeTransferFrom(address(this), to, 1337, 70, "");
    ...
    function test_RevertSafeBatchTransferInsufficientBalance() public {
        address from = address(0xABCD);
    ...
    function test_RevertSafeBatchTransferFromToZero() public {
        address from = address(0xABCD);
    ...
    function test_RevertSafeBatchTransferFromToNonERC1155Recipient() public {
        address from = address(0xABCD);
    ...
    function test_RevertSafeBatchTransferFromToRevertingERC1155Recipient() public {
        address from = address(0xABCD);
    ...
    function test_RevertSafeBatchTransferFromToWrongReturnDataERC1155Recipient() public {
        address from = address(0xABCD);
    ...
    function test_RevertSafeBatchTransferFromWithArrayLengthMismatch() public {
        address from = address(0xABCD);
    ...
    function test_RevertBatchMintToZero() public {
        uint256[] memory ids = new uint256[](5);
        ids[0] = 1337;
        ids[1] = 1338;
        ids[2] = 1339;
    ...
    function test_RevertBatchMintToNonERC1155Recipient() public {
    ...
    function test_RevertBatchMintToRevertingERC1155Recipient() public {
    ...
    function test_RevertBatchMintToWrongReturnDataERC1155Recipient() public {
    ...
    function test_RevertBatchMintWithArrayMismatch() public {
        uint256[] memory ids = new uint256[](5);
        ids[0] = 1337;
        ids[1] = 1338;
        ids[2] = 1339;
    ...
    function test_RevertBatchBurnInsufficientBalance() public {
        uint256[] memory ids = new uint256[](5);
        ids[0] = 1337;
        ids[1] = 1338;
        ids[2] = 1339;
    ...
    function test_RevertBatchBurnWithArrayLengthMismatch() public {
        uint256[] memory ids = new uint256[](5);
        ids[0] = 1337;
        ids[1] = 1338;
        ids[2] = 1339;
    ...
    function test_RevertBalanceOfBatchWithArrayMismatch() public {
        address[] memory tos = new address[](5);
        tos[0] = address(0xBEEF);
        tos[1] = address(0xCAFE);
        tos[2] = address(0xFACE);
    ...
    function test_RevertMintToZero(uint256 id, uint256 amount, bytes memory data) public {
        vm.expectRevert();
        token.mint(address(0), id, amount, data);
    }

    function test_RevertMintToNonERC155Recipient(uint256 id, uint256 mintAmount, bytes memory mintData) public {
    ...
    function test_RevertMintToRevertingERC155Recipient(uint256 id, uint256 mintAmount, bytes memory mintData) public {
        vm.assume(mintAmount > 0);
        address to = address(new RevertingERC1155Recipient());
        vm.expectRevert();
        token.mint(to, id, mintAmount, mintData);
    ...
    function test_RevertMintToWrongReturnDataERC155Recipient(uint256 id, uint256 mintAmount, bytes memory mintData)
        public
    {
        vm.assume(mintAmount > 0);
        address to = address(new WrongReturnDataERC1155Recipient());
    ...
    function test_RevertBurnInsufficientBalance(
        address to,
        uint256 id,
        uint256 mintAmount,
        uint256 burnAmount,
        ...
        if (to == address(0x7109709ECfa91a80626fF3989D68f67F5b1DD12D) || uint160(to) <= 18) {
            to = address(0xBEEF);
        }
    ...
    function test_RevertSafeTransferFromInsufficientBalance(
        address to,
        uint256 id,
        uint256 mintAmount,
        uint256 transferAmount,
        ...
        if (to == address(0x7109709ECfa91a80626fF3989D68f67F5b1DD12D) || uint160(to) <= 18) to = address(0xBEEF);
    ...
    function test_RevertSafeTransferFromSelfInsufficientBalance(
        address to,
        uint256 id,
        uint256 mintAmount,
        uint256 transferAmount,
    ...
    function test_RevertSafeTransferFromToZero(
        uint256 id,
        uint256 mintAmount,
        uint256 transferAmount,
        bytes memory mintData,
    ...
    function test_RevertSafeTransferFromToNonERC155Recipient(
        uint256 id,
        uint256 mintAmount,
        uint256 transferAmount,
        bytes memory mintData,
    ...
    function test_RevertSafeTransferFromToRevertingERC1155Recipient(
        uint256 id,
        uint256 mintAmount,
        uint256 transferAmount,
        bytes memory mintData,
    ...
    function test_RevertSafeTransferFromToWrongReturnDataERC1155Recipient(
        uint256 id,
        uint256 mintAmount,
        uint256 transferAmount,
        bytes memory mintData,
    ...
    function test_RevertSafeBatchTransferInsufficientBalance(
        address to,
        uint256[] memory ids,
        uint256[] memory mintAmounts,
        uint256[] memory transferAmounts,
        ...
        for (uint256 i = 0; i < minLength; i++) {
            ...
            uint256 mintedSoFar = userMintAmounts[from][id];
            uint256 remainingMintAmountForId = mintedSoFar >= type(uint256).max ? 0 : type(uint256).max - mintedSoFar;
    ...
    function test_RevertSafeBatchTransferFromToZero(
        uint256[] memory ids,
        uint256[] memory mintAmounts,
        uint256[] memory transferAmounts,
        bytes memory mintData,
    ...
    function test_RevertSafeBatchTransferFromToNonERC1155Recipient(
        uint256[] memory ids,
        uint256[] memory mintAmounts,
        uint256[] memory transferAmounts,
        bytes memory mintData,
    ...
    function test_RevertSafeBatchTransferFromToRevertingERC1155Recipient(
        uint256[] memory ids,
        uint256[] memory mintAmounts,
        uint256[] memory transferAmounts,
        bytes memory mintData,
    ...
    function test_RevertSafeBatchTransferFromToWrongReturnDataERC1155Recipient(
        uint256[] memory ids,
        uint256[] memory mintAmounts,
        uint256[] memory transferAmounts,
        bytes memory mintData,
    ...
    function test_RevertSafeBatchTransferFromWithArrayLengthMismatch(
        address to,
        uint256[] memory ids,
        uint256[] memory mintAmounts,
        uint256[] memory transferAmounts,
        ...
        // Construct equal-length id/amount arrays for the setup mint, then require the
        // transfer amounts array to have a *different* length so the transfer reverts
        // with LENGTH_MISMATCH. Building the equal length (rather than assuming two
        // independently fuzzed arrays happen to match) keeps vm.assume from exhausting
        // its rejection budget.
        uint256 minLength = min2(ids.length, mintAmounts.length);
        vm.assume(minLength != 0);
        vm.assume(transferAmounts.length != minLength);

        uint256[] memory normalizedIds = new uint256[](minLength);
        uint256[] memory normalizedMintAmounts = new uint256[](minLength);

        // Bound minted amounts per id so duplicate ids in the fuzzed array cannot
        // overflow the sender balance during setup; the transfer must be what reverts.
        for (uint256 i = 0; i < minLength; i++) {
            uint256 id = ids[i];
            uint256 remainingMintAmountForId = type(uint256).max - userMintAmounts[from][id];
            normalizedIds[i] = id;
            normalizedMintAmounts[i] = bound(mintAmounts[i], 0, remainingMintAmountForId);
            userMintAmounts[from][id] += normalizedMintAmounts[i];
        }
        ...
        vm.expectRevert();
        token.safeBatchTransferFrom(from, to, normalizedIds, transferAmounts, transferData);
    }

    function test_RevertBatchMintToZero(uint256[] memory ids, uint256[] memory amounts, bytes memory mintData) public {
        uint256 minLength = min2(ids.length, amounts.length);
    ...
    function test_RevertBatchMintToNonERC1155Recipient(
        uint256[] memory ids,
        uint256[] memory amounts,
        bytes memory mintData
    ) public {
    ...
    function test_RevertBatchMintToRevertingERC1155Recipient(
        uint256[] memory ids,
        uint256[] memory amounts,
        bytes memory mintData
    ) public {
    ...
    function test_RevertBatchMintToWrongReturnDataERC1155Recipient(
        uint256[] memory ids,
        uint256[] memory amounts,
        bytes memory mintData
    ) public {
    ...
    function test_RevertBatchMintWithArrayMismatch(
        address to,
        uint256[] memory ids,
        uint256[] memory amounts,
        bytes memory mintData
    ...
    function test_RevertBatchBurnInsufficientBalance(
        address to,
        uint256[] memory ids,
        uint256[] memory mintAmounts,
        uint256[] memory burnAmounts,
        ...
        // Skip precompiles, the VM cheatcode address, and any contract: minting
        // routes through the ERC1155 receiver hook, which reverts (or is mis-routed
        // as a cheatcode) for non-receiver `to`, aborting setup before the burn.
        if (uint256(uint160(to)) <= 18 || to.code.length > 0) return;
        ...
        for (uint256 i = 0; i < minLength; i++) {
            ...
            uint256 mintedSoFar = userMintAmounts[to][id];
            uint256 remainingMintAmountForId = mintedSoFar >= type(uint256).max ? 0 : type(uint256).max - mintedSoFar;

            normalizedIds[i] = id;
            normalizedMintAmounts[i] = bound(mintAmounts[i], 0, remainingMintAmountForId);
            vm.assume(normalizedMintAmounts[i] < type(uint256).max);
    ...
    function test_RevertBatchBurnWithArrayLengthMismatch(
        address to,
        uint256[] memory ids,
        uint256[] memory mintAmounts,
        uint256[] memory burnAmounts,
        ...
        // Construct equal-length id/amount arrays for the setup mint, then require the
        // burn amounts array to have a *different* length so the burn reverts with
        // LENGTH_MISMATCH. Building the equal length (rather than assuming two
        // independently fuzzed arrays happen to match) keeps vm.assume from exhausting
        // its rejection budget.
        uint256 minLength = min2(ids.length, mintAmounts.length);
        vm.assume(minLength != 0);
        vm.assume(burnAmounts.length != minLength);

        uint256[] memory normalizedIds = new uint256[](minLength);
        uint256[] memory normalizedMintAmounts = new uint256[](minLength);

        // Bound minted amounts per id so duplicate ids in the fuzzed array cannot
        // overflow the recipient balance during setup; the burn must be what reverts.
        for (uint256 i = 0; i < minLength; i++) {
            uint256 id = ids[i];
            uint256 remainingMintAmountForId = type(uint256).max - userMintAmounts[to][id];
            normalizedIds[i] = id;
        ...
        vm.expectRevert();
        token.batchBurn(to, normalizedIds, burnAmounts);
    }

    function test_RevertBalanceOfBatchWithArrayMismatch(address[] memory tos, uint256[] memory ids) public {
