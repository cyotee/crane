...
contract ERC6909Test is DSTestPlus {
    ...
    function test_RevertWhen_MintBalanceOverflow() public {
        token.mint(address(0xDEAD), 1337, type(uint256).max);
        vm.expectRevert();
        token.mint(address(0xDEAD), 1337, 1);
    }

    function test_RevertWhen_TransferBalanceUnderflow() public {
        address sender = address(0xABCD);
        address receiver = address(0xBEEF);
    ...
    function test_RevertWhen_TransferBalanceOverflow() public {
        address sender = address(0xABCD);
        address receiver = address(0xBEEF);
    ...
    function test_RevertWhen_TransferFromBalanceUnderflow() public {
        address sender = address(0xABCD);
        address receiver = address(0xBEEF);
    ...
    function test_RevertWhen_TransferFromBalanceOverflow() public {
        address sender = address(0xABCD);
        address receiver = address(0xBEEF);
    ...
    function test_RevertWhen_TransferFromNotAuthorized() public {
        address sender = address(0xABCD);
        address receiver = address(0xBEEF);
    ...
    function test_RevertWhen_TransferBalanceUnderflow(address sender, address receiver, uint256 id, uint256 amount)
        public
    {
    ...
    function test_RevertWhen_TransferBalanceOverflow(address sender, address receiver, uint256 id, uint256 amount)
        public
    {
        amount = bound(amount, 1, type(uint256).max);
    ...
    function test_RevertWhen_TransferFromBalanceUnderflow(address sender, address receiver, uint256 id, uint256 amount)
        public
    {
        amount = bound(amount, 1, type(uint256).max);
    ...
    function test_RevertWhen_TransferFromBalanceOverflow(address sender, address receiver, uint256 id, uint256 amount)
        public
    {
        amount = bound(amount, 1, type(uint256).max);
        uint256 overflowAmount = type(uint256).max - amount + 1;
    ...
    function test_RevertWhen_TransferFromNotAuthorized(address sender, address receiver, uint256 id, uint256 amount)
        public
    {
        amount = bound(amount, 1, type(uint256).max);
