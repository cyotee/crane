...
interface IBalancerV3ConstantProductPoolStandardVaultPkg {
    ...
    function deployPool(TokenConfig[] calldata tokenConfigs, address hooksContract) external returns (address vault);
}

contract BalancerV3ConstantProductPoolDFPkg is
    BalancerV3BasePoolFactory,
    ...
    IBalancerV3ConstantProductPoolStandardVaultPkg
{
    ...
    function packageName() public pure returns (string memory name_) {
        return type(BalancerV3ConstantProductPoolDFPkg).name;
    }
    ...
    function facetAddresses() public view returns (address[] memory facetAddresses_) {
        ...
        facetAddresses_[4] = address(BALANCER_V3_CONST_PROD_POOL_FACET);
    }
