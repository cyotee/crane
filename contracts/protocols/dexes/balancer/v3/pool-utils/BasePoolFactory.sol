    ...
    FactoryWidePauseWindow
{
    ...
    function _registerPoolWithVault(
        ...
        console.log("BasePoolFactory._registerPoolWithVault called with:");
        console.log(" - pool: %s", pool);
        console.log(" - tokens length: %d", tokens.length);
        console.log(" - swapFeePercentage: %d", swapFeePercentage);
        console.log(" - protocolFeeExempt: %s", protocolFeeExempt);
        console.log(" - roleAccounts.pauseManager: %s", roleAccounts.pauseManager);
        console.log(" - roleAccounts.swapFeeManager: %s", roleAccounts.swapFeeManager);
        console.log(" - roleAccounts.poolCreator: %s", roleAccounts.poolCreator);
        console.log(" - poolHooksContract: %s", poolHooksContract);
        console.log(" - liquidityManagement.disableUnbalancedLiquidity: %s", liquidityManagement.disableUnbalancedLiquidity);
        console.log(" - liquidityManagement.enableAddLiquidityCustom: %s", liquidityManagement.enableAddLiquidityCustom);
        console.log(" - liquidityManagement.enableRemoveLiquidityCustom: %s", liquidityManagement.enableRemoveLiquidityCustom);
        console.log(" - liquidityManagement.enableDonation: %s", liquidityManagement.enableDonation);
        console.log("Calling vault.registerPool...");
        ...
        console.log("vault.registerPool call complete");
    }
