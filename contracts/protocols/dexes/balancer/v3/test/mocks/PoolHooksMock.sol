...
contract PoolHooksMock is BaseHooks, VaultGuard {
    ...
    ***********************************************************/
    ...
    function setSwapReentrancyHookActive(bool swapReentrancyHookActive_) external {
        swapReentrancyHookActive = swapReentrancyHookActive_;
    }
    ...
    function setAddLiquidityHookFeePercentage(uint256 hookFeePercentage_) public {
        addLiquidityHookFeePercentage = hookFeePercentage_;
    }
    ...
    function setRemoveLiquidityHookFeePercentage(uint256 hookFeePercentage_) public {
        removeLiquidityHookFeePercentage = hookFeePercentage_;
    }
