...
///      - Added stakedLiquidityNet for gauge staking
///      - Added rewardGrowthOutsideX128 for reward tracking
///      - Added updateStake() for staking operations
///      - Added getRewardGrowthInside() for reward calculations
///      - Modified cross() to return LiquidityNets struct
library Tick {
    ...
    /// @notice Return value from cross() containing both liquidity nets
    ...
    /// @notice Retrieves reward growth data inside a tick range
    /// @param self The mapping containing all tick information for initialized ticks
    /// @param tickLower The lower tick boundary of the position
    /// @param tickUpper The upper tick boundary of the position
    /// @param tickCurrent The current tick
    ...
    function updateStake(
        ...
        unchecked {
            info.stakedLiquidityNet = upper
                ? int128(int256(info.stakedLiquidityNet) - stakedLiquidityDelta)
                : int128(int256(info.stakedLiquidityNet) + stakedLiquidityDelta);
        }
    }
