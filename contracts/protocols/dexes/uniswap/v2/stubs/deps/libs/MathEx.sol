...
library MathEx {
     ...
     */
    function weightedAverage(Fraction memory fraction1, Fraction memory fraction2, uint256 weight1, uint256 weight2)
        internal
        pure
     ...
     */
    function isInRange(Fraction memory baseSample, Fraction memory offsetSample, uint32 maxDeviationPPM)
        internal
        pure
        returns (bool)
    {
    ...
    function sub256(Uint512 memory x, uint256 y) internal pure returns (Uint512 memory) {
        return _sub512(x, y);
    }

    function sub512(Uint512 memory x, Uint512 memory y) internal pure returns (Uint512 memory ret) {
        unchecked {
            ret.lo = x.lo - y.lo;
    ...
    function add512(Uint512 memory x, Uint512 memory y) internal pure returns (Uint512 memory ret) {
        unchecked {
            ret.lo = x.lo + y.lo;
    ...
    function mul512x256(Uint512 memory a, uint256 b) public pure returns (Uint512 memory result) {
        uint256 a0 = a.hi;
        uint256 a1 = a.lo;
        uint256 r0;
        uint256 r1;
