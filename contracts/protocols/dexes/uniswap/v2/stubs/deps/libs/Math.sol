...
import "@crane/contracts/protocols/dexes/uniswap/v2/stubs/deps/libs/Conversion.sol";
import "@crane/contracts/protocols/dexes/uniswap/v2/stubs/deps/libs/FixedPointWadMathLib.sol";
import "@crane/contracts/protocols/dexes/uniswap/v2/stubs/deps/libs/Fraction.sol";
import {MathEx} from "@crane/contracts/protocols/dexes/uniswap/v2/stubs/deps/libs/MathEx.sol";
import "@crane/contracts/protocols/dexes/uniswap/v2/stubs/deps/libs/UQ112x112.sol";
import "@crane/contracts/protocols/dexes/uniswap/v2/stubs/deps/libs/WadRayMath.sol";
...
library Math {
    ...
    function _sqrtFast(uint256 x) internal pure returns (uint256 z) {
        assembly {
     ...
     */
    function _sqrrt(uint256 a) internal pure returns (uint256 c) {
        c = _sqrt(a);
    }

    function _sqrt(uint256 a) internal pure returns (uint256 c) {
        if (a > 3) {
            c = a;
            uint256 b = ((a / 2) + 1);
            while (b < c) {
     ...
     */
    function _percentageAmount(uint256 total_, uint256 percentage_) internal pure returns (uint256 percentAmount_) {
     ...
     */
    function _substractPercentage(uint256 total_, uint8 percentageToSub_) internal pure returns (uint256 result_) {
        return (total_ - ((total_ * percentageToSub_) / 1000));
    }

    function _percentageOfTotal(uint256 part_, uint256 total_) internal pure returns (uint256 percent_) {
        return ((part_ * 100) / total_);
    }

    function _quadraticPricing(uint256 payment_, uint256 multiplier_) internal pure returns (uint256) {
