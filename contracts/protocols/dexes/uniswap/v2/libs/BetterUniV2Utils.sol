...
library BetterUniV2Utils {
    ...
    function _calcLpSettlement(
        ...
        {
            Lp1 = (b * a2);
            Lp2 = (a2 * BetterMath._sqrt((b * b) - (BetterMath._mul512(a1, (c * 4))._div256(a2))));
            Lp3 = (a1 * 2);
        }
