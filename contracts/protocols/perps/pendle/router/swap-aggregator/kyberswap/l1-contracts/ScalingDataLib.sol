...
library ScalingDataLib {
    ...
    function newUniV3ProMM(bytes memory data, uint256 oldAmount, uint256 newAmount)
        internal
        pure
        returns (bytes memory)
    {
    ...
    function newMaticMigrate(bytes memory data, uint256 oldAmount, uint256 newAmount)
        internal
        pure
        returns (bytes memory)
    {
    ...
    function newEtherFieETH(bytes memory data, uint256 oldAmount, uint256 newAmount)
        internal
        pure
        returns (bytes memory)
    {
    ...
    function newEtherFiWeETH(bytes memory data, uint256 oldAmount, uint256 newAmount)
        internal
        pure
        returns (bytes memory)
    {
    ...
    function newEthenaSusde(bytes memory data, uint256 oldAmount, uint256 newAmount)
        internal
        pure
        returns (bytes memory)
    {
    ...
    function newRocketPool(bytes memory data, uint256 oldAmount, uint256 newAmount)
        internal
        pure
        returns (bytes memory)
    {
    ...
    function newMakersDAI(bytes memory data, uint256 oldAmount, uint256 newAmount)
        internal
        pure
        returns (bytes memory)
    {
    ...
    function newSfrxETHConvertor(bytes memory data, uint256 oldAmount, uint256 newAmount)
        internal
        pure
        returns (bytes memory)
    {
    ...
    function newOriginETH(bytes memory data, uint256 oldAmount, uint256 newAmount)
        internal
        pure
        returns (bytes memory)
    {
    ...
    function newMantleUsd(bytes memory data, uint256 oldAmount, uint256 newAmount)
        internal
        pure
        returns (bytes memory)
    {
