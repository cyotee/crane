...
contract ActionAddRemoveLiqV3 is IPActionAddRemoveLiqV3, ActionBase {
    ...
    function addLiquiditySinglePt(
        ...
        (netPtLeft, netSyReceived, netSyFeeMarket) = _swapPtToSyForAddLiquidity(
            market,
            YT,
            netPtLeft,
            netSyReceived,
    ...
    function _swapPtToSyForAddLiquidity(
        ...
        uint256 netPtSwapMarket = _approxSwapPtToAddLiquidity(
            market,
            pyIndex,
            netPtLeft,
            netSyReceived,
    ...
    function _approxSwapPtToAddLiquidity(
        ...
        (netPtSwapMarket, , ) = _readMarket(market).approxSwapPtToAddLiquidity(
            pyIndex,
            netPtLeft,
            netSyReceived,
            block.timestamp,
    ...
    function _addLiquiditySingleSy(
        ...
        uint256 netSyFeeMarket;
        (netSyLeft, netPtReceived, netSyFeeMarket) = _swapSyToPtForAddLiquidity(
            market,
            YT,
            netSyLeft,
            netPtReceived,
    ...
    function _swapSyToPtForAddLiquidity(
        ...
        PYIndex pyIndex = YT.newIndex();
        uint256 netPtOutMarket = _approxSwapSyToAddLiquidity(
            market,
            pyIndex,
            netSyLeft,
            netPtReceived,
    ...
    function _approxSwapSyToAddLiquidity(
        ...
        (netPtOutMarket, , ) = _readMarket(market).approxSwapSyToAddLiquidity(
            pyIndex,
            netSyLeft,
            netPtReceived,
            block.timestamp,
