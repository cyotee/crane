...
import {
    AaveV4TokenizationSpokeDeployProcedure
} from "@crane/contracts/protocols/lending/aave/v4/deployments/procedures/deploy/spoke/AaveV4TokenizationSpokeDeployProcedure.sol";
...
contract AaveV4TokenizationSpokeBatch is AaveV4TokenizationSpokeDeployProcedure {
    ...
    constructor(
        ...
        (address tokenizationSpokeProxy, address tokenizationSpokeImplementation) = _deployUpgradeableTokenizationSpokeInstance({
            hub: hub_,
