...
library AaveV4AccessManagerRolesProcedure {
    ...
    function labelAllRoles(address accessManager) internal {
        ...
        am.labelRole(Roles.SPOKE_CONFIGURATOR_DOMAIN_ADMIN_ROLE, "SPOKE_CONFIGURATOR_DOMAIN_ADMIN_ROLE");
    }
    ...
    function replaceDefaultAdminRole(address accessManager, address adminToAdd, address adminToRemove) internal {
    ...
    function grantAccessManagerAdminRole(address accessManager, address adminToAdd) internal {
        ...
        IAccessManager(accessManager)
            .grantRole({roleId: Roles.ACCESS_MANAGER_ADMIN_ROLE, account: adminToAdd, executionDelay: 0});
    }
    ...
    function revokeAccessManagerAdminRole(address accessManager, address adminToRemove) internal {
        ...
        IAccessManager(accessManager).revokeRole({roleId: Roles.ACCESS_MANAGER_ADMIN_ROLE, account: adminToRemove});
    }
}
