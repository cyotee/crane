...
contract AaveV4SpokeDeployProcedure is AaveV4DeployProcedureBase {
    ...
    function _deployUpgradeableSpokeInstance(
        ...
        spokeImplementation = Create2Utils.create2Deploy({
            salt: salt, bytecode: _getSpokeInstanceInitCode(spokeBytecode, oracle, maxUserReservesLimit)
        });
    ...
    function _getSpokeInstanceInitCode(bytes memory spokeBytecode, address oracle, uint16 maxUserReservesLimit)
        internal
        pure
