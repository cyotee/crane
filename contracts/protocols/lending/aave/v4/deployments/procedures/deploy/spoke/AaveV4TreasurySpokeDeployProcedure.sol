...
contract AaveV4TreasurySpokeDeployProcedure is AaveV4DeployProcedureBase {
    ...
    function _deployTreasurySpoke(address owner, bytes32 salt) internal returns (address) {
        ...
        address implementation = Create2Utils.create2Deploy(salt, type(TreasurySpokeInstance).creationCode);
        return
            Create2Utils.proxify(salt, implementation, owner, abi.encodeCall(TreasurySpokeInstance.initialize, (owner)));
    }
}
