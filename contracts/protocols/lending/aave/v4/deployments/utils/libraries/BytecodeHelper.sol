...
library BytecodeHelper {
  ...
  function getHubBytecode() internal view returns (bytes memory) {
    return vm.getCode('contracts/protocols/lending/aave/v4/hub/instances/HubInstance.sol:HubInstance');
  }
  ...
  function getSpokeBytecode() internal view returns (bytes memory) {
    return vm.getCode('contracts/protocols/lending/aave/v4/spoke/instances/SpokeInstance.sol:SpokeInstance');
  }
}
