...
library SpokeUtils {
    ...
    /// @return The reserve.
    function get(mapping(uint256 reserveId => ISpoke.Reserve) storage reserves, uint256 reserveId)
        internal
        view
        returns (ISpoke.Reserve storage)
    {
    ...
    function toValue(uint256 amount, uint256 decimals, uint256 price) internal pure returns (uint256) {
