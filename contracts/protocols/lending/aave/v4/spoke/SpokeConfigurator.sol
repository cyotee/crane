...
import {AccessManaged} from "@crane/contracts/external/openzeppelin-contracts/access/manager/AccessManaged.sol";
...
contract SpokeConfigurator is AccessManaged, ISpokeConfigurator {
    ...
    function updateReservePriceSource(address spoke, uint256 reserveId, address priceSource) external restricted {
        ISpoke(spoke).updateReservePriceSource(reserveId, priceSource);
    }

    /// @inheritdoc ISpokeConfigurator
    function updateLiquidationTargetHealthFactor(address spoke, uint256 targetHealthFactor) external restricted {
    ...
    /// @inheritdoc ISpokeConfigurator
    function updateHealthFactorForMaxBonus(address spoke, uint256 healthFactorForMaxBonus) external restricted {
        ISpoke targetSpoke = ISpoke(spoke);
        ISpoke.LiquidationConfig memory liquidationConfig = targetSpoke.getLiquidationConfig();
    ...
    /// @inheritdoc ISpokeConfigurator
    function updateLiquidationBonusFactor(address spoke, uint256 liquidationBonusFactor) external restricted {
        ISpoke targetSpoke = ISpoke(spoke);
        ISpoke.LiquidationConfig memory liquidationConfig = targetSpoke.getLiquidationConfig();
    ...
    /// @inheritdoc ISpokeConfigurator
    function updateLiquidationConfig(address spoke, ISpoke.LiquidationConfig calldata liquidationConfig)
        external
        restricted
    {
    ...
    /// @inheritdoc ISpokeConfigurator
    function updateReceiveSharesEnabled(address spoke, uint256 reserveId, bool receiveSharesEnabled)
        external
        restricted
    {
        ISpoke targetSpoke = ISpoke(spoke);
    ...
    /// @inheritdoc ISpokeConfigurator
    function updateCollateralRisk(address spoke, uint256 reserveId, uint256 collateralRisk) external restricted {
        ISpoke targetSpoke = ISpoke(spoke);
        ISpoke.ReserveConfig memory reserveConfig = targetSpoke.getReserveConfig(reserveId);
    ...
    /// @inheritdoc ISpokeConfigurator
    function addCollateralFactor(address spoke, uint256 reserveId, uint16 collateralFactor)
        external
        restricted
        returns (uint32)
    {
        ...
        ISpoke.DynamicReserveConfig memory dynamicReserveConfig =
            targetSpoke.getDynamicReserveConfig(reserveId, _getReserveLastDynamicConfigKey(spoke, reserveId));
    ...
    /// @inheritdoc ISpokeConfigurator
    function updateCollateralFactor(address spoke, uint256 reserveId, uint32 dynamicConfigKey, uint16 collateralFactor)
        external
        restricted
    {
        ISpoke targetSpoke = ISpoke(spoke);
        ISpoke.DynamicReserveConfig memory dynamicReserveConfig =
            targetSpoke.getDynamicReserveConfig(reserveId, dynamicConfigKey);
        dynamicReserveConfig.collateralFactor = collateralFactor;
        targetSpoke.updateDynamicReserveConfig(reserveId, dynamicConfigKey, dynamicReserveConfig);
    }

    /// @inheritdoc ISpokeConfigurator
    function addMaxLiquidationBonus(address spoke, uint256 reserveId, uint256 maxLiquidationBonus)
        external
        restricted
        returns (uint32)
    {
    ...
    /// @inheritdoc ISpokeConfigurator
    function addLiquidationFee(address spoke, uint256 reserveId, uint256 liquidationFee)
        external
        restricted
        returns (uint32)
    {
    ...
    /// @inheritdoc ISpokeConfigurator
    function updateLiquidationFee(address spoke, uint256 reserveId, uint32 dynamicConfigKey, uint256 liquidationFee)
        external
        restricted
    {
        ISpoke targetSpoke = ISpoke(spoke);
    ...
    /// @inheritdoc ISpokeConfigurator
    function updatePositionManager(address spoke, address positionManager, bool active) external restricted {
    ...
    function _getReserveLastDynamicConfigKey(address spoke, uint256 reserveId) internal view returns (uint32) {
