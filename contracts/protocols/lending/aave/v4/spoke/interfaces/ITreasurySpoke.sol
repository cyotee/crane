...
interface ITreasurySpoke {
    ...
    function supply(address hub, address underlying, uint256 amount) external returns (uint256, uint256);
    ...
    /// @return The amount of shares supplied.
    /// @return The amount of assets supplied.
    function supplySkimmed(address hub, address underlying, uint256 amount) external returns (uint256, uint256);
