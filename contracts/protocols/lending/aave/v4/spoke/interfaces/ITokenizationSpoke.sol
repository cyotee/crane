...
import {IERC2612, IERC20Permit} from "@crane/contracts/external/openzeppelin-contracts/interfaces/IERC2612.sol";
...
interface ITokenizationSpoke is IERC4626, IERC2612, IIntentConsumer {
    ...
    function DOMAIN_SEPARATOR() external view override(IERC20Permit, IIntentConsumer) returns (bytes32);
}
