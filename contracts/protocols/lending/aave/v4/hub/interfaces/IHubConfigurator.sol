...
interface IHubConfigurator {
    ...
    /// @param liquidityFee The new liquidity fee.
    /// @param feeReceiver The new fee receiver.
    function updateFeeConfig(address hub, uint256 assetId, uint256 liquidityFee, address feeReceiver) external;
    ...
    function updateReinvestmentController(address hub, uint256 assetId, address reinvestmentController) external;
    ...
    function addSpoke(address hub, address spoke, uint256 assetId, IHub.SpokeConfig calldata config) external;
    ...
    /// @param addCap The new add cap.
    /// @param drawCap The new draw cap.
    function updateSpokeCaps(address hub, uint256 assetId, address spoke, uint256 addCap, uint256 drawCap) external;
