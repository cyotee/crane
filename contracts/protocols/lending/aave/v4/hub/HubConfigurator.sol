...
contract HubConfigurator is AccessManaged, IHubConfigurator {
    ...
    function addAsset(
        ...
        uint256 assetId =
            targetHub.addAsset(underlying, IERC20Metadata(underlying).decimals(), feeReceiver, irStrategy, irData);
    ...
    /// @inheritdoc IHubConfigurator
    function updateLiquidityFee(address hub, uint256 assetId, uint256 liquidityFee) external restricted {
        _updateLiquidityFee(IHub(hub), assetId, liquidityFee);
    }

    /// @inheritdoc IHubConfigurator
    function updateFeeReceiver(address hub, uint256 assetId, address feeReceiver) external restricted {
        IHub targetHub = IHub(hub);
    ...
    /// @inheritdoc IHubConfigurator
    function updateFeeConfig(address hub, uint256 assetId, uint256 liquidityFee, address feeReceiver)
        external
        restricted
    {
        IHub targetHub = IHub(hub);
    ...
    /// @inheritdoc IHubConfigurator
    function updateInterestRateStrategy(address hub, uint256 assetId, address irStrategy, bytes calldata irData)
        external
        restricted
    {
        IHub targetHub = IHub(hub);
    ...
    /// @inheritdoc IHubConfigurator
    function updateReinvestmentController(address hub, uint256 assetId, address reinvestmentController)
        external
        restricted
    {
        IHub targetHub = IHub(hub);
    ...
    /// @inheritdoc IHubConfigurator
    function addSpoke(address hub, address spoke, uint256 assetId, IHub.SpokeConfig calldata config)
        external
        restricted
    {
    ...
    /// @inheritdoc IHubConfigurator
    function updateSpokeActive(address hub, uint256 assetId, address spoke, bool active) external restricted {
        IHub targetHub = IHub(hub);
        IHub.SpokeConfig memory config = targetHub.getSpokeConfig(assetId, spoke);
    ...
    /// @inheritdoc IHubConfigurator
    function updateSpokeHalted(address hub, uint256 assetId, address spoke, bool halted) external restricted {
        IHub targetHub = IHub(hub);
        IHub.SpokeConfig memory config = targetHub.getSpokeConfig(assetId, spoke);
    ...
    /// @inheritdoc IHubConfigurator
    function updateSpokeAddCap(address hub, uint256 assetId, address spoke, uint256 addCap) external restricted {
        IHub targetHub = IHub(hub);
        IHub.SpokeConfig memory config = targetHub.getSpokeConfig(assetId, spoke);
    ...
    /// @inheritdoc IHubConfigurator
    function updateSpokeDrawCap(address hub, uint256 assetId, address spoke, uint256 drawCap) external restricted {
        IHub targetHub = IHub(hub);
        IHub.SpokeConfig memory config = targetHub.getSpokeConfig(assetId, spoke);
    ...
    /// @inheritdoc IHubConfigurator
    function updateSpokeRiskPremiumThreshold(address hub, uint256 assetId, address spoke, uint256 riskPremiumThreshold)
        external
        restricted
    {
        IHub targetHub = IHub(hub);
    ...
    /// @inheritdoc IHubConfigurator
    function updateSpokeCaps(address hub, uint256 assetId, address spoke, uint256 addCap, uint256 drawCap)
        external
        restricted
    {
    ...
    function _updateSpokeCaps(IHub hub, uint256 assetId, address spoke, uint256 addCap, uint256 drawCap) internal {
