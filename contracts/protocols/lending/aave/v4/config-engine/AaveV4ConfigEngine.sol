...
contract AaveV4ConfigEngine is IAaveV4ConfigEngine {
    ...
    /// @inheritdoc IAaveV4ConfigEngine
    function executeSpokeLiquidationConfigUpdates(LiquidationConfigUpdate[] calldata updates) external {
        SpokeEngine.executeSpokeLiquidationConfigUpdates(updates);
    }

    /// @inheritdoc IAaveV4ConfigEngine
    function executeSpokeDynamicReserveConfigAdditions(DynamicReserveConfigAddition[] calldata additions) external {
        SpokeEngine.executeSpokeDynamicReserveConfigAdditions(additions);
    }

    /// @inheritdoc IAaveV4ConfigEngine
    function executeSpokeDynamicReserveConfigUpdates(DynamicReserveConfigUpdate[] calldata updates) external {
    ...
    /// @inheritdoc IAaveV4ConfigEngine
    function executePositionManagerSpokeRegistrations(SpokeRegistration[] calldata registrations) external {
        PositionManagerEngine.executePositionManagerSpokeRegistrations(registrations);
    }

    /// @inheritdoc IAaveV4ConfigEngine
    function executePositionManagerRoleRenouncements(PositionManagerRoleRenouncement[] calldata renouncements)
        external
    {
