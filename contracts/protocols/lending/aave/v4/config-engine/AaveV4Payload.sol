...
abstract contract AaveV4Payload {
    ...
    function hubAssetListings() public view virtual returns (IAaveV4ConfigEngine.AssetListing[] memory) {
    ...
    function hubAssetConfigUpdates() public view virtual returns (IAaveV4ConfigEngine.AssetConfigUpdate[] memory) {
    ...
    function hubSpokeConfigUpdates() public view virtual returns (IAaveV4ConfigEngine.SpokeConfigUpdate[] memory) {
    ...
    function hubAssetDeactivations() public view virtual returns (IAaveV4ConfigEngine.AssetDeactivation[] memory) {
    ...
    function hubAssetCapsResets() public view virtual returns (IAaveV4ConfigEngine.AssetCapsReset[] memory) {
    ...
    function hubSpokeDeactivations() public view virtual returns (IAaveV4ConfigEngine.SpokeDeactivation[] memory) {
    ...
    function hubSpokeCapsResets() public view virtual returns (IAaveV4ConfigEngine.SpokeCapsReset[] memory) {
    ...
    function spokeReserveListings() public view virtual returns (IAaveV4ConfigEngine.ReserveListing[] memory) {
    ...
    function accessManagerRoleMemberships() public view virtual returns (IAaveV4ConfigEngine.RoleMembership[] memory) {
    ...
    function accessManagerRoleUpdates() public view virtual returns (IAaveV4ConfigEngine.RoleUpdate[] memory) {
    ...
    function _executeHubActions() internal {
        ...
        if (assetConfigUpdates.length > 0) {
            _delegateCallEngine(abi.encodeCall(IAaveV4ConfigEngine.executeHubAssetConfigUpdates, (assetConfigUpdates)));
        }

        IAaveV4ConfigEngine.SpokeToAssetsAddition[] memory spokeToAssetsAdds = hubSpokeToAssetsAdditions();
        ...
        if (spokeConfigUpdates.length > 0) {
            _delegateCallEngine(abi.encodeCall(IAaveV4ConfigEngine.executeHubSpokeConfigUpdates, (spokeConfigUpdates)));
        }
        ...
        if (assetDeactivations.length > 0) {
            _delegateCallEngine(abi.encodeCall(IAaveV4ConfigEngine.executeHubAssetDeactivations, (assetDeactivations)));
        }

        IAaveV4ConfigEngine.AssetCapsReset[] memory assetCapsResets = hubAssetCapsResets();
        if (assetCapsResets.length > 0) {
            _delegateCallEngine(abi.encodeCall(IAaveV4ConfigEngine.executeHubAssetCapsResets, (assetCapsResets)));
        }

        IAaveV4ConfigEngine.SpokeDeactivation[] memory spokeDeactivations = hubSpokeDeactivations();
        if (spokeDeactivations.length > 0) {
            _delegateCallEngine(abi.encodeCall(IAaveV4ConfigEngine.executeHubSpokeDeactivations, (spokeDeactivations)));
        }

        IAaveV4ConfigEngine.SpokeCapsReset[] memory spokeCapsResets = hubSpokeCapsResets();
        if (spokeCapsResets.length > 0) {
            _delegateCallEngine(abi.encodeCall(IAaveV4ConfigEngine.executeHubSpokeCapsResets, (spokeCapsResets)));
        }
    }
    ...
    function _executeSpokeActions() internal {
        ...
        if (reserveListings.length > 0) {
            _delegateCallEngine(abi.encodeCall(IAaveV4ConfigEngine.executeSpokeReserveListings, (reserveListings)));
        }

        IAaveV4ConfigEngine.ReserveConfigUpdate[] memory reserveConfigUpdates = spokeReserveConfigUpdates();
        ...
        IAaveV4ConfigEngine.LiquidationConfigUpdate[] memory liqConfigUpdates = spokeLiquidationConfigUpdates();
        ...
        IAaveV4ConfigEngine.DynamicReserveConfigAddition[] memory dynAdds = spokeDynamicReserveConfigAdditions();
        if (dynAdds.length > 0) {
            _delegateCallEngine(
        ...
        IAaveV4ConfigEngine.DynamicReserveConfigUpdate[] memory dynUpdates = spokeDynamicReserveConfigUpdates();
        ...
        if (pmUpdates.length > 0) {
            _delegateCallEngine(abi.encodeCall(IAaveV4ConfigEngine.executeSpokePositionManagerUpdates, (pmUpdates)));
        }
    }
    ...
    function _executeAccessManagerActions() internal {
        ...
        if (memberships.length > 0) {
            _delegateCallEngine(abi.encodeCall(IAaveV4ConfigEngine.executeRoleMemberships, (memberships)));
        }
        ...
        IAaveV4ConfigEngine.TargetFunctionRoleUpdate[] memory fnRoleUpdates = accessManagerTargetFunctionRoleUpdates();
        if (fnRoleUpdates.length > 0) {
            _delegateCallEngine(abi.encodeCall(IAaveV4ConfigEngine.executeTargetFunctionRoleUpdates, (fnRoleUpdates)));
        }

        IAaveV4ConfigEngine.TargetAdminDelayUpdate[] memory targetDelayUpdates = accessManagerTargetAdminDelayUpdates();
    ...
    function _executePositionManagerActions() internal {
        ...
        IAaveV4ConfigEngine.PositionManagerRoleRenouncement[] memory renouncements = positionManagerRoleRenouncements();
