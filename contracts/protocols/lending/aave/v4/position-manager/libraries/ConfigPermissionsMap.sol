...
library ConfigPermissionsMap {
    ...
    function setCanSetUsingAsCollateral(ConfigPermissions self, bool status) internal pure returns (ConfigPermissions) {
        return
            ConfigPermissions.wrap(_setStatus(ConfigPermissions.unwrap(self), CAN_SET_USING_AS_COLLATERAL_MASK, status));
    }
    ...
    /// @return The updated ConfigPermissions.
    function setCanUpdateUserRiskPremium(ConfigPermissions self, bool status)
        internal
        pure
        returns (ConfigPermissions)
    {
        return ConfigPermissions.wrap(
    ...
    /// @return The updated ConfigPermissions.
    function setCanUpdateUserDynamicConfig(ConfigPermissions self, bool status)
        internal
        pure
        returns (ConfigPermissions)
    {
    ...
    function getConfigPermissionValues(ConfigPermissions self)
        internal
        pure
        returns (IConfigPositionManager.ConfigPermissionValues memory)
    {
        return IConfigPositionManager.ConfigPermissionValues({
