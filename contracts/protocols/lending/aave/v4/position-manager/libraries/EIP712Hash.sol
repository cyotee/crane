...
library EIP712Hash {
    ...
    function hash(ISignatureGateway.SetUsingAsCollateral calldata params) internal pure returns (bytes32) {
        return
        // keccak256(
        //   abi.encode(
    ...
    function hash(ISignatureGateway.UpdateUserRiskPremium calldata params) internal pure returns (bytes32) {
        return
        // keccak256(
        //   abi.encode(
        ...
        //   )
        // );
        abi.encode(UPDATE_USER_RISK_PREMIUM_TYPEHASH, params.spoke, params.onBehalfOf, params.nonce, params.deadline)
            ._hash();
    }

    function hash(ISignatureGateway.UpdateUserDynamicConfig calldata params) internal pure returns (bytes32) {
        return
        // keccak256(
        //   abi.encode(
        ...
        //   )
        // );
        abi.encode(UPDATE_USER_DYNAMIC_CONFIG_TYPEHASH, params.spoke, params.onBehalfOf, params.nonce, params.deadline)
            ._hash();
    }

    function hash(ITakerPositionManager.WithdrawPermit calldata params) internal pure returns (bytes32) {
        return
        // keccak256(
        //   abi.encode(
    ...
    function hash(ITakerPositionManager.BorrowPermit calldata params) internal pure returns (bytes32) {
        return
        // keccak256(
        //   abi.encode(
    ...
    function hash(IConfigPositionManager.SetGlobalPermissionPermit calldata params) internal pure returns (bytes32) {
        return
        // keccak256(
        //   abi.encode(
    ...
    function hash(IConfigPositionManager.SetCanSetUsingAsCollateralPermissionPermit calldata params)
        internal
        pure
        returns (bytes32)
    {
    ...
    function hash(IConfigPositionManager.SetCanUpdateUserRiskPremiumPermissionPermit calldata params)
        internal
        pure
        returns (bytes32)
    {
    ...
    function hash(IConfigPositionManager.SetCanUpdateUserDynamicConfigPermissionPermit calldata params)
        internal
        pure
        returns (bytes32)
    {
