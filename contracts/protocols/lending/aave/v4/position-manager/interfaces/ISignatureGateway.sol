...
interface ISignatureGateway is IPositionManagerIntentBase {
    ...
    function supplyWithSig(Supply calldata params, bytes calldata signature) external returns (uint256, uint256);
    ...
    function withdrawWithSig(Withdraw calldata params, bytes calldata signature) external returns (uint256, uint256);
    ...
    function borrowWithSig(Borrow calldata params, bytes calldata signature) external returns (uint256, uint256);
    ...
    function repayWithSig(Repay calldata params, bytes calldata signature) external returns (uint256, uint256);
    ...
    /// @param signature The EIP712-typed signed bytes for the intent.
    function setUsingAsCollateralWithSig(SetUsingAsCollateral calldata params, bytes calldata signature) external;
    ...
    /// @param signature The EIP712-typed signed bytes for the intent.
    function updateUserRiskPremiumWithSig(UpdateUserRiskPremium calldata params, bytes calldata signature) external;
    ...
    /// @param signature The EIP712-typed signed bytes for the intent.
    function updateUserDynamicConfigWithSig(UpdateUserDynamicConfig calldata params, bytes calldata signature) external;
