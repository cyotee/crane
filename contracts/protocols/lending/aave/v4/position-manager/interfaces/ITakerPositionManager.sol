...
interface ITakerPositionManager is IPositionManagerIntentBase {
    ...
    event WithdrawApproval(
        address indexed spoke, address indexed owner, address indexed spender, uint256 reserveId, uint256 amount
    );
    ...
    function approveWithdrawWithSig(WithdrawPermit calldata params, bytes calldata signature) external;
