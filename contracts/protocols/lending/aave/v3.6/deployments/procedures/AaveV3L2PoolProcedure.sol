...
import {L2PoolInstance} from "@crane/contracts/protocols/lending/aave/v3.6/instances/L2PoolInstance.sol";
import {
...
contract AaveV3L2PoolProcedure is AaveV3PoolConfigProcedure, IErrors {
    function _deployAaveV3L2Pool(address poolAddressesProvider, address interestRateStrategy)
        internal
    ...
    function _deployL2PoolImpl(address poolAddressesProvider, address interestRateStrategy) internal returns (address) {
