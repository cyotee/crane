...
contract MetadataReporter is IMetadataReporter {
    ...
    function writeJsonReportMarket(MarketReport memory report) external {
        ...
        vm.serializeAddress(jsonReport, "poolAddressesProviderRegistry", report.poolAddressesProviderRegistry);
        ...
        vm.serializeAddress(jsonReport, "poolConfiguratorImplementation", report.poolConfiguratorImplementation);
        ...
        vm.serializeAddress(jsonReport, "rewardsControllerImplementation", report.rewardsControllerImplementation);
