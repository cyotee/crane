...
contract MockAToken is ATokenInstance {
    ...
    function transferWithIndex(address sender, address recipient, uint256 amount, uint256 newIndex) public {
        _transfer(sender, recipient, amount, amount.getATokenTransferScaledAmount(newIndex).toUint120(), newIndex);
    }
