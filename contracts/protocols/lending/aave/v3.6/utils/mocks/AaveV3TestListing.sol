...
import {
    AaveV3Payload
} from "@crane/contracts/protocols/lending/aave/v3.6/extensions/v3-config-engine/AaveV3Payload.sol";
import {
...
import {MarketReport} from "@crane/contracts/protocols/lending/aave/v3.6/deployments/interfaces/IMarketReportTypes.sol";
import {
    IPoolConfigurator,
    ConfiguratorInputTypes
} from "@crane/contracts/protocols/lending/aave/v3.6/interfaces/IPoolConfigurator.sol";
...
contract AaveV3TestListing is AaveV3Payload {
    ...
    function newListingsCustom() public view override returns (IEngine.ListingWithCustomImpl[] memory) {
        ...
        IEngine.InterestRateInputData memory rateParams = IEngine.InterestRateInputData({
            optimalUsageRatio: 45_00, baseVariableBorrowRate: 0, variableRateSlope1: 4_00, variableRateSlope2: 60_00
        });
