...
import {ERC20Upgradeable, ERC20PermitUpgradeable} from '@crane/contracts/protocols/lending/aave/v3.6/dependencies/openzeppelin-contracts-upgradeable/contracts/token/ERC20/extensions/ERC20PermitUpgradeable.sol';
import {PausableUpgradeable} from '@crane/contracts/protocols/lending/aave/v3.6/dependencies/openzeppelin-contracts-upgradeable/contracts/utils/PausableUpgradeable.sol';
import {IERC20Metadata} from "@crane/contracts/interfaces/IERC20Metadata.sol";
import {IERC20Permit} from '@crane/contracts/protocols/lending/aave/v3.6/dependencies/openzeppelin-contracts/contracts/token/ERC20/extensions/IERC20Permit.sol';
import {Rescuable} from '@crane/contracts/protocols/lending/aave/v3.6/dependencies/solidity-utils/contracts/utils/Rescuable.sol';
import {IRescuableBase, RescuableBase} from '@crane/contracts/protocols/lending/aave/v3.6/dependencies/solidity-utils/contracts/utils/RescuableBase.sol';
...
/**
 * @title StataTokenV2
 * @notice A 4626 Vault which wraps aTokens in order to translate the rebasing nature of yield accrual into a non-rebasing value accrual.
 * @author BGD labs
 */
