...
} from "@crane/contracts/external/openzeppelin-upgradeable/token/ERC20/extensions/ERC20PermitUpgradeable.sol";
import {PausableUpgradeable} from "@crane/contracts/external/openzeppelin-upgradeable/utils/PausableUpgradeable.sol";
...
import {
    Rescuable
} from "@crane/contracts/protocols/lending/aave/v3.6/dependencies/solidity-utils/contracts/utils/Rescuable.sol";
import {
    IRescuableBase,
    RescuableBase
} from "@crane/contracts/protocols/lending/aave/v3.6/dependencies/solidity-utils/contracts/utils/RescuableBase.sol";
...
import {
    ...
    Math,
    IERC20
} from "./ERC4626StataTokenUpgradeable.sol";
    ...
    IStataTokenV2
{
    ...
    constructor(IPool pool, IRewardsController rewardsController)
        ...
        ERC4626StataTokenUpgradeable(pool)
    {
    ...
    function maxRescue(address asset) public view override(IRescuableBase, RescuableBase) returns (uint256) {
    ...
    function _claimRewardsOnBehalf(address onBehalfOf, address receiver, address[] memory rewards)
        internal
        virtual
        override
        whenNotPaused
    ...
    function _update(address from, address to, uint256 amount)
        internal
        virtual
        override(ERC20AaveLMUpgradeable, ERC20Upgradeable)
        whenNotPaused
    {
