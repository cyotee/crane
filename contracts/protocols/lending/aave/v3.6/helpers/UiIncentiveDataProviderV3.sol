            ...
            if (address(aTokenIncentiveController) != address(0)) {
                ...
                for (uint256 j = 0; j < aTokenRewardAddresses.length; ++j) {
                    ...
                    rewardInformation.rewardTokenDecimals =
                        IERC20Metadata(rewardInformation.rewardTokenAddress).decimals();
                    rewardInformation.rewardTokenSymbol = IERC20Metadata(rewardInformation.rewardTokenAddress).symbol();
                    ...
                    rewardInformation.priceFeedDecimals =
                        AggregatorInterface(rewardInformation.rewardOracleAddress).decimals();
                    rewardInformation.rewardPriceFeed =
                        AggregatorInterface(rewardInformation.rewardOracleAddress).latestAnswer();
            ...
            if (address(aTokenIncentiveController) != address(0)) {
                ...
                for (uint256 j = 0; j < aTokenRewardAddresses.length; ++j) {
                    ...
                    userRewardInformation.rewardTokenDecimals =
                        IERC20Metadata(userRewardInformation.rewardTokenAddress).decimals();
                    userRewardInformation.rewardTokenSymbol =
                        IERC20Metadata(userRewardInformation.rewardTokenAddress).symbol();
                    ...
                    userRewardInformation.priceFeedDecimals =
                        AggregatorInterface(userRewardInformation.rewardOracleAddress).decimals();
                    userRewardInformation.rewardPriceFeed =
                        AggregatorInterface(userRewardInformation.rewardOracleAddress).latestAnswer();
