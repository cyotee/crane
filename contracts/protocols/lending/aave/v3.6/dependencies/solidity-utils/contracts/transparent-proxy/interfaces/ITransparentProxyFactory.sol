...
interface ITransparentProxyFactory {
    ...
    event ProxyDeterministicCreated(
        address proxy, address indexed logic, address indexed initialOwner, bytes32 indexed salt
    );
    event ProxyAdminDeterministicCreated(address proxyAdmin, address indexed initialOwner, bytes32 indexed salt);
     ...
     *
     */
    function create(address logic, address initialOwner, bytes memory data) external returns (address);
     ...
     *
     */
    function createDeterministic(address logic, address initialOwner, bytes memory data, bytes32 salt)
        external
        returns (address);
     ...
     *
     */
    function createDeterministicProxyAdmin(address adminOwner, bytes32 salt) external returns (address);
     ...
     *
     */
    function predictCreateDeterministicProxyAdmin(bytes32 salt, address initialOwner) external view returns (address);
