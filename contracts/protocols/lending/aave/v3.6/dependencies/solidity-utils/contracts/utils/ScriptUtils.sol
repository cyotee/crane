...
library Create2Utils {
    ...
    function create2Deploy(bytes32 salt, bytes memory bytecode, bytes memory arguments) internal returns (address) {
    ...
    function computeCreate2Address(bytes32 salt, bytes memory bytecode, bytes memory arguments)
        internal
        pure
        returns (address)
    {
