...
abstract contract IncentivizedERC20 is Context, IERC20Metadata {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) external virtual override returns (bool) {
        uint120 castAmount = amount.toUint120();
        _spendAllowance({owner: sender, spender: _msgSender(), amount: castAmount, correctedAmount: castAmount});
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) external virtual returns (bool) {
        ...
        _approve({owner: _msgSender(), spender: spender, amount: currentAllowance - subtractedValue, emitEvent: true});
        return true;
    }
    ...
    function _spendAllowance(address owner, address spender, uint256 amount, uint256 correctedAmount) internal virtual {
        ...
        _approve({owner: owner, spender: spender, amount: currentAllowance - consumption, emitEvent: false});
    }
