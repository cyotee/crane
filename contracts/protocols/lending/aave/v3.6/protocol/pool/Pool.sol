...
abstract contract Pool is VersionedInitializable, PoolStorage, IPool, Multicall {
    ...
    function repayWithPermit(
...

        {
            ...
            return
                BorrowLogic.executeRepay(_reserves, _reservesList, _eModeCategories, _usersConfig[onBehalfOf], params);
        }
    }
    ...
    /// @inheritdoc IPool
    function configureEModeCategory(uint8 id, DataTypes.EModeCategoryBaseConfiguration calldata category)
        external
        virtual
        override
        onlyPoolConfigurator
    ...
    /// @inheritdoc IPool
    function configureEModeCategoryLtvzeroBitmap(uint8 id, uint128 ltvzeroBitmap)
        external
        virtual
        override
        onlyPoolConfigurator
