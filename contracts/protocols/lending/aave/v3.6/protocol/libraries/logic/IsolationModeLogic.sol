...
library IsolationModeLogic {
    ...
    function increaseIsolatedDebtIfIsolated(
        ...
        if (isolationModeActive) {
            ...
            require(
                reserveCache.reserveConfiguration.getBorrowableInIsolation(), Errors.AssetNotBorrowableInIsolation()
            );
    ...
    {
        return (amount / 10
                ** (reserveCache.reserveConfiguration.getDecimals() - ReserveConfiguration.DEBT_CEILING_DECIMALS))
        .toUint128();
    }
}
