...
library BorrowLogic {
    ...
    function executeRepay(
        ...
        if (params.useATokens && params.amount == type(uint256).max) {
            ...
            paybackAmount = IAToken(reserveCache.aTokenAddress).scaledBalanceOf(params.user)
        ...
        bool noMoreDebt;
        (noMoreDebt, reserveCache.nextScaledVariableDebt) = IVariableDebtToken(reserveCache.variableDebtTokenAddress)
            .burn({
