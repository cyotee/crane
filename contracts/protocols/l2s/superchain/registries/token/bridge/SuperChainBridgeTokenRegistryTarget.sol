...
import {
    SuperChainBridgeTokenRegistryRepo
} from "@crane/contracts/protocols/l2s/superchain/registries/token/bridge/SuperChainBridgeTokenRegistryRepo.sol";
...
contract SuperChainBridgeTokenRegistryTarget is ISuperChainBridgeTokenRegistry, OperableModifiers {
    ...
    function setRemoteTokenMinGasLimit(uint256 chainId, IERC20 remoteToken, uint256 minGasLimit)
        external
        onlyOwnerOrOperator
        returns (bool)
    {
