...
// Crane port of production PonsLaunchLocker (Robinhood Chain).
// Upstream source recovered from Sourcify exact_match for
// 0x736D76699C26D0d966744cAe304C000d471f7F35 (verified 2026-07-13).
// Not present in github.com/ponsdotdev/ponsfamily public tree as of 2026-08-10.
// Adaptations: pragma ^0.8.35; OZ imports remapped to Crane external OZ v5;
// implements IPonsLaunchLocker for factory typing.
...
import {IERC721ReceiverLike, INonfungiblePositionManagerLike, IPonsLaunchFactory, IPonsLaunchLocker} from "./interfaces/ILaunchpad.sol";
 ...
 */
contract PonsLaunchLocker is Ownable2Step, ReentrancyGuard, IERC721ReceiverLike, IPonsLaunchLocker {
