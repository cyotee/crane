...
// Interfaces
import {IERC3156FlashBorrower} from "@crane/contracts/protocols/tokens/stable/olympus/interfaces/maker-dao/IERC3156FlashBorrower.sol";
import {IERC3156FlashLender} from "@crane/contracts/protocols/tokens/stable/olympus/interfaces/maker-dao/IERC3156FlashLender.sol";
import {IDaiUsdsMigrator} from "@crane/contracts/protocols/tokens/stable/olympus/interfaces/maker-dao/IDaiUsdsMigrator.sol";
...
import {SafeCast} from "@crane/contracts/protocols/tokens/stable/olympus/libraries/SafeCast.sol";
...
// Bophades
import {Cooler} from "@crane/contracts/protocols/tokens/stable/olympus/external/cooler/Cooler.sol";
import {CHREGv1} from "@crane/contracts/protocols/tokens/stable/olympus/modules/CHREG/CHREG.v1.sol";
import {IMonoCooler} from "@crane/contracts/protocols/tokens/stable/olympus/policies/interfaces/cooler/IMonoCooler.sol";
import {ICoolerFactory} from "@crane/contracts/protocols/tokens/stable/olympus/external/cooler/interfaces/ICoolerFactory.sol";
import {IDLGTEv1} from "@crane/contracts/protocols/tokens/stable/olympus/modules/DLGTE/IDLGTE.v1.sol";
