...
FOUNDRY_PROFILE=olympus_port forge test --match-path 'test/foundry/spec/protocols/tokens/stable/olympus/v2/**'
...
Any test that **is** under `test/foundry/spec/protocols/tokens/stable/olympus/v2/**` must pass.
