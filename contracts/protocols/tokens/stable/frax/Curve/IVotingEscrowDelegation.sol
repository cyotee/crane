...
interface IVotingEscrowDelegation {
    ...
    function batch_set_delegation_status(
        address _receiver,
        address[256] memory _delegators,
        uint256[256] memory _status
    ) external;
    ...
    function calc_boost_bias_slope(address _delegator, int256 _percentage, int256 _expire_time)
        external
        view
