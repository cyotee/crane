...
// Aave V2
import "@crane/contracts/protocols/tokens/stable/frax/Misc_AMOs/Lending_AMOs/aave/IAToken.sol";
import "@crane/contracts/protocols/tokens/stable/frax/Misc_AMOs/Lending_AMOs/aave/ILendingPool.sol";
...
contract FraxCrossChainFarmV3_ERC20_Pos_Rebase is Owned, ReentrancyGuard {
    ...
    function fraxPerLPToken() public pure returns (uint256) {
    ...
    function _accrueInterest(address staker_address, LockedStake memory thisStake, uint256 theArrayIndex)
        internal
        returns (LockedStake memory, uint256)
    {
