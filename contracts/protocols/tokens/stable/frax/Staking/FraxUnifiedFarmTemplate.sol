...
// Balancer
// ====================
// import "@crane/contracts/protocols/tokens/stable/frax/Misc_AMOs/balancer/IAuraDeposit.sol";
// import "@crane/contracts/protocols/tokens/stable/frax/Misc_AMOs/balancer/IAuraDepositVault.sol";

// BUNNI
// ====================
// import "@crane/contracts/protocols/tokens/stable/frax/Misc_AMOs/bunni/IBunniGauge.sol";
// import "@crane/contracts/protocols/tokens/stable/frax/Misc_AMOs/bunni/IBunniLens.sol";
// import "@crane/contracts/protocols/tokens/stable/frax/Misc_AMOs/bunni/IBunniMinter.sol";

// CONVEX
// ====================
import "@crane/contracts/protocols/tokens/stable/frax/Misc_AMOs/convex/IConvexBaseRewardPool.sol";
...
contract FraxUnifiedFarmTemplate is Owned, ReentrancyGuard {
    ...
    modifier onlyByOwnGov() {
        require(
            msg.sender == owner || msg.sender == 0x8412ebf45bAC1B340BbE8F318b928C466c4E39CA, "Not owner or timelock"
        );
        _;
    }
        ...
        if (gauge_controller_address != address(0)) {
            rwd_rate =
                (IFraxGaugeController(gauge_controller_address).global_emission_rate()
                        * last_gauge_relative_weights[token_idx]) / 1e18;
        } else {
    ...
    function maxLPForMaxBoost(address account) external view returns (uint256) {
        return (veFXS.balanceOf(account) * MULTIPLIER_PRECISION * MULTIPLIER_PRECISION)
    ...
    function veFXSMultiplier(address account) public view returns (uint256 vefxs_multiplier) {
        ...
        uint256 mult_optn_2;
        {
            ...
            if (veFXS_needed_for_max_boost > 0) {
                ...
                mult_optn_2 = 0; // This will happen with the first stake, when user_staked_frax is 0
            }
        }
