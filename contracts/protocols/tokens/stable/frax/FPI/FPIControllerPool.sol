...
import "@crane/contracts/protocols/tokens/stable/frax/Oracle/CPITrackerOracle.sol";
import "@crane/contracts/protocols/tokens/stable/frax/Fraxswap/periphery/libraries/UniswapV2LiquidityMathLibraryMini.sol";
...
contract FPIControllerPool is Owned {
   ...
   // AMO addresses (lend out FRAX)
    ...
    function dollarBalances() public pure returns (uint256 frax_val_e18, uint256 collat_val_e18) {
