...
library Linkedlist {
    ...
    function init(mapping(int24 => Linkedlist.Data) storage self, int24 lowestValue, int24 highestValue) internal {
    ...
    function insert(mapping(int24 => Linkedlist.Data) storage self, int24 newValue, int24 lowerValue, int24 nextValue)
        internal
    {
