...
interface ICurveTricryptoOptimizedWETH {
    ...
    function remove_liquidity(uint256 _amount, uint256[3] memory min_amounts, bool use_eth)
        external
        returns (uint256[3] memory);
    function remove_liquidity(uint256 _amount, uint256[3] memory min_amounts, bool use_eth, address receiver)
        external
        returns (uint256[3] memory);
