...
interface IZapDepositor2pool {
    ...
    function remove_liquidity(address _pool, uint256 _burn_amount, uint256[3] memory _min_amounts)
        external
        returns (uint256[3] memory);
    function remove_liquidity(address _pool, uint256 _burn_amount, uint256[3] memory _min_amounts, address _receiver)
        external
        returns (uint256[3] memory);
    ...
    function remove_liquidity_imbalance(address _pool, uint256[3] memory _amounts, uint256 _max_burn_amount)
        external
        returns (uint256);
