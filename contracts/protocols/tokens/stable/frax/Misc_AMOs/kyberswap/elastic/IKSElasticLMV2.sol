...
interface IKSElasticLMV2 {
    ...
    function addFarm(address poolAddress, RangeInput[] memory ranges, PhaseInput memory phase, bool isUsingToken)
        external
        returns (uint256 fId);
    ...
    function getFarm(uint256 fId)
        ...
        returns (
            address poolAddress,
            RangeInput[] memory ranges,
            PhaseInput memory phase,
            uint256 liquidity,
            address farmingToken,
