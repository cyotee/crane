...
contract BetterERC4626 is ERC4626Target, ERC20, BetterIERC4626 {
    ...
    function asset()
    public view virtual override(ERC4626Target, IERC4626) returns (address) {
        return super.asset();
    }

    function totalAssets()
    public view virtual override(ERC4626Target, IERC4626) returns (uint256) {
    ...
    public virtual override(ERC4626Target, IERC4626) returns (uint256) {
