...
interface IERC20MintBurnOperableStorage
{
    ...
    struct MintBurnOperableAccountInit {
        IOwnableStorage
        .OwnableAccountInit ownableAccountInit;
        IOperableStorage
        .OperableAccountInit operableAccountInit;
        string name;
        string symbol;
        uint8 decimals;
    }
...
contract ERC20MintBurnOperableStorage
is
OwnableStorage,
OperableStorage,
ERC20Storage,
IERC20MintBurnOperableStorage
{
    ...
    function _initERC20(
        ...
        memory mintBurnOperableAccountInit
    ) internal {
        ...
        _initERC20(
            mintBurnOperableAccountInit.name,
            mintBurnOperableAccountInit.symbol,
            mintBurnOperableAccountInit.decimals
        );
    }
