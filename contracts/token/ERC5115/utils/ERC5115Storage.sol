...
contract ERC5115Storage {
    ...
    bytes32 private constant LAYOUT_ID =
        keccak256(abi.encode(type(ERC5115Repo).name));
     ...
     */
    function _erc5115()
    internal pure virtual returns (ERC5115Layout storage) {
