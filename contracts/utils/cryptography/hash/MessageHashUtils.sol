...
library MessageHashUtils {
    ...
    // using EfficientHashLib for address;
     ...
     * See {ECDSA-recover}.
     */
    function _toDataWithIntendedValidatorHash(address validator, bytes memory data) internal pure returns (bytes32) {
        // return keccak256(abi.encodePacked(hex"19_00", validator, data));
        return abi.encodePacked(hex"1900", validator, data)._hash();
    }
