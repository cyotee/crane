...
import {ConstProdUtils} from "./ConstProdUtils.sol";
...
library VirtBalConstProdUtils {
    ...
    ) internal pure returns (uint256 saleProceeds) {
    ...
    ) internal pure returns (uint256 amountIn_min) {
    ...
    function _withdrawSwapQuote(
        ...
        exitAmount = opposingTokenOwnedReserve._saleQuote(
            virtOpposingReserve - opposingTokenOwnedReserve,
            virtExitReserve - exitTokenOwnedReserve,
            opTokenFeePercent
        );
    }
