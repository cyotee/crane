...
library ConstProdUtils {
    ...
    function _quoteSwapDepositWithFee(SwapDepositArgs memory args) internal pure returns (uint256 lpAmt) {
        ...
        // console.log("_quoteSwapDepositWithFee: amountIn", args.amountIn);
        // console.log("_quoteSwapDepositWithFee: lpTotalSupply (start)", args.lpTotalSupply);
        // console.log("_quoteSwapDepositWithFee: reserveIn (start)", args.reserveIn);
        // console.log("_quoteSwapDepositWithFee: reserveOut (start)", args.reserveOut);
        // console.log("_quoteSwapDepositWithFee: feePercent", args.feePercent);
        // console.log("_quoteSwapDepositWithFee: feeDenom", feeDenom);
        ...
        // console.log("_quoteSwapDepositWithFee: amtInSaleAmt", amtInSaleAmt);
        // console.log("_quoteSwapDepositWithFee: opTokenAmtIn", opTokenAmtIn);
        ...
        // console.log("_quoteSwapDepositWithFee: amountIn (remain)", args.amountIn);
        // console.log("_quoteSwapDepositWithFee: reserveIn (post swap)", args.reserveIn);
        // console.log("_quoteSwapDepositWithFee: reserveOut (post swap)", args.reserveOut);
        ...
        if (args.feeOn && args.kLast != 0) {
            ...
            // console.log("_quoteSwapDepositWithFee: protocolFee", protocolFee);
            // console.log("_quoteSwapDepositWithFee: lpTotalSupply (adj)", args.lpTotalSupply);
        }

        // Replicate Uniswap router _addLiquidity integer-quoting branch to select final deposit integers
    ...
    function _calculateUniswapFeeMint(uint256 lpTotalSupply, uint256 reserve0, uint256 reserve1, uint256 kLast)
        internal
        pure
