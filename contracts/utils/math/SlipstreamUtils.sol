...
/// @title SlipstreamUtils
/// @notice Math utilities for quoting Aerodrome Slipstream (CL) swaps within a single tick
/// @dev Aerodrome Slipstream is a Uniswap V3 fork with gauge integration
...
library SlipstreamUtils {
    ...
    /// @dev Useful for converting V2-style reserves to Slipstream sqrt price format
