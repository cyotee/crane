...
import {IArbOwnerPublic} from "../../interfaces/IArbOwnerPublic.sol";
...
IArbOwnerPublic
{
    ...
    function setAllChainOwners(
        address[] memory newAllOwners
    ) public returns(bool) {
    ...
    function setVersionAndTime(uint64 arbosVersion, uint64 scheduledForTimestamp)
    public returns(bool) {
