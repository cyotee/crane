...
library betterconsole {
    ...
    function log(
        ...
        logMsg1 = string.concat(logMsg1, addr1._toString());
        logMsg1 = string.concat(logMsg1, logMsgs2);
        logMsg1 = string.concat(logMsg1, addr2._toString());
        logMsg1 = string.concat(logMsg1, logMsgs3);
        logMsg1 = string.concat(logMsg1, num._toString());
        logMsg1 = string.concat(logMsg1, logMsg4);
        logMsg1 = string.concat(logMsg1, addr3._toString());
        console.log(logMsg1);
    }
    ...
    function logCompare(string memory subjectLabel, string memory logBody, bytes32 expected, bytes32 actual)
        ...
        pure
    {
        logCompare(subjectLabel, logBody, uint256(expected)._toHexString(), uint256(actual)._toHexString());
    }
