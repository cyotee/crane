    ...
    Behavior_ICreate2Aware
{
    ...
    function test_ICreate2Aware_INITCODE_HASH() public {
        isValid_ICreate2Aware_INITCODE_HASH(
            create2TestInstance(),
            controlInitCodeHash(),
            create2TestInstance().INITCODE_HASH()
        );
    }

    function test_ICreate2Aware_SALT() public {
        isValid_ICreate2Aware_SALT(
            create2TestInstance(),
            controlSalt(),
            create2TestInstance().SALT()
        );
    }
    ...
    function test_ICreate2Aware_CREATE2Metadata() public {
        areValid_ICreate2Aware_METADATA(
            create2TestInstance(),
            controlCreate2Metadata(),
            create2TestInstance().METADATA()
        );
    }
