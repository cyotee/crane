...
} from "../../factories/create2/callback/diamondPkg/utils/DiamondFactoryPackageAdaptor.sol";
import {
    IDiamond
...
FacetsComparator
{
    ...
    function _evalDiamondConfig(
        ...
        console.logBehaviorProcessing(
            ...
            string.concat(
                "expected: ",
                expected.facetCuts.length.toString(),
                ", actual: ",
                actual.facetCuts.length.toString()
            )
        );
