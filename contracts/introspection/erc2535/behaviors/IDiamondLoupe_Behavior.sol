...
import {Behavior} from "../../../test/behavior/Behavior.sol";

// import "contracts/crane/vm/foundry/VMAware.sol";

// import "../../../utils/Primitives.sol";
import {Address} from "../../../utils/primitives/Address.sol";
import {Bytes} from "../../../utils/primitives/Bytes.sol";
import {Bytes4} from "../../../utils/primitives/Bytes4.sol";
import {Bytes32} from "../../../utils/primitives/Bytes32.sol";
import {String} from "../../../utils/primitives/String.sol";
import {UInt} from "../../../utils/primitives/UInt.sol";

// import "../../../utils/Collections.sol";
import "../../../utils/math/BetterMath.sol";
import {
    AddressSet,
    AddressSetRepo
...
// import "contracts/crane/tokens/erc20/interfaces/IERC20MintBurn.sol";

// import "contracts/crane/introspection/erc2535/test/comparators/FacetComparator.sol";

/**
 * @title IDiamondLoupe_Behavior
 ...
 */
contract IDiamondLoupe_Behavior
is
Behavior,
...
FacetsComparator
{
    ...
    /* ------------------------- Helper Functions --------------------------- */
    function _idiamondLoupe_behaviorName()
    internal pure returns(string memory) {
        return type(IDiamondLoupe_Behavior).name;
    }
    ...
    function expect_IDiamondLoupe(
        ...
        console.logBehaviorEntry(_idiamondLoupe_behaviorName(), "expect_IDiamondLoupe");
        ...
        console.logBehaviorExit(_idiamondLoupe_behaviorName(), "expect_IDiamondLoupe");
    }
    ...
    function areValid_IDiamondLoupe(
        ...
        console.logBehaviorEntry(_idiamondLoupe_behaviorName(), "areValid_IDiamondLoupe");
        ...
        console.logBehaviorExit(_idiamondLoupe_behaviorName(), "areValid_IDiamondLoupe");
    }
    ...
    function hasValid_IDiamondLoupe(
        ...
        console.logBehaviorEntry(_idiamondLoupe_behaviorName(), "hasValid_IDiamondLoupe");
        ...
        console.logBehaviorExit(_idiamondLoupe_behaviorName(), "hasValid_IDiamondLoupe");
    }
            ...
            for(uint256 funcsCursor = 0; funcsCursor < actualFacetFuncs.length; funcsCursor++) {
                ...
                if(!matches) {
                    ...
                    console.logCompare(
                        ...
                        string.concat(
                            "function: ",
                            actualFacetFuncs[funcsCursor]._toString()
                        ),
                        // string memory expectedLog
                        string.concat(
                            "expected: ",
                            _expected_facetAddr[subject][actualFacetFuncs[funcsCursor]]._toString()
                        ),
                        // string memory actualLog
                        string.concat(
                            "actual: ",
                            actualFacetAddrs[actualAddrCursor]._toString()
                        )
                    );
                }
            }
